...
<ul>
  ...
  nearbyCities: ["Paris 20ème", "Montreuil", "Les Lilas", "Romainville"],
...
<p>Le nettoyage s'effectue par injection d'une solution nettoyante suivie d'une extraction immédiate. La pression et la température sont ajustées selon la fragilité du tissu. Nous optimisons l'extraction pour réduire le temps de séchage, généralement compris entre 4 et 8 heures selon l'épaisseur et l'aération disponible.</p>`,
...

    {
      ...
      heroDescription:
        "Remise en état complète de votre terrasse à Bagnolet : traitement des mousses, décrassage adapté au support et protection des plantations pour retrouver un espace extérieur propre et utilisable.",
      whyUsBullets: [
        "Connaissance des terrasses bagnoletaises : pavillons ombragés, dalles exposées à la pollution des axes proches.",
        "Adaptation technique à chaque support : pression calibrée, produits ciblés, traitement anti-mousse selon porosité.",
        "Organisation soignée : déplacement du mobilier, protection des plantations, gestion de l'écoulement sans gêne pour le voisinage.",
      ],
      uniqueIntro: `<p>Dans les <strong>quartiers pavillonnaires de Bagnolet</strong>, notamment vers Les Malassis et La Dhuys, les terrasses subissent une dégradation progressive au fil des saisons. Mousse qui s'étend dans les joints, dépôts noirs sur les dalles, surface devenue glissante après chaque épisode pluvieux : l'espace extérieur perd son attrait et son confort d'usage.</p>
<p class="mt-4">Les <strong>supports courants</strong> — dalles sur plots, carrelage ou béton — réagissent différemment à l'humidité et à l'encrassement. Une terrasse exposée à l'ombre des arbres verdit plus vite, tandis que celles proches des axes routiers accumulent un film gras difficile à éliminer au simple jet d'eau. Le résultat : un sol terne, parfois dangereux, qui décourage toute utilisation.</p>
<p class="mt-4">Une intervention structurée permet de traiter chaque problématique selon le matériau. Diagnostic du support, choix de la méthode adaptée, protection du mobilier et des jardinières : chaque étape vise un résultat durable sans risque pour les éléments environnants.</p>`,
      uniqueDeepDive: `<h3>Préparation et protection</h3>
<p>Le mobilier extérieur et les plantes sont déplacés ou bâchés. Les menuiseries — baies vitrées, portes — reçoivent une protection contre les projections. Un balayage préalable élimine feuilles, terre et débris accumulés.</p>

<h3>Traitement et nettoyage</h3>
<p>Un produit adapté au support est appliqué : formulation spécifique pour dalles sur plots, pierre naturelle ou béton. Le brossage — manuel ou mécanique selon l'encrassement — décolle mousses et salissures incrustées. La haute pression intervient ensuite à intensité contrôlée pour préserver joints et matériaux poreux.</p>

<h3>Finitions et conseils</h3>
<p>L'eau est dirigée vers les points d'écoulement existants, en veillant à protéger les plantations adjacentes. Un traitement anti-mousse préventif peut être appliqué sur demande. Avant de quitter les lieux, nous restituons l'espace rangé et formulons des recommandations d'entretien saisonnier pour prolonger le résultat.</p>`,
      specificChallenges: [
        "Pollution noire liée à la proximité de l'A3 : film gras tenace sur dalles et béton.",
        "Mousses et lichens fréquents sur les terrasses pavillonnaires exposées à l'ombre.",
        "Dalles sur plots dans les programmes récents : nettoyage sans déplacement ni infiltration.",
        "Accès parfois limité aux jardins arrière, nécessitant passage par l'intérieur.",
        "Protection des jardinières et mobilier pendant l'intervention haute pression.",
      ],
      faqAdditions: [
        {
          question:
            "Comment nettoyer des dalles sur plots sans les déplacer ni provoquer d'infiltration, notamment sur les terrasses récentes du Plateau ?",
          answer:
            "<p>Nous utilisons une pression modérée et orientée pour éviter de soulever les dalles. Le traitement cible la surface visible sans forcer l'eau sous le revêtement. Cette méthode préserve l'étanchéité tout en éliminant mousses et salissures incrustées dans les joints périphériques.</p>",
        },
        {
          question:
            "Comment éliminer durablement mousses et lichens sur une terrasse pavillonnaire aux Malassis ?",
          answer:
            "<p>Après brossage mécanique pour retirer la couche végétale, nous appliquons un produit anti-mousse adapté au support. Le rinçage contrôlé évacue les résidus. Un traitement préventif peut prolonger l'effet plusieurs mois, surtout sur les zones ombragées où l'humidité favorise la repousse.</p>",
        },
        {
          question:
            "Quel traitement anti-mousse recommandez-vous pour une terrasse souvent à l'ombre à Bagnolet ?",
          answer:
            "<p>Nous privilégions un produit à action progressive, appliqué après nettoyage. Il pénètre le support et limite la réapparition des mousses pendant plusieurs saisons. Le choix dépend du matériau : formulation douce pour pierre naturelle, plus concentrée pour béton ou carrelage extérieur.</p>",
        },
        {
          question:
            "Faut-il déplacer mobilier et plantes avant une intervention haute pression sur terrasse de pavillon ?",
          answer:
            "<p>Nous nous en chargeons. Le mobilier est écarté ou bâché, les jardinières protégées des projections et du produit de traitement. À la fin de l'intervention, tout est remis en place. Cette organisation évite tout dommage et vous libère de la manutention préalable.</p>",
        },
      ],
      ctaOverride: "",
    },
