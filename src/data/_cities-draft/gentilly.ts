...
const city: City = {
  ...
  customDescription: "Klinova assure l'entretien des parties communes, parkings et espaces extérieurs à Gentilly. Du quartier du Plateau aux résidences du Chaperon Vert, une équipe locale intervient avec des méthodes adaptées au bâti varié de la commune.",

  // hubIntro : HTML autorisé (voir règles ci-dessous)
  // Pattern : 2 <p> then a <ul>
  hubIntro: `<p>Station RER B Gentilly et Campus Sanofi, aux portes du 14e arrondissement : Klinova accompagne syndics, gestionnaires et occupants dans l'entretien régulier de leurs locaux. Notre ancrage local permet une réactivité adaptée aux contraintes d'une commune dense et bien desservie.</p>
...
<ul>
 ...
 districts: [
  ...
  nearbyCities: ["Paris (13e/14e)", "Montrouge", "Arcueil", "Le Kremlin-Bicêtre"],
...
<p>Une vérification finale confirme l'état des sols et des évacuations. Si demandé, un dépoussiérage des blocs lumineux et tuyauteries complète l'intervention. Un compte-rendu est transmis au syndic avec des préconisations de fréquence adaptées au trafic constaté.</p>`,
    ...
    {
      serviceKey: "balcons",
      heroDescription: "Remise en état complète de votre balcon à Gentilly : traitement des dépôts gras, brossage adapté au support et rinçage contrôlé pour un espace extérieur utilisable rapidement.",
      whyUsBullets: [
...
<p class="mt-4">Selon la configuration, des pics anti-pigeons ou un filet de protection peuvent être installés sur les rebords et corniches pour limiter le retour des oiseaux.</p>`,
...

    {
      ...
      heroDescription: "Remise en état complète de votre terrasse avec traitement adapté au support, élimination des mousses et dépôts verts, et conseils d'entretien pour prolonger la propreté obtenue.",
      whyUsBullets: [
        "Connaissance des expositions locales : ombrage, humidité du secteur Aqueduc, pollution atmosphérique liée aux axes proches.",
        "Maîtrise des traitements selon le support : bois, pierre, composite, avec application anti-mousse adaptée à chaque matériau.",
        "Organisation soignée : protection du mobilier et des plantes, gestion de l'écoulement d'eau sans gêne pour le voisinage.",
      ],
...
<p class="mt-4">Avant de quitter les lieux, des conseils d'entretien saisonnier sont transmis pour espacer les interventions futures.</p>`,
      specificChallenges: [
        "Mousses et lichens favorisés par l'humidité du secteur Aqueduc et l'ombrage des arbres.",
        "Terrasses bois du Plateau nécessitant un traitement doux pour préserver les fibres.",
        "Dalles sur plots avec joints encrassés et rétention d'eau sous les éléments.",
        "Pollution atmosphérique déposant un film gras sur les surfaces exposées.",
        "Mobilier et jardinières à déplacer sur des espaces souvent restreints.",
      ],
      faqAdditions: [
        {
