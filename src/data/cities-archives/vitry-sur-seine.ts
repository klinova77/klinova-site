...
const city: City = {
  ...
  hubIntro: `<p>Au cœur du Grand Paris, entre la Seine, le RER C et le parc des Lilas, Vitry-sur-Seine concentre des configurations variées : grands ensembles, pavillons du Plateau, résidences neuves. Klinova s'organise pour répondre à cette diversité avec des équipes formées aux spécificités locales.</p>
...
<ul>
  ...
  nearbyCities: ["Ivry-sur-Seine", "Choisy-le-Roi", "Thiais", "Alfortville", "Paris"],
  ...
  faq: [
    {
      ...
      answer: `<p>En centre-ville ou près de la gare de Vitry-sur-Seine, nous repérons les possibilités de stationnement avant le premier passage. Nos équipes arrivent avec un véhicule adapté et <strong>planifient les créneaux</strong> en dehors des heures de marché ou de forte affluence pour limiter les contraintes logistiques.</p>`,
    },
    {
      question: "Pouvez-vous intervenir dans des résidences avec digicode et gardien ?",
      answer: `<p>Oui, c'est une situation fréquente à Vitry-sur-Seine. Nous récupérons les <strong>codes d'accès ou badges Vigik</strong> en amont et coordonnons avec le gardien si nécessaire. Les horaires d'intervention sont définis pour respecter les règles de la copropriété et éviter toute gêne pour les résidents.</p>`,
    },
    {
      question: "Quel délai prévoir pour une première intervention sur un immeuble ou un parking ?",
      answer: `<p>Après validation du devis, nous pouvons généralement intervenir <strong>sous 5 à 10 jours ouvrés</strong> selon la nature de la prestation et la disponibilité des accès. En cas d'urgence signalée, nous étudions la possibilité d'un passage plus rapide en fonction de notre planning.</p>`,
    },
    {
      question: "Comment gérez-vous les interventions dans les zones en chantier comme les Ardoines ?",
      answer: `<p>Les secteurs en mutation génèrent des <strong>poussières et salissures spécifiques</strong>. Nous adaptons la fréquence et les méthodes selon l'avancement des travaux environnants. La coordination avec le gestionnaire permet d'ajuster le planning si les conditions d'accès évoluent.</p>`,
    },
  ],
...
<p class="mt-4">Une intervention structurée permet de traiter ces surfaces en profondeur. Le diagnostic préalable identifie le type de fibre et la nature des taches, avant un protocole adapté aux <strong>contraintes d'accès et aux horaires d'activité</strong> des locaux concernés.</p>`,
      uniqueDeepDive: `<h3>Fibres ravivées et taches éliminées</h3>
...
<p>L'extraction maximale limite le temps de séchage à quelques heures selon l'épaisseur du revêtement et la ventilation disponible. Les consignes de non-piétinement sont transmises pour éviter les reprises de salissures pendant cette phase. Un conseil de fréquence d'entretien est fourni en fin d'intervention.</p>`,
      ...
      faqAdditions: [
        {
          ...
          answer: `<p>Le matériel est dimensionné pour passer dans les escaliers sans ascenseur. Les paliers sont bâchés avant intervention, les plinthes protégées. L'acheminement se fait par étapes pour éviter d'encombrer les passages et limiter la gêne pour les résidents pendant le transport.</p>`,
        },
        {
          question:
          ...
          answer: `<p>Le séchage varie de trois à six heures selon l'épaisseur du revêtement et la ventilation des locaux. L'extraction poussée réduit l'humidité résiduelle au minimum. Une aération naturelle ou mécanique accélère le processus. Les espaces sont généralement praticables en fin de journée.</p>`,
        },
        {
          question:
          ...
          answer: `<p>L'injection-extraction reste la méthode la plus efficace sur dalles textiles. Elle pénètre la fibre, décolle les salissures et les extrait immédiatement. La vapeur seule ne retire pas les résidus, elle les déplace. Sur les taches grasses ou anciennes, un pré-traitement localisé complète l'extraction.</p>`,
        },
        {
          question:
          ...
          answer: `<p>Le repérage préalable identifie les possibilités de stationnement temporaire ou de dépose rapide. Le matériel est déchargé en une fois puis le véhicule déplacé. L'intervention est calibrée pour limiter le temps de présence sur site et respecter les contraintes de circulation du quartier.</p>`,
        },
      ],
      ctaOverride: "",
    },
    {
      ...
      uniqueIntro: `<p>Comment maintenir un parking propre et sécurisé quand le trafic quotidien y dépose huile, graisse et poussières noires ? Le long de l'Avenue Rouget de Lisle et dans les secteurs proches des zones d'activités, les sols subissent un encrassement accéléré lié aux véhicules utilitaires et aux flux vers l'A86. Les traces s'accumulent sur le béton, les rampes deviennent glissantes, les rigoles se bouchent.</p>
      ...
      faqAdditions: [
        {
          ...
          answer: `<p>Les taches incrustées reçoivent un dégraissant appliqué en pré-traitement avant le passage de l'autolaveuse. Plusieurs passes peuvent être nécessaires sur les dépôts anciens. Le béton retrouve un aspect uniforme sans risque d'altération du revêtement.</p>`,
        },
        {
          question:
            "Comment gérez-vous l'évacuation des eaux de lavage dans un parking souterrain de copropriété ?",
          answer: `<p>Les eaux sont orientées vers les regards et rigoles existants. Nous vérifions leur bon écoulement avant intervention et dégageons les obstructions si besoin. Aucun rejet n'est effectué hors des circuits prévus, conformément aux règles en vigueur.</p>`,
        },
        {
          question:
            "Quelles adaptations appliquez-vous entre un parking souterrain et un parking aérien à Vitry-sur-Seine ?",
          answer: `<p>En souterrain, l'aération limitée impose un séchage plus long et une gestion stricte des eaux. À l'air libre, les intempéries et la pollution atmosphérique demandent un dégraissage renforcé. Le matériel et les produits sont ajustés à chaque configuration.</p>`,
        },
        {
          question:
            "Quels créneaux proposez-vous pour intervenir sur un parking lié aux zones d'activité des Ardoines ?",
          answer: `<p>Les interventions sont programmées en début de matinée ou en soirée, hors pics de circulation. Le balisage sécurise les usagers présents. La coordination avec le gestionnaire permet de fermer partiellement les accès sans bloquer l'activité.</p>`,
        },
      ],
      ctaOverride: "",
    },
...
<p class="mt-4">La proximité du <strong>Parc des Lilas</strong> et des espaces arborés du Coteau renforce la pression des volatiles sur les immeubles environnants. Une intervention structurée permet de retrouver un espace utilisable : diagnostic de l'étendue des dépôts, protection du logement, assainissement des supports et désinfection complète avant remise en service.</p>`,
      uniqueDeepDive: `<h3>Espace assaini et désinfecté</h3>
      ...
      faqAdditions: [
        {
          ...
          answer: `<p>L'intervention débute par un confinement de la zone pour éviter toute dispersion. Les dépôts sont humidifiés puis collectés en sacs étanches. Un produit désinfectant virucide est ensuite appliqué sur l'ensemble des surfaces contaminées, avec respect du temps de contact avant rinçage et aération.</p>`,
        },
        {
          question:
            "Quel protocole EPI et quelles étapes de désinfection appliquez-vous pour un balcon contaminé par fientes de pigeons ?",
          answer: `<p>L'intervenant porte masque FFP2, combinaison jetable, gants et lunettes de protection. Après bâchage et humidification préalable, les fientes sont ramassées sans envol de poussières. La désinfection couvre sol, garde-corps et vitrages avec un produit homologué bactéricide et virucide.</p>`,
        },
        {
          question:
          ...
          answer: `<p>Nous utilisons des désinfectants homologués adaptés aux supports exposés à l'humidité. Leur formulation élimine les agents pathogènes présents dans les fientes. Pour limiter les retours, des dispositifs de dissuasion comme les pics ou filets peuvent être installés selon la configuration du balcon.</p>`,
        },
        {
          question:
...
<p class="mt-4">Nous intervenons avec un protocole adapté à chaque fibre et à chaque type de tache. Avant de commencer, nous évaluons l'état du textile, les contraintes d'accès — ascenseur parfois hors service, paliers étroits — et le temps de séchage réaliste selon la saison et l'aération disponible.</p>`,
      uniqueDeepDive: `<h3>Identifier les taches et la nature du tissu</h3>
...
<p>L'injection-extraction retire la quasi-totalité de l'humidité. Nous conseillons ensuite sur l'aération : fenêtre entrouverte, ventilateur d'appoint si besoin. Selon l'épaisseur du tissu et la météo, le canapé ou le tapis redevient utilisable sous 12 à 24 heures. Nous indiquons aussi la fréquence d'entretien adaptée à l'usage du foyer.</p>`,
      ...
      faqAdditions: [
        {
          ...
          answer: `<p>L'injection-extraction à l'eau chaude déloge les acariens nichés dans les fibres. Le détachant utilisé ne laisse pas de résidu irritant une fois sec. Pour prolonger l'effet, nous recommandons un entretien tous les douze à dix-huit mois selon la présence d'animaux ou d'enfants en bas âge.</p>`,
        },
        {
          question:
          ...
          answer: `<p>Nous appliquons d'abord un détachant enzymatique qui décompose l'acide urique sans attaquer les pigments. Un test préalable sur une zone cachée confirme la tenue des couleurs. L'extraction suit immédiatement pour éviter toute auréole résiduelle et neutraliser l'odeur en profondeur.</p>`,
        },
        {
          question:
            "Pour un canapé tissu non déhoussable dans un appartement HLM, quelles techniques garantissent un nettoyage complet ?",
          answer: `<p>L'injection-extraction reste la méthode la plus efficace : l'eau et le produit pénètrent le rembourrage, puis sont aspirés avec les salissures. Aucun démontage n'est nécessaire. Nous adaptons la pression et la température selon l'épaisseur du tissu pour ne pas détériorer la structure du canapé.</p>`,
        },
        {
          question:
            "Si l'ascenseur est hors service et le palier étroit, comment planifiez-vous le shampouinage d'un canapé volumineux ?",
          answer: `<p>Nous vérifions l'accessibilité avant le rendez-vous : étage, largeur des portes, présence d'escaliers. Le matériel d'injection-extraction est conçu pour être transporté à la main. En cas de contrainte forte, nous prévoyons un créneau plus long pour éviter toute précipitation et protéger les parties communes.</p>`,
        },
      ],
      ctaOverride: "",
    },
    {
      ...
      uniqueIntro: `<p>Comment préserver l'aspect d'une terrasse quand l'humidité s'installe et que la mousse gagne du terrain ? Sur le <strong>Quartier du Plateau</strong> comme dans les résidences avec jardins privatifs du secteur Coteau, les surfaces extérieures subissent un encrassement progressif qui rend le sol glissant et peu engageant. Les dépôts verts s'incrustent dans les joints, les feuilles mortes laissent des traces tenaces.</p>
...
<p>L'eau est évacuée vers les points d'écoulement existants. Un traitement anti-mousse préventif peut être appliqué selon la configuration. Vous recevez des recommandations d'entretien saisonnier pour prolonger le résultat obtenu.</p>`,
      ...
      faqAdditions: [
        {
          ...
          answer: `<p>Le bois composite ne supporte pas la haute pression standard. Nous utilisons une pression réduite combinée à un produit neutre qui préserve la surface et les fixations. Le brossage manuel complète le travail sur les zones encrassées sans altérer l'aspect du revêtement ni fragiliser les lames.</p>`,
        },
        {
          question:
            "Comment éliminez-vous la mousse et les lichens incrustés sur des dalles peu exposées au soleil ?",
          answer: `<p>Un traitement spécifique est appliqué pour décoller les végétaux sans gratter excessivement. Le brossage mécanique déloge les résidus, puis un rinçage contrôlé évacue les dépôts. Un produit anti-mousse peut être posé en finition pour ralentir la réapparition sur les zones ombragées.</p>`,
        },
        {
          question:
            "Quel traitement anti-mousse appliquez-vous sur une terrasse carrelée sans risque pour les joints et plantes voisines ?",
          answer: `<p>Nous sélectionnons des formulations biodégradables qui agissent sur la mousse sans attaquer les joints ni contaminer le sol environnant. Les plantations proches sont bâchées pendant l'application. Le produit est rincé après action pour éviter toute accumulation résiduelle sur le carrelage.</p>`,
        },
        {
          question:
            "Quand déconseilleriez-vous le karcher haute pression pour une terrasse ancienne ?",
          answer: `<p>Sur les supports poreux, fissurés ou dont les joints sont fragilisés, la haute pression risque d'aggraver les dégâts. Nous privilégions alors un nettoyage doux avec brossage et produit adapté. Cette approche préserve l'intégrité du revêtement tout en obtenant un résultat propre et durable.</p>`,
        },
      ],
      ctaOverride: "",
    },
    {
      ...
      uniqueIntro: `<p>Après plusieurs semaines de travaux ou une période de location, un appartement accumule des traces que le ménage courant ne suffit pas à éliminer. <strong>Le long des Quais de Seine et dans les secteurs proches du centre-ville</strong>, les logements en rotation locative présentent souvent des sols ternis, des vitres voilées et des pièces d'eau entartrées qui compliquent la remise des clés.</p>
...
<p class="mt-4">L'intervention s'organise en coordination avec les contraintes de calendrier. <strong>Fin de chantier pour les livraisons de la ZAC Les Ardoines ou états des lieux locatifs</strong> : le planning s'adapte aux impératifs de remise, avec un diagnostic préalable pour anticiper les besoins spécifiques du logement.</p>`,
      uniqueDeepDive: `<h3>Un logement prêt à la remise</h3>
