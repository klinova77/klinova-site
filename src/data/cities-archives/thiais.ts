const city = {
  ...
  customDescription: "Klinova intervient à Thiais pour l'entretien des parties communes, parkings et espaces extérieurs. Au carrefour de l'A86 et de la N7, nos équipes connaissent les contraintes d'accès liées aux copropriétés denses et aux zones commerciales.",

  // hubIntro : HTML autorisé (voir règles ci-dessous)
  // - 2 paragraphes <p>...</p>
  // - puis une liste à puces <ul><li>...</li></ul>
  hubIntro: `<p>À proximité immédiate de Belle Épine et de l'aéroport d'Orly, Thiais concentre des flux importants qui sollicitent fortement les espaces communs. Klinova accompagne syndics, gestionnaires et occupants avec une organisation calibrée pour ce territoire.</p>
  ...
  services: [
    {
      ...
      uniqueIntro: `<p>Dans la <strong>Zone d'activité Sénia</strong>, les bureaux et locaux tertiaires accueillent un flux constant de collaborateurs et visiteurs. Les dalles textiles des couloirs et les velours ras des salles de réunion accumulent poussières fines, traces de semelles et résidus de boissons. Sans entretien adapté, ces fibres perdent leur tenue et ternissent l'image des espaces professionnels.</p>
...
<p>Après extraction maximale de l'humidité, nous vérifions l'homogénéité du rendu sur l'ensemble des surfaces traitées. Le temps de séchage varie selon l'épaisseur des fibres et la ventilation des locaux — généralement deux à quatre heures pour une remise en service rapide. Des consignes de non-piétinement temporaire sont transmises.</p>`,
    ...
    {
      serviceKey: "parkings",
      heroDescription: "Décrassage complet des sols de parking avec autolaveuse et gestion stricte des eaux usées, pour des surfaces circulables et sécurisées dès la fin d'intervention.",
      whyUsBullets: [
...
<p class="mt-4">Avec la proximité de l'A86 et de la N7, les particules fines et suies grasses pénètrent jusque dans les parkings couverts. Une coordination précise — balisage, rotation des véhicules, créneaux adaptés — garantit un chantier fluide sans bloquer l'accès aux résidents ou visiteurs.</p>`,
      uniqueDeepDive: `<h3>Sol dégraissé et circulable</h3>
...
<p class="mt-4">Un compte-rendu précise l'état constaté et la fréquence recommandée selon le trafic observé.</p>`,
    ...
    {
      serviceKey: "balcons",
      heroDescription: "Remise en état complète de votre balcon à Thiais : traitement des dépôts, nettoyage des garde-corps et gestion maîtrisée des eaux pour un espace extérieur à nouveau utilisable.",
      whyUsBullets: [
...
<p>Le rinçage s'effectue à pression contrôlée pour préserver les joints. Un système anti-coulures protège les balcons inférieurs et la façade. Après évacuation de l'eau résiduelle, le séchage naturel permet une réutilisation sous quelques heures. Nous transmettons des conseils d'entretien pour espacer les prochaines interventions.</p>`,
...

    {
      ...
      heroDescription: "Assainissement complet de votre balcon souillé par les fientes de pigeons, avec désinfection virucide et évacuation sécurisée des déchets contaminés.",
      whyUsBullets: [
...
<p class="mt-4">Des conseils d'entretien prolongent le résultat : fréquence de passage, gestes à éviter entre deux interventions.</p>`,
...

    {
      ...
      heroDescription: "Remise en état complète de votre terrasse à Thiais, avec traitement adapté au support et élimination des dépôts verts, mousses et salissures tenaces pour retrouver un espace extérieur propre et utilisable.",
      whyUsBullets: [
      ...
      uniqueIntro: `<p>Dans les secteurs proches de l'<strong>Avenue de Versailles</strong> et des axes à fort trafic, les terrasses accumulent un voile grisâtre caractéristique. Les particules fines se déposent sur la pierre, le carrelage ou le bois, formant une couche adhérente que le simple jet d'eau ne décolle pas. À cela s'ajoutent les feuilles mortes, les résidus organiques et, dans les zones ombragées, une mousse qui gagne du terrain chaque saison.</p>
...
<p class="mt-4">Des conseils d'entretien saisonnier sont transmis pour prolonger le résultat obtenu.</p>`,
...

    {
      ...
      heroDescription: "Une remise en état complète de votre logement après travaux, déménagement ou avant état des lieux, avec traitement de chaque pièce et contrôle qualité avant remise des clés.",
      whyUsBullets: [
