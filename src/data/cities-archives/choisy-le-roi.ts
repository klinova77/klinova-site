...
const city: City = {
  ...
  customDescription: "Klinova intervient à Choisy-le-Roi pour l'entretien des parties communes, parkings et espaces extérieurs. Entre le quartier du Port et les pavillons des Gondoles, une équipe locale adaptée aux contraintes d'une ville sur deux rives.",

  // hubIntro : HTML autorisé (voir règles ci-dessous)
  // Format : <p>...</p> <p class="mt-4">...</p> <ul>...</ul>
  hubIntro: `<p>Au carrefour du RER C et du Tram T9, Choisy-le-Roi concentre des flux quotidiens importants sur ses deux rives. Klinova accompagne syndics, gestionnaires et occupants dans la gestion régulière de la propreté, avec une organisation pensée pour ce territoire en mutation.</p>
...
<ul>
  ...
  faq: [
    {
      question: "Intervenez-vous rapidement en cas de besoin urgent sur Choisy-le-Roi ?",
      answer: `<p>Oui, notre équipe basée en Île-de-France peut se mobiliser sous <strong>24 à 48 heures</strong> selon la nature de la demande. Pour les situations critiques (dégât des eaux, souillure importante), nous priorisons l'intervention afin de limiter la gêne pour les occupants ou usagers du site.</p>`,
    },
    {
      question: "Comment se passe la prise de rendez-vous pour un devis ?",
      answer: `<p>Nous organisons une visite technique sur place pour évaluer les surfaces, les accès et les contraintes spécifiques. À Choisy-le-Roi, cela inclut souvent la <strong>vérification du stationnement</strong> près du chantier et la coordination avec le gardien ou le syndic. Le devis est transmis sous 48 heures après passage.</p>`,
    },
    {
      question: "Pouvez-vous intervenir en dehors des heures de bureau ?",
      answer: `<p>Oui, nous proposons des créneaux en <strong>horaires décalés</strong> (tôt le matin, soirée) pour les sites où la présence de personnel ou de résidents complique l'accès en journée. C'est fréquent pour les parkings souterrains ou les halls d'immeubles à fort passage.</p>`,
    },
    {
      question: "Travaillez-vous avec les syndics et bailleurs sociaux ?",
      answer: `<p>Nous collaborons régulièrement avec des <strong>syndics professionnels</strong> et des bailleurs pour des interventions ponctuelles ou récurrentes. Facturation claire, reporting adapté aux exigences de gestion, et souplesse sur les plannings de rotation des locataires ou copropriétaires.</p>`,
    },
  ],
  ...
  services: [
    {
      ...
      heroDescription: "Extraction en profondeur des salissures incrustées dans vos moquettes, avec traitement adapté aux fibres et séchage maîtrisé pour une remise en service rapide.",
      whyUsBullets: [
      ...
      uniqueIntro: `<p>Dans le <strong>Quartier du Port</strong>, les parties communes des résidences récentes accumulent rapidement poussières et traces de passage. Les bureaux proches des programmes neufs subissent le même phénomène : couloirs fréquentés, zones d'attente sollicitées, fibres qui ternissent malgré l'aspiration régulière. Le trafic quotidien laisse des dépôts que le simple entretien courant ne suffit pas à éliminer.</p>
...
<p>Les angles, dessous de mobilier et recoins font l'objet d'un traitement complémentaire. L'extraction maximale de l'humidité réduit le temps de séchage. Selon l'épaisseur du revêtement et la ventilation disponible, comptez entre 4 et 8 heures avant piétinement normal.</p>`,
      ...
      faqAdditions: [
        {
          question: "Les cages d'escalier étroites du centre-ville près de la gare compliquent l'accès : comment procédez-vous pour nettoyer la moquette ?",
          answer: `<p>Nous utilisons du matériel compact adapté aux passages restreints. Les tuyaux et buses sont dimensionnés pour manœuvrer dans les angles serrés. L'intervention se fait par sections successives afin de ne pas encombrer les circulations et de permettre aux résidents d'accéder à leur logement.</p>`,
        },
        {
          question: "Une moquette de palier au Quartier du Port présente des taches anciennes : quelles solutions pour une remise en état durable ?",
          answer: `<p>Un pré-traitement enzymatique est appliqué sur les zones marquées avant l'injection-extraction. Cette méthode décolle les résidus incrustés sans agresser les fibres. Selon l'ancienneté des taches, plusieurs passes peuvent être nécessaires pour obtenir un rendu homogène et prolonger la tenue du revêtement.</p>`,
        },
        {
          question: "Pour des dalles textiles en bureaux administratifs, quelle méthode offre le meilleur résultat sans risque pour le support ?",
          answer: `<p>L'injection-extraction reste la technique la plus adaptée aux dalles textiles. Elle limite l'apport d'eau tout en assurant une extraction efficace des salissures. La vapeur seule convient aux désinfections légères mais ne retire pas les particules incrustées. Nous ajustons la pression et le débit selon la densité du tissage.</p>`,
        },
        {
          question: "Avec un stationnement saturé près de la gare RER C, comment organisez-vous la logistique pour intervenir sur les moquettes ?",
          answer: `<p>Nous repérons en amont les possibilités de stationnement ou de dépose rapide. Le matériel est conditionné pour un transport efficace sur courte distance. Les créneaux d'intervention sont calés en dehors des pics de circulation afin de réduire les contraintes d'accès et de respecter les délais convenus.</p>`,
        },
      ],
      ctaOverride: "",
    },
    ...
    {
      serviceKey: "parkings",
      heroDescription: "Décrassage complet des sols de parkings souterrains et aériens, avec traitement des taches d'huile, gestion rigoureuse des eaux usées et coordination des accès pour limiter la gêne aux résidents.",
      whyUsBullets: [
...
<p>L'objectif est d'obtenir un revêtement débarrassé des graisses, huiles et poussières incrustées. Les rampes retrouvent leur adhérence, les zones de circulation leur aspect propre. Le résultat se constate dès la fin du passage : sol uniforme, sans traces résiduelles ni flaques stagnantes.</p>
...
<p>L'autolaveuse ou la haute pression associée à un dégraissant adapté traite les surfaces. Les angles morts, pieds de murs et rigoles reçoivent une attention particulière. Les eaux de lavage sont collectées et dirigées vers les évacuations conformes, sans rejet sauvage. Un dépoussiérage aérien des blocs lumineux peut compléter l'intervention si demandé.</p>`,
      specificChallenges: [
        "Sous-sols du Quartier du Port : rampes étroites et ventilation limitée imposent un matériel adapté.",
      ...
      faqAdditions: [
        {
          question: "Quelle différence de méthode entre un parking souterrain du Quartier du Port et un parking aérien aux Gondoles ?",
          answer: `<p>Le souterrain sous dalle présente un béton brut sensible aux produits agressifs : on privilégie un dégraissant neutre et une autolaveuse à faible pression. En aérien, l'enrobé supporte mieux la haute pression, ce qui accélère le décrassage des zones exposées aux intempéries et à la poussière de circulation.</p>`,
        },
        {
          question: "Des taches d'huile anciennes marquent la rampe d'accès proche de l'A86 : quel procédé utilisez-vous ?",
          answer: `<p>Un dégraissant alcalin est appliqué en prétraitement sur les zones imprégnées. Après un temps de contact adapté, le passage de l'autolaveuse ou de la haute pression déloge les résidus incrustés. Les rampes retrouvent leur adhérence sans risque de glissance résiduelle après séchage.</p>`,
        },
        {
          question: "Comment gérez-vous les eaux de lavage lors d'une intervention en sous-sol de copropriété ?",
          answer: `<p>Les eaux chargées sont dirigées vers les regards existants après vérification de leur état. Si les évacuations sont obstruées ou non conformes, on procède à une aspiration pour éviter tout rejet sauvage. Le syndic reçoit un compte-rendu précisant les volumes traités et l'état des canalisations.</p>`,
        },
        {
          question: "Pour un parking proche du marché du Centre, quels horaires privilégier afin de limiter la gêne ?",
          answer: `<p>Les jeudis et dimanches matins sont à éviter en raison de l'affluence liée au marché. On recommande une intervention en début d'après-midi ou en soirée, après concertation avec le gestionnaire pour informer les résidents et organiser le déplacement temporaire des véhicules concernés.</p>`,
        },
      ],
      ctaOverride: "",
    },
    ...
    {
      serviceKey: "balcons",
      heroDescription: "Remise en état complète de votre balcon à Choisy-le-Roi : traitement des dépôts, brossage adapté au support et rinçage contrôlé pour un espace extérieur à nouveau agréable.",
      whyUsBullets: [
      ...
      uniqueIntro: `<p>Dans le secteur du Centre-Ville et le long de l'avenue Anatole France, les balcons accumulent rapidement une couche grisâtre. La circulation dense sur cet axe structurant dépose un film de particules fines qui s'incruste dans les joints et ternit les surfaces. Les dépôts verts s'installent dès que l'humidité persiste, surtout sur les expositions nord ou à l'ombre des bâtiments voisins.</p>
...
<p>Un produit adapté au support est appliqué : formulation douce sur carrelage, solution désincrustante sur béton brut. Le brossage — manuel ou mécanique selon l'état — déloge les salissures incrustées dans les joints et sur les dalles. Le garde-corps, les vitrages latéraux et les murs mitoyens accessibles sont traités dans la foulée.</p>
...
<p>Le rinçage s'effectue à pression contrôlée pour préserver les joints fragiles. L'eau est dirigée vers l'évacuation sans coulures chez les voisins du dessous. Après séchage, quelques conseils d'entretien courant sont transmis pour prolonger la propreté obtenue.</p>`,
      specificChallenges: [
        "Pollution routière sur les balcons proches du Pont de Choisy : film gras à traiter en profondeur.",
        "Loggias du Quartier du Port avec évacuation intégrée : rinçage à adapter pour éviter les refoulements.",
      ...
      faqAdditions: [
        {
          question: "Balcons en béton des grands ensembles (Navigateurs) : quelles précautions techniques pour nettoyer sans abîmer le support ?",
          answer: `<p>Le béton brut est poreux et peut se dégrader sous une pression trop forte. Nous utilisons un brossage mécanique adapté et une pression modérée. Le produit désincrustant agit en profondeur avant rinçage, ce qui limite l'agression mécanique tout en éliminant les salissures incrustées.</p>`,
        },
        {
          question: "Balcon fortement encrassé par la pollution routière près du Pont de Choisy : quelle méthode recommandez-vous ?",
          answer: `<p>Les dépôts gras liés au trafic nécessitent un dégraissant spécifique appliqué avant brossage. La surface est ensuite rincée à pression contrôlée. Sur carrelage ou béton, ce traitement retire le film noirâtre sans endommager les joints ni les finitions.</p>`,
        },
        {
          question: "Que prévoir concernant l'évacuation des eaux et le risque de coulures pour un balcon rue Anatole France ?",
          answer: `<p>Avant de commencer, nous repérons le point d'évacuation et protégeons les abords. Le rinçage est orienté vers la descente d'eau, avec un débit maîtrisé. Si le balcon surplombe un autre espace, nous prévenons les occupants et installons une protection temporaire.</p>`,
        },
        {
          question: "Intervention sur balcon en loggia au 6ème étage du Port : comment procédez-vous sans nacelle ?",
          answer: `<p>L'intervention se fait depuis l'intérieur du logement. Le matériel — aspirateur, brosses, nettoyeur basse pression — est monté par l'équipe. L'accès par digicode est coordonné en amont. Aucun équipement extérieur n'est nécessaire pour ce type de configuration.</p>`,
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription: "Assainissement complet de votre balcon souillé par les fientes de pigeons, avec désinfection virucide et conseils de prévention pour éviter le retour des nuisibles.",
      whyUsBullets: [
...
<p>L'objectif est de restituer un espace extérieur propre, sans odeur ni risque sanitaire. Les fientes sont intégralement retirées du sol, du garde-corps et des vitrages. Une désinfection virucide et bactéricide élimine les agents pathogènes. Le balcon redevient utilisable après un délai d'aération de quelques heures.</p>
...
<p>Chaque surface reçoit un nettoyage adapté : sol béton, métal du garde-corps, vitrage. Le produit désinfectant agit pendant le temps de contact requis avant rinçage. Nous proposons ensuite des solutions anti-retour — pics sur les rebords, filets de protection — pour limiter la réinstallation des pigeons.</p>`,
      specificChallenges: [
        "Proximité du Parc des Gondoles : pigeons et oiseaux trouvent refuge dans les arbres et nichent sur les balcons voisins.",
        ...
        "Loggias du Quartier du Port parfois fermées : confinement renforcé nécessaire pour éviter dispersion des poussières.",
        "Odeurs persistantes si le traitement se limite au rinçage sans désinfection adaptée.",
      ],
      faqAdditions: [
        {
          question: "Des fientes se sont accumulées sur le rebord de ma fenêtre près du centre-ville : quels risques sanitaires et que faire en urgence ?",
          answer: `<p>Les fientes de pigeons peuvent contenir des agents pathogènes (bactéries, champignons) susceptibles de provoquer des infections respiratoires. En attendant l'intervention, évitez de manipuler les dépôts à mains nues et aérez sans balayer à sec. Nous intervenons rapidement pour retirer les souillures et désinfecter la zone concernée.</p>`,
        },
        {
          question: "Sur les balcons exposés aux pigeons le long des bords de Seine, quels équipements de protection utilisez-vous ?",
          answer: `<p>L'équipe porte systématiquement masque FFP2, lunettes, gants et combinaison jetable. La zone est bâchée pour confiner les poussières. Les fientes sont humidifiées avant collecte afin d'éviter toute dispersion de particules contaminées vers l'intérieur du logement ou les balcons voisins.</p>`,
        },
        {
          question: "Après le retrait des fientes sur les corniches anciennes du centre, quelle désinfection appliquez-vous ?",
          answer: `<p>Nous utilisons un produit virucide et bactéricide homologué, appliqué sur l'ensemble des surfaces nettoyées. Le temps de contact est respecté avant rinçage pour garantir l'élimination des agents pathogènes. Cette étape est indispensable sur les supports poreux comme le béton ou la pierre ancienne.</p>`,
        },
        {
          question: "Comment gérez-vous l'évacuation des déchets lors d'une intervention sur un immeuble du Quartier du Port ?",
          answer: `<p>Les fientes collectées sont conditionnées dans des sacs étanches fermés hermétiquement. Nous les évacuons avec notre matériel, sans laisser de résidus dans les parties communes. Cette organisation limite les nuisances pour les voisins et garantit une intervention propre du début à la fin.</p>`,
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription: "Détachage et nettoyage en profondeur de vos canapés, tapis et matelas à Choisy-le-Roi, avec extraction des salissures incrustées et séchage maîtrisé pour une remise en service rapide.",
      whyUsBullets: [
      ...
      uniqueIntro: `<p>Comment préserver la fraîcheur d'un canapé quand la vie de famille s'y installe au quotidien ? Dans les zones résidentielles comme le quartier des Gondoles Sud ou Briand-Pelloutier, les textiles d'ameublement absorbent les traces du quotidien : taches de boissons renversées, marques laissées par les animaux, poussières qui s'accumulent dans les fibres. Ces salissures s'incrustent progressivement et finissent par altérer l'aspect général du mobilier.</p>
...
<p>Le traitement principal utilise la technique d'injection-extraction : l'eau et le produit nettoyant pénètrent les fibres, puis sont aspirés avec les salissures dissoutes. La pression et la température s'ajustent selon la fragilité du textile. L'extraction maximale réduit le temps de séchage. Nous vous indiquons le délai de remise en service selon l'épaisseur et la ventilation du logement.</p>`,
      specificChallenges: [
        ...
        "Taches d'animaux et odeurs persistantes dans les foyers familiaux du quartier des Gondoles.",
        "Escaliers étroits dans le centre ancien compliquant l'accès avec le matériel d'extraction.",
      ...
      faqAdditions: [
        {
          question: "Canapé en tissu non déhoussable dans un appartement locatif proche du RER : quelle méthode utilisez-vous ?",
          answer: `<p>Pour les canapés non déhoussables, nous procédons par injection-extraction directement sur le tissu en place. Cette technique permet de nettoyer en profondeur sans démonter l'assise. La pression et la température sont ajustées selon la fibre identifiée lors du diagnostic initial, qu'il s'agisse de coton, synthétique ou velours.</p>`,
        },
        {
          question: "Pour réduire les acariens et allergènes dans un canapé familial du quartier des Gondoles, quel résultat peut-on attendre après nettoyage pro ?",
          answer: `<p>L'extraction mécanique déloge les acariens et leurs déjections logés dans les fibres. Le passage en profondeur aspire également les poussières fines et résidus organiques. Après séchage complet, le textile présente une charge allergénique nettement diminuée. Pour les foyers sensibles, nous recommandons un entretien régulier adapté à l'usage quotidien.</p>`,
        },
        {
          question: "Accès compliqué et stationnement difficile en centre-ville : comment organisez-vous l'intervention ?",
          answer: `<p>Nous anticipons les contraintes d'accès dès la prise de rendez-vous. Pour les immeubles anciens avec escaliers étroits, le matériel est adapté en conséquence. Le créneau d'intervention tient compte des horaires de stationnement autorisé. Cette préparation évite les retards et garantit une intervention fluide malgré la configuration du quartier.</p>`,
        },
        {
          question: "Taches et odeur d'urine animale sur un canapé : quel niveau d'élimination et séchage garantissez-vous ?",
          answer: `<p>Les souillures organiques comme l'urine nécessitent un pré-traitement enzymatique qui décompose les résidus en profondeur. L'extraction retire ensuite les substances dissoutes. L'odeur disparaît progressivement avec le séchage complet. Sur taches récentes, le résultat est généralement excellent. Sur marques anciennes, une amélioration significative reste visible même si une légère trace peut subsister.</p>`,
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription: "Remise en état complète de votre terrasse avec traitement adapté au support, élimination des mousses et dépôts verts, et application d'un produit préventif pour prolonger la propreté.",
      whyUsBullets: [
...
<p class="mt-4">Avant de partir, nous indiquons la fréquence d'entretien recommandée selon l'exposition et l'environnement de votre terrasse.</p>`,
      specificChallenges: [
        "Mousses tenaces sur dalles exposées à l'humidité des bords de Seine.",
      ...
      faqAdditions: [
        {
          question: "Ma terrasse proche de la Seine est couverte de mousse verte : quel traitement permet d'éviter que ça revienne chaque année ?",
          answer: `<p>Après le nettoyage en profondeur, nous appliquons un produit anti-mousse préventif qui freine la réapparition des dépôts verts. L'efficacité dépend de l'exposition et de l'humidité ambiante. Sur les terrasses proches de la Seine, un entretien annuel reste conseillé pour maintenir le résultat dans la durée.</p>`,
        },
        {
          question: "Sur les dalles carrelées d'un pavillon aux Gondoles, quel produit utilisez-vous sans risquer d'abîmer le carrelage ?",
          answer: `<p>Nous sélectionnons un désincrustant adapté au type de carrelage : formule neutre sur les surfaces émaillées, produit légèrement acide sur les dalles minérales résistantes. Le brossage mécanique complète l'action chimique. Les joints sont traités avec précaution pour éviter toute dégradation.</p>`,
        },
        {
          question: "Faut-il utiliser la haute pression sur une terrasse en bois composite ou existe-t-il une méthode plus douce ?",
...

    {
      ...
      heroDescription: "Une remise en état complète de votre appartement ou maison à Choisy-le-Roi, avec traitement de chaque pièce et finitions soignées pour une restitution ou une entrée dans les lieux sans mauvaise surprise.",
      whyUsBullets: [
      ...
      uniqueIntro: `<p>Après plusieurs mois de location ou à la fin d'un chantier de rénovation, un logement accumule des traces que le ménage courant ne suffit pas à effacer. Autour du tramway T9 et de la gare RER C, la rotation locative génère des besoins réguliers de remise en état avant ou après état des lieux. Les résidus de peinture, les joints de salle de bain ternis ou les sols encrassés deviennent alors des points de friction entre locataires, propriétaires et agences.</p>
...
<p>Interrupteurs, poignées de portes, radiateurs et intérieurs de placards sont passés en revue. Un contrôle final permet de vérifier l'absence de traces résiduelles. Le logement est ensuite aéré pour une remise en service rapide selon le planning convenu avec le donneur d'ordre.</p>`,
      specificChallenges: [
        "Résidus de chantier dans les appartements neufs du Quartier du Port : colle, enduit, poussière de plâtre.",
        "Rotation locative soutenue près du RER C et du T9 : délais serrés pour les états des lieux.",
      ...
      faqAdditions: [
        {
          question: "Nettoyage après chantier sur appartement neuf du Port : quelles tâches spécifiques (peinture, colle) traitez-vous ?",
          answer: `<p>Nous retirons les résidus de peinture sur les encadrements, les traces de colle sur les sols et la poussière de plâtre accumulée dans les placards et sur les plinthes. Les vitres intérieures et les sanitaires sont également nettoyés pour une livraison conforme aux attentes du promoteur ou du propriétaire.</p>`,
        },
        {
          question: "Pour un nettoyage avant état des lieux proche du T9, comment coordonnez-vous l'intervention avec l'agence et le propriétaire ?",
          answer: `<p>Nous calons la date et l'heure directement avec l'agence ou le gestionnaire, en tenant compte du créneau de l'état des lieux. Les clés peuvent être récupérées en agence ou auprès du gardien. Un compte rendu est transmis si nécessaire pour confirmer la réalisation de la prestation.</p>`,
        },
        {
          question: "Quel niveau de propreté (détail) garantissez-vous pour une remise en location dans un appartement près du RER C ?",
          answer: `<p>Nous visons un logement prêt à être occupé : sols lavés, sanitaires détartrés, cuisine dégraissée, vitres intérieures propres, placards vidés et essuyés. Le niveau de finition correspond aux standards attendus lors d'un état des lieux d'entrée, sans traces ni résidus visibles.</p>`,
        },
        {
          question: "Appartement au troisième étage sans ascenseur dans le centre : quelles options logistiques proposez-vous ?",
          answer: `<p>Nous adaptons le matériel transporté pour limiter les allers-retours. L'équipe monte l'essentiel en une fois et organise l'intervention de manière à ne pas bloquer les parties communes. Le stationnement est anticipé pour éviter les contraintes liées aux rues étroites du centre ancien.</p>`,
        },
      ],
      ctaOverride: "",
    },
