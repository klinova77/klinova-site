...
const city: City = {
  ...
  customDescription: "Klinova intervient à Orly pour l'entretien des parties communes, parkings souterrains et espaces extérieurs. Une organisation adaptée aux contraintes des grands ensembles comme aux pavillons de la Cité Jardins.",
  ...
  hubIntro: `<p>Ville aéroportuaire aux quartiers pavillonnaires historiques, Orly concentre des besoins variés en propreté : halls d'immeubles collectifs, parkings de résidences, balcons exposés aux retombées atmosphériques. Klinova structure ses interventions pour répondre à cette diversité de bâti.</p>
...
<ul>
  ...
  nearbyCities: ["Thiais", "Choisy-le-Roi", "Villeneuve-le-Roi", "Paray-Vieille-Poste"],
  ...
  faq: [
    {
      question: "Comment organisez-vous vos interventions dans les quartiers où le stationnement est difficile ?",
      answer: `<p>Nous repérons en amont les <strong>zones de stationnement autorisées</strong> et les créneaux les moins contraints. Dans le Vieil Orly ou près de la gare, nous privilégions les interventions tôt le matin ou en milieu de journée pour éviter les pics de circulation et faciliter l'accès au matériel.</p>`,
    },
    {
      question: "Pouvez-vous intervenir dans des résidences avec digicode et gardien ?",
      answer: `<p>Oui, nous travaillons régulièrement avec des <strong>résidences sécurisées</strong>. Avant l'intervention, nous récupérons les codes d'accès ou badges nécessaires auprès du syndic ou du gardien. Le créneau est confirmé pour garantir l'ouverture des accès le jour prévu.</p>`,
    },
    {
      question: "Quel délai pour une première intervention à Orly ?",
      answer: `<p>En général, nous proposons un <strong>premier passage sous 5 à 7 jours ouvrés</strong> après validation du devis. Pour les demandes urgentes — dégradation importante ou état des lieux imminent — nous étudions la possibilité d'un créneau anticipé selon la disponibilité de l'équipe.</p>`,
    },
    {
      question: "Travaillez-vous avec les bailleurs sociaux présents sur la commune ?",
      answer: `<p>Nous intervenons pour des <strong>copropriétés et résidences gérées par différents bailleurs</strong>. Nos méthodes s'adaptent aux cahiers des charges spécifiques : horaires décalés, balisage des zones traitées, reporting post-intervention si demandé par le gestionnaire.</p>`,
    },
  ],
  ...
  services: [
    {
      ...
      heroDescription: "Extraction des salissures incrustées dans vos moquettes de bureaux ou parties communes, avec séchage maîtrisé pour une reprise d'activité rapide selon les contraintes du site.",
      whyUsBullets: [
      ...
      uniqueIntro: `<p>Dans les locaux de la <strong>Zone Senia</strong>, les moquettes des bureaux et espaces de circulation accumulent rapidement poussières fines et traces de boue. Le trafic logistique environnant ramène des particules grasses qui s'incrustent dans les fibres, ternissant l'aspect général des sols textiles en quelques semaines seulement.</p>
<p class="mt-4">Sur les <strong>dalles plombantes</strong> fréquentes dans les open spaces ou les <strong>velours ras</strong> des halls d'hôtels proches de l'aéroport, ces dépôts créent des zones grisâtres aux passages intensifs. L'image professionnelle s'en trouve affectée, et les occupants signalent parfois une sensation de sol "collant" ou poussiéreux malgré l'aspiration régulière.</p>
<p class="mt-4">La <strong>rotation élevée dans les hôtels</strong> et le flux constant de véhicules sur le secteur génèrent un encrassement récurrent. Une intervention structurée permet de traiter chaque type de revêtement selon sa nature, avec un diagnostic préalable des zones de trafic et des taches spécifiques à cibler.</p>`,
      uniqueDeepDive: `<h3>Zones de passage intensif</h3>
<p>Les couloirs, entrées et espaces devant ascenseurs concentrent l'essentiel des salissures. Le diagnostic identifie le type de fibre — bouclée, velours ou dalle plombante — pour adapter la pression d'injection. Les protections sont posées sur les plinthes et bas de murs avant traitement.</p>

<h3>Surfaces de travail et espaces ouverts</h3>
<p>Les open spaces et salles de réunion reçoivent un traitement par injection-extraction sur l'ensemble de la surface. Les taches localisées — café, encre, traces grasses — font l'objet d'un détachage ciblé avant le passage général. Plusieurs passes sont effectuées sur les zones les plus sollicitées.</p>
...
<p>L'extraction maximale de l'eau limite le temps d'humidité résiduelle. Selon l'épaisseur du revêtement et la ventilation du local, le séchage complet intervient sous 4 à 8 heures. Un balisage temporaire permet de maintenir l'activité sur les zones déjà sèches pendant la fin de l'intervention.</p>`,
      specificChallenges: [
        "Boue et poussières grasses ramenées par le trafic camions de la Zone Senia.",
        "Dalles plombantes en bureaux nécessitant une extraction puissante sans décollement.",
        "Moquettes velours ras des hôtels à traiter entre deux rotations de chambres.",
        "Halls de copropriétés proches de la gare Orly Ville avec passages fréquents.",
        "Séchage à maîtriser pour reprise rapide des activités professionnelles.",
      ],
      faqAdditions: [
        {
          question: "Les escaliers étroits des immeubles proches de la Zone Senia empêchent-ils la montée d'une shampouineuse professionnelle ?",
          answer: `<p>Nos équipements sont dimensionnés pour passer dans les cages d'escalier standard des immeubles du secteur. Pour les accès particulièrement contraints, nous utilisons des machines compactes avec flexibles allongés. Le diagnostic préalable permet d'anticiper ces configurations et d'adapter le matériel mobilisé.</p>`,
        },
        {
          question: "Quelle méthode recommandez-vous pour des dalles plombantes en bureaux de la Zone Senia : injection-extraction ou shampouinage ?",
          answer: `<p>L'injection-extraction reste la méthode de référence pour les dalles plombantes. Elle permet une pénétration contrôlée de la solution nettoyante et une aspiration immédiate, sans risque de décollement. Le shampouinage convient davantage aux moquettes collées en plein, mais laisse plus de résidus dans les fibres denses.</p>`,
        },
        {
          question: "Comment traitez-vous des taches anciennes et incrustées sur moquette de parties communes proches de la gare Orly Ville ?",
          answer: `<p>Les taches anciennes font l'objet d'un pré-traitement avec un détachant adapté à leur nature — tanin, graisse ou protéine. Après un temps de pose, l'injection-extraction déloge les résidus en profondeur. Certaines marques très anciennes peuvent s'atténuer sans disparaître totalement selon l'état de la fibre.</p>`,
        },
        {
          question: "Après un nettoyage en hôtel proche de l'aéroport, quel temps de séchage faut-il prévoir avant réutilisation ?",
          answer: `<p>Sur un velours ras bien ventilé, le séchage complet intervient généralement sous 4 à 6 heures. Pour les moquettes plus épaisses ou les pièces peu aérées, comptez jusqu'à 8 heures. Nous pouvons intervenir en fin de journée pour une remise en service dès le lendemain matin.</p>`,
        },
      ],
      ctaOverride: "",
    },
    ...
    {
      serviceKey: "parkings",
      heroDescription: "Décrassage complet des sols de parking avec autolaveuse et gestion stricte des eaux usées, rotation des véhicules coordonnée avec le syndic pour limiter la gêne aux résidents.",
      whyUsBullets: [
...
<p class="mt-4">Nous organisons chaque intervention en coordination avec le syndic : balisage des zones, rotation des véhicules par secteur, <strong>horaires adaptés hors pics de départs</strong> vers l'aéroport ou les transports. Le compte-rendu photographique permet de suivre l'évolution entre deux passages.</p>`,
      uniqueDeepDive: `<h3>Sol dégraissé et rampes antidérapantes</h3>
...
<p>Le balisage sécurise chaque zone pendant le chantier. La rotation des véhicules s'effectue par secteur, en lien avec le gardien ou le syndic. Une fois le sol sec, nous transmettons un compte-rendu avec recommandations de fréquence selon le trafic constaté.</p>`,
      ...
      faqAdditions: [
        {
          question: "À quelle fréquence faut-il nettoyer les parkings souterrains des grands ensembles comme Les Navigateurs ?",
          answer: `<p>Le trafic quotidien et les dépôts de suie liés à la proximité de l'aéroport accélèrent l'encrassement. Un passage trimestriel maintient un sol correct. Pour les copropriétés à fort trafic, un rythme bimestriel évite l'accumulation de graisse sur les rampes et dans les rigoles.</p>`,
        },
        {
          question: "Comment traitez-vous les taches d'huile anciennes sur les rampes béton des parkings d'Orly ?",
          answer: `<p>Nous appliquons un dégraissant alcalin sur les zones imprégnées, suivi d'un brossage mécanique. La haute pression déloge les résidus incrustés. Sur béton brut poreux, plusieurs passes peuvent être nécessaires. Le résultat dépend de l'ancienneté de la tache, mais l'aspect général s'améliore nettement.</p>`,
        },
        {
          question: "Comment gérez-vous les eaux de lavage lors d'un nettoyage haute pression dans un parking proche de la gare Orly Ville ?",
          answer: `<p>Les eaux chargées sont dirigées vers les évacuations existantes du parking. Nous vérifions au préalable que les regards ne sont pas obstrués. Aucun rejet n'est effectué vers la voirie ou les espaces verts. En cas de doute sur le réseau, nous adaptons le volume d'eau utilisé.</p>`,
        },
        {
          question: "Quels horaires privilégiez-vous pour intervenir dans un parking géré près de l'aéroport sans gêner les usagers ?",
          answer: `<p>Les départs vers l'aéroport se concentrent tôt le matin. Nous intervenons plutôt en milieu de matinée ou en début d'après-midi, quand le parking est moins sollicité. Les horaires sont validés avec le syndic ou le gestionnaire pour limiter la gêne aux résidents et aux professionnels.</p>`,
        },
      ],
      ctaOverride: "",
    },
    ...
    {
      serviceKey: "balcons",
      heroDescription: "Remise en état complète de votre balcon à Orly, avec traitement adapté au support, protection des voisins du dessous et séchage contrôlé pour un espace extérieur à nouveau utilisable.",
      whyUsBullets: [
...
<p class="mt-4">La proximité des axes A106 et N7 impose un protocole qui tient compte de cette pollution grasse récurrente. Nous adaptons le traitement au support identifié lors du diagnostic, avec une gestion stricte des écoulements pour éviter tout désagrément aux étages inférieurs.</p>`,
      uniqueDeepDive: `<h3>Dépôts gras et poussières accumulées</h3>
...
<p>Une fois le balcon rincé, nous vérifions l'absence de traces résiduelles. Le temps de séchage varie selon l'exposition et la saison. Nous vous indiquons la fréquence de nettoyage recommandée compte tenu de votre environnement direct.</p>`,
      ...
      faqAdditions: [
        {
          question: "Quelle méthode utilisez-vous pour un balcon en béton sur l'Avenue Adrien Raynal sans abîmer les joints ?",
          answer: `<p>Nous appliquons un dégraissant adapté au béton, suivi d'un brossage manuel ciblé sur les zones encrassées. Le rinçage s'effectue à pression modérée pour évacuer les résidus sans creuser les joints. Cette approche convient aux balcons exposés aux retombées routières fréquentes dans ce secteur.</p>`,
        },
        {
          question: "Comment gérez-vous l'eau et les coulures lors du nettoyage d'un balcon en étage dans le Vieil Orly ?",
          answer: `<p>Nous utilisons des quantités d'eau maîtrisées et orientons le rinçage vers les évacuations existantes. Si nécessaire, nous installons des protections temporaires pour canaliser les écoulements. Les voisins du dessous sont prévenus en amont lorsque l'intervention le justifie.</p>`,
        },
        {
          question: "Nettoyez-vous différemment une loggia fermée et un balcon ouvert dans les immeubles des années 70 à Orly ?",
          answer: `<p>Une loggia fermée retient davantage l'humidité et les odeurs, ce qui impose une ventilation pendant le séchage. Le balcon ouvert sèche plus vite mais accumule plus de poussières. Nous adaptons le produit et le temps de pose selon cette configuration pour un résultat homogène.</p>`,
        },
        {
          question: "Après nettoyage d'un balcon exposé aux retombées routières, combien de temps avant de pouvoir l'utiliser ?",
          answer: `<p>Le séchage complet prend généralement quelques heures selon l'exposition et la météo. En été, un balcon orienté sud peut être praticable en fin de journée. Nous vous indiquons le délai estimé à la fin de l'intervention pour que vous puissiez planifier votre usage.</p>`,
        },
      ],
      ctaOverride: "",
    },
...
<p class="mt-4">Si nécessaire, des pics anti-pigeons ou un gel répulsif peuvent être posés sur les rebords et corniches pour limiter le retour des volatiles.</p>`,
      ...
      faqAdditions: [
        {
          question: "Les fientes accumulées sur ma corniche près du Marché du Vieil Orly représentent-elles un danger sanitaire ?",
        ...
        {
          question: "Quel type de désinfection appliquez-vous après le retrait des fientes sur un balcon à Orly ?",
          answer: `<p>Nous utilisons un produit virucide et bactéricide homologué, appliqué sur l'ensemble des surfaces nettoyées. Le temps de contact est respecté avant rinçage pour garantir l'élimination des agents pathogènes. Cette étape est systématique, quel que soit le volume de fientes traité.</p>`,
        },
        {
          question: "Comment évacuez-vous les déchets contaminés après un assainissement de balcon en immeuble collectif ?",
          answer: `<p>Les fientes et résidus sont conditionnés dans des sacs étanches fermés hermétiquement. Nous les évacuons avec notre matériel pour éviter tout contact avec les parties communes. Le bâchage préalable protège également le logement et les balcons voisins pendant l'intervention.</p>`,
        },
        {
          question: "À quelle fréquence conseillez-vous un traitement pour les balcons exposés aux arbres matures du quartier Les Saules ?",
          answer: `<p>Les arbres matures offrent des perchoirs aux pigeons, ce qui augmente les dépôts sur les balcons proches. Sans dispositif dissuasif, un nettoyage tous les six mois peut être nécessaire. La pose de pics ou filets après le premier traitement réduit significativement cette fréquence.</p>`,
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription: "Un détachage en profondeur de vos textiles d'ameublement, avec extraction des salissures incrustées et séchage maîtrisé pour retrouver un canapé, tapis ou matelas propre et sain.",
      whyUsBullets: [
...
<p>L'extraction maximale limite le temps de séchage. Selon l'épaisseur du textile et la ventilation de la pièce, comptez quelques heures avant de réutiliser le mobilier. Nous vous indiquons les consignes d'aération et la fréquence d'entretien recommandée pour prolonger la propreté obtenue.</p>`,
      ...
      faqAdditions: [
        {
          question: "Quelle méthode utilisez-vous pour un canapé tissu non déhoussable dans un pavillon près du Parc de la Cloche ?",
          answer: `<p>Nous procédons par injection-extraction directement sur place. Après identification du tissu et test sur zone cachée si nécessaire, le nettoyage s'effectue sans démonter le canapé. La pression et la température sont ajustées pour préserver les fibres tout en éliminant les salissures incrustées.</p>`,
        },
        {
          question: "Pouvez-vous traiter des taches anciennes de café ou de vin sur un tapis dans un pavillon de la Cité Jardins ?",
          answer: `<p>Les taches anciennes nécessitent un pré-traitement enzymatique ciblé avant l'extraction. L'efficacité dépend de l'ancienneté et du type de fibre, mais nous obtenons généralement une nette amélioration. Si la tache a altéré la couleur du textile, nous vous le signalons dès le diagnostic.</p>`,
        },
        {
          question: "Quel temps de séchage prévoir après un nettoyage de canapé pour un logement avec rotation fréquente ?",
          answer: `<p>Comptez entre deux et six heures selon l'épaisseur du textile et la ventilation de la pièce. Nous extrayons un maximum d'humidité pour accélérer le séchage. Une bonne aération après notre passage permet de réduire ce délai et de remettre le mobilier en service rapidement.</p>`,
        },
        {
          question: "Comment organisez-vous une intervention si le stationnement est impossible dans le Vieil Orly ?",
          answer: `<p>Nous anticipons ce point dès la prise de rendez-vous. Selon la configuration, nous identifions une place à proximité ou convenons d'un créneau où le stationnement est plus accessible. Le matériel portable permet de rejoindre le logement à pied sur une courte distance si nécessaire.</p>`,
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription: "Remise en état complète de votre terrasse avec traitement adapté au support, élimination des mousses et dépôts verts, pour retrouver un espace extérieur propre et utilisable.",
      whyUsBullets: [
...
<p>Les garde-corps et murets périphériques sont traités si nécessaire. Après séchage, un traitement anti-mousse préventif peut être appliqué pour ralentir la recolonisation. Des recommandations d'entretien saisonnier sont transmises pour prolonger le résultat obtenu.</p>`,
      ...
      faqAdditions: [
        {
          question: "Quel traitement privilégiez-vous pour une terrasse en dalles gravillonnées dans le quartier Cité Jardins ?",
          answer: `<p>Les dalles gravillonnées nécessitent un désincrustant adapté aux surfaces poreuses, suivi d'un brossage mécanique. La haute pression est utilisée avec précaution pour ne pas déchausser les gravillons. Un traitement anti-mousse complète l'intervention sur ce type de support fréquent dans les pavillons d'Orly.</p>`,
        },
        {
          question: "Comment éliminez-vous mousse et lichen sur une terrasse exposée à l'humidité proche d'un parc ?",
          answer: `<p>L'humidité favorise une colonisation rapide par les végétaux. Nous appliquons un produit biocide qui détruit mousses et lichens en profondeur, puis procédons au brossage et rinçage. Un traitement préventif limite la réapparition, particulièrement utile pour les terrasses situées près du Parc Méliès ou du Parc de la Cloche.</p>`,
        },
        {
          question: "Faut-il privilégier haute pression ou nettoyage doux pour une terrasse bois composite à Orly ?",
        ...
        {
          question: "Faut-il déplacer mobilier et plantes avant intervention pour un démoussage de terrasse en pavillon ?",
          answer: `<p>Nous prenons en charge le déplacement ou le bâchage du mobilier et des jardinières. Les plantes sensibles sont protégées des projections de produit et d'eau. Cette préparation fait partie de l'intervention et permet de traiter l'intégralité de la surface sans zone oubliée ni dégât collatéral.</p>`,
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription: "Une remise en état complète de votre logement, adaptée aux fins de chantier, états des lieux ou grands ménages ponctuels, avec un rendu prêt à habiter.",
      whyUsBullets: [
      ...
      uniqueIntro: `<p>Comment rendre un appartement présentable en quelques jours quand les travaux viennent de s'achever ou qu'un locataire libère les lieux ? Autour de la <strong>Gare Les Saules</strong>, la rotation locative génère des demandes régulières : poussières de chantier sur les plinthes, traces de peinture au sol, résidus dans les placards. Les agences et bailleurs attendent un logement impeccable pour la remise des clés.</p>
...
<p class="mt-4">Le logement est aéré avant restitution pour éliminer les odeurs résiduelles de produits ou de chantier.</p>`,
      ...
      faqAdditions: [
        {
          question: "Quel est le délai d'intervention pour un nettoyage avant état des lieux près de la Gare Les Saules ?",
          answer: `<p>Les demandes urgentes autour de la Gare Les Saules sont fréquentes en raison de la forte rotation locative. Nous pouvons intervenir sous 48 à 72 heures selon la surface du logement et la disponibilité des accès. Un échange préalable permet de caler le créneau avec l'agence ou le propriétaire.</p>`,
        },
        {
          question: "Quel protocole appliquez-vous pour un nettoyage fin de chantier dans un appartement en rénovation à Orly ?",
          answer: `<p>Le protocole commence par l'évacuation des gravats légers et le dépoussiérage complet des surfaces hautes. Les traces de peinture, enduit ou colle sont traitées selon le revêtement. Sols, vitres intérieures et pièces d'eau sont ensuite nettoyés pour un rendu prêt à habiter.</p>`,
        },
        {
          question: "Quel niveau de propreté garantissez-vous pour une remise clé en main demandée par une agence d'Orly ?",
          answer: `<p>Le logement est restitué dans un état permettant une entrée immédiate : sols propres, sanitaires désinfectés, placards vidés et essuyés, vitres intérieures nettoyées. Un contrôle pièce par pièce est effectué avant départ pour éviter tout retour de l'agence.</p>`,
        },
        {
          question: "Comment coordonnez-vous l'intervention ménage avec les artisans lors d'une remise en état à Pierre-au-Prêtre ?",
          answer: `<p>Nous intervenons après la fin des travaux salissants, en accord avec le calendrier du chantier. Si des retouches sont encore prévues, nous adaptons notre passage pour éviter de repasser sur des zones recontaminées. Un contact direct avec le responsable de chantier facilite cette organisation.</p>`,
        },
      ],
      ctaOverride: "",
    },
