  ...
  services: [
    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Le séchage dépend de <strong>l'épaisseur des fibres</strong> et de la ventilation du local. En général, comptez entre 4 et 8 heures pour un passage léger, 12 à 24 heures pour une utilisation normale. Nous optimisons l'extraction pour réduire ce délai au maximum.</p>",
        },
        {
          question:
            "Comment protégez-vous plinthes et angles lors d'un décapage ou shampouinage sur les moquettes de halls rénovés ?",
          answer:
            "<p>Des <strong>protections plastifiées</strong> sont posées le long des plinthes et bas de murs avant toute injection. Les angles et jonctions avec d'autres revêtements sont isolés pour éviter les projections. Cette précaution préserve les finitions et évite les traces d'humidité sur les surfaces adjacentes.</p>",
        },
        {
          question:
...

    {
      ...
      specificChallenges: [
        ...
        "<strong>Rotation des véhicules</strong> à coordonner avec le syndic pour libérer les zones par secteur.",
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Nous définissons un <strong>zonage par secteur</strong> avec le syndic ou le gestionnaire. Les résidents sont informés en amont pour déplacer leur véhicule sur les emplacements libérés. Le balisage sécurisé délimite la zone en cours de traitement et permet de maintenir une circulation partielle pendant l'intervention.</p>",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "<p>Pour un parking à fort trafic, un <strong>décrassage complet</strong> tous les trois à six mois limite l'accumulation de salissures et préserve l'état du revêtement. Entre deux interventions, un balayage mécanique mensuel peut suffire à maintenir un niveau de propreté acceptable selon le flux constaté.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      uniqueDeepDive:
        "<h3>Préparation et protection</h3>\n<p>Nous déplaçons le mobilier et les plantes vers l'intérieur ou les bâchons sur place. Les menuiseries — fenêtres, portes-fenêtres, seuils — reçoivent une protection pour éviter les projections. Un <strong>dispositif anti-coulures</strong> est installé en périphérie du balcon afin de préserver le voisin du dessous.</p>\n\n<h3>Traitement du sol et des surfaces</h3>\n<p>Les gros dépôts (feuilles, terre, débris) sont retirés manuellement. Un produit adapté au support — carrelage, béton, dalles — est appliqué puis brossé. Le garde-corps, les vitrages et les murs mitoyens accessibles sont traités dans la foulée. Le rinçage s'effectue à <strong>pression contrôlée</strong>, douce sur les joints pour ne pas les dégrader.</p>\n\n<h3>Séchage et conseils</h3>\n<p>L'eau résiduelle est raclée vers l'évacuation. Nous vérifions l'absence de traces et laissons sécher naturellement. Avant de partir, nous vous indiquons la fréquence d'entretien recommandée selon l'exposition de votre balcon.</p>",
      specificChallenges: [
        "Poussières de chantier liées aux <strong>travaux du Grand Paris</strong> sur les balcons des Rives de l'Ourcq.",
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Nous évitons la <strong>haute pression directe</strong> sur les joints. Le carrelage est brossé avec un produit adapté, puis rincé à pression douce et contrôlée. Cette méthode préserve l'étanchéité tout en éliminant les salissures incrustées par les poussières de chantier fréquentes dans ce secteur.</p>",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "<p>Avant de commencer, nous installons des <strong>protections en périphérie</strong> du balcon pour canaliser l'eau vers l'évacuation. Le rinçage est effectué par zones, avec un raclage immédiat. Cette organisation évite les projections sur le linge étendu ou le mobilier du voisin situé en dessous.</p>",
        },
        {
          question:
...

    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>L'intervenant porte masque FFP2, combinaison, gants et lunettes. La zone est <strong>confinée par bâchage</strong>. Après collecte des dépôts, un désinfectant virucide homologué est appliqué avec respect du temps de contact avant rinçage final.</p>",
        },
        {
          question:
...

    {
      ...
      specificChallenges: [
        "Taches d'urine et <strong>odeurs animales</strong> fréquentes dans les foyers avec chiens ou chats.",
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Nous vérifions l'accessibilité avant le rendez-vous et adaptons le matériel transporté. Si l'ascenseur est indisponible, nous montons <strong>l'équipement par les escaliers</strong>. L'intervention se déroule sur place, sans déplacement du tapis, pour limiter les contraintes et respecter le délai convenu.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      specificChallenges: [
        ...
        "<strong>Accès par le jardin</strong> dans les pavillons du Mainguy ou des Merisiers, nécessitant une organisation adaptée.",
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Nos équipes s'en chargent au début de l'intervention. Tables, chaises et pots sont <strong>déplacés ou protégés</strong> par bâchage selon leur poids. Nous les repositionnons une fois le séchage suffisant, pour que vous retrouviez votre terrasse prête à l'usage sans manipulation de votre part.</p>",
        },
        {
          question:
