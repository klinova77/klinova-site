...
const city: City = {
  ...
  citySpecificChallenges: [
    ...
    "<strong>Dépôts verts et mousses sur les balcons</strong> des résidences pavillonnaires de Voisins et Souilly en raison de la proximité de la Beuvronne et du canal de l'Ourcq.",
  ...
  services: [
    ...
    // =========================
    {
      ...
      specificChallenges: [
        "Encrassement rapide des moquettes dans les halls proches de la zone commerciale et de la RN3, avec <strong>apports constants de boues</strong>, graviers et particules fines.",
    ...
    // =========================
    {
      ...
      specificChallenges: [
        "Accumulation rapide de <strong>taches d'hydrocarbures</strong> dans les parkings proches de la zone commerciale, liée au fort trafic quotidien et au stationnement prolongé.",
    ...
    // =========================
    {
      ...
      specificChallenges: [
        "<strong>Dépôts verts et mousses</strong> sur les balcons peu ensoleillés, notamment dans les immeubles du centre-ville et à proximité des zones végétalisées.",
    ...
    // =========================
    {
      ...
      specificChallenges: [
        "<strong>Contamination marquée</strong> sur les balcons du centre-ville, du quartier Victor Hugo et des résidences proches du canal de l'Ourcq, avec zones de nidification en corniches.",
...

    {
      ...
      specificChallenges: [
        "Dépôts liés aux axes routiers (N3, proximité A104) : <strong>finitions sur vitres, entrées</strong> et plinthes à soigner.",
        ...
        "Accès en résidences récentes (Mauperthuis) : <strong>digicodes/badges</strong> et stationnement parfois contraint en centre.",
      ],
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p><strong>En logement récent,</strong> on porte une attention particulière aux finitions (parquet stratifié, surfaces modernes, baies vitrées) et aux accès (badge/interphone). En pavillon, le volume et les vitrages (véranda, grandes ouvertures) comptent davantage : on structure le passage pièce par pièce pour garder un rendu homogène.</p>",
        },
        {
          question:
            "Comment évitez-vous les traces de calcaire dans la salle de bain après intervention ?",
          answer:
            "<p><strong>Nous utilisons un détartrage adapté aux matériaux</strong> (robinetterie, parois, joints) et nous rinçons correctement pour limiter les résidus. Nous pouvons aussi laisser des conseils simples d’aération et d’essuyage sur les zones qui marquent vite, surtout dans le 77.</p>",
        },
        {
          question:
            "Est-ce que vous proposez aussi un nettoyage des vitres et baies vitrées d’une maison ?",
          answer:
            "<p><strong>Oui, sur les vitrages accessibles.</strong> C’est fréquent à Claye-Souilly, notamment sur les pavillons avec véranda ou grandes baies. Nous intégrons cette partie au périmètre défini avant intervention pour garantir un rendu propre et cohérent.</p>",
        },
      ],
