...
const city: City = {
  ...
  customDescription:
    "Klinova intervient à Montrouge pour l'entretien des parties communes, parkings souterrains et espaces privatifs. Une organisation adaptée à la densité urbaine de la commune, avec des équipes réactives et un accès Vigik pour les résidences sécurisées.",
  ...
  faq: [
    {
      question:
        "Comment organisez-vous l'accès aux résidences sécurisées de Montrouge ?",
      answer:
        "<p>Nos équipes peuvent intervenir avec <strong>accès Vigik</strong> et coordonnent systématiquement avec le gardien ou le syndic avant le passage. Le créneau est validé en amont pour éviter l'attente sur place. En l'absence de gardien, nous utilisons les codes ou modalités transmis par le gestionnaire.</p>",
    },
    {
      question:
        "Pouvez-vous intervenir en dehors des heures de bureau pour limiter la gêne ?",
      answer:
        "<p>Oui, nous proposons des créneaux tôt le matin ou en fin de journée selon les besoins. Pour les parkings ou parties communes, un horaire décalé peut être envisagé après validation avec le syndic. Cette flexibilité permet de préserver le quotidien des résidents et l'activité des entreprises.</p>",
    },
    {
      question:
  ...
  services: [
    {
      ...
      heroDescription:
        "Extraction en profondeur des salissures incrustées dans vos moquettes, avec séchage maîtrisé pour une remise en service rapide adaptée aux contraintes de vos locaux.",
      whyUsBullets: [
      ...
      faqAdditions: [
        {
          question:
            "Comment organisez-vous l'accès aux bureaux sécurisés comme ceux du Campus Evergreen à Montrouge ?",
          answer:
            "<p>Nous coordonnons en amont avec votre PC sécurité ou facility manager. Badge temporaire, créneau validé, zones à traiter identifiées : l'intervention se déroule sans perturber l'activité des collaborateurs ni les protocoles d'accès en vigueur.</p>",
        },
        {
          question:
        ...
        {
          question:
            "Votre méthode convient-elle aux moquettes velours des résidences de standing près des Allées Jean Jaurès ?",
          answer:
            "<p>L'injection-extraction s'adapte aux fibres délicates du velours ras. La pression et le dosage sont ajustés pour préserver la densité du textile tout en éliminant les salissures. Le rendu retrouve souplesse et uniformité de teinte.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      serviceKey: "parkings",
      heroDescription:
        "Décrassage complet des parkings souterrains avec autolaveuse et traitement dégraissant, gestion stricte des eaux usées et coordination des accès pour limiter la gêne aux résidents.",
      whyUsBullets: [
      ...
      faqAdditions: [
        {
          question:
            "Comment gérez-vous les eaux de lavage dans les parkings souterrains des résidences de Montrouge ?",
          answer:
            "<p>Les eaux chargées sont dirigées vers les évacuations existantes après vérification de leur bon fonctionnement. Nous n'effectuons aucun rejet sauvage. Si les regards sont partiellement obstrués, un dégagement préalable est réalisé pour garantir l'écoulement correct pendant toute l'intervention.</p>",
        },
        {
          question:
        ...
        {
          question:
            "Quelle fréquence de décrassage recommandez-vous pour un parking à fort trafic comme ceux proches du stade Maurice Arnoux ?",
          answer:
            "<p>Un parking à usage intensif accumule rapidement huile et poussières. Nous conseillons généralement une intervention tous les quatre à six mois pour maintenir un niveau de propreté correct et prévenir l'incrustation des salissures dans le revêtement.</p>",
        },
        {
          question:
            "Adaptez-vous le traitement selon le type de revêtement présent dans les parkings montrougiens ?",
          answer:
            "<p>Oui, le protocole varie selon le support. Un béton brut supporte un dégraissant alcalin et une pression plus élevée. Une résine ou une peinture de sol nécessite des produits neutres et une action mécanique modérée pour éviter toute dégradation du film protecteur.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      serviceKey: "balcons",
      heroDescription:
        "Remise en état complète de votre balcon à Montrouge : traitement des dépôts, brossage adapté au support et gestion des eaux pour préserver le voisinage.",
      whyUsBullets: [
      ...
      faqAdditions: [
        ...
        {
          question:
            "Les dépôts verts sur mon balcon exposé nord, côté Allées Jean Jaurès, peuvent-ils être éliminés durablement ?",
          answer:
            "<p>Nous appliquons un traitement anti-mousse après le brossage. L'exposition ombragée favorise la repousse, mais ce traitement ralentit significativement le retour des dépôts. Un entretien annuel suffit généralement à maintenir la surface propre.</p>",
        },
        {
          question:
        ...
        {
          question:
            "À quelle fréquence recommandez-vous un nettoyage pour un balcon donnant sur l'avenue de la République ?",
          answer:
            "<p>L'exposition au trafic dense accélère l'encrassement. Nous conseillons une intervention tous les douze à dix-huit mois pour maintenir un aspect propre. Un rinçage léger entre deux passages peut prolonger le résultat.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription:
        "Assainissement complet de votre balcon souillé par les fientes, avec désinfection des supports et conseils de protection pour éviter le retour des pigeons.",
      whyUsBullets: [
      ...
      faqAdditions: [
        {
          question:
            "Les fientes de pigeons sur mon balcon près du Square Renaudel présentent-elles un risque sanitaire réel ?",
          answer:
            "<p>Les fientes sèches peuvent libérer des particules porteuses de bactéries ou de champignons. Le risque existe surtout lors du balayage à sec ou en cas d'accumulation prolongée. Une intervention avec humidification préalable et désinfection limite ces dangers pour vous et votre entourage.</p>",
        },
        {
          question:
            "Comment fonctionne la désinfection après le retrait des fientes dans un immeuble ancien de Montrouge ?",
          answer:
            "<p>Après le nettoyage des surfaces, un produit virucide et bactéricide homologué est appliqué sur le sol, le garde-corps et les vitrages. Le temps de contact est respecté avant rinçage. Cette étape élimine les agents pathogènes résiduels présents dans les micro-porosités du béton ou de la peinture.</p>",
        },
        {
          question:
            "Proposez-vous des solutions pour éviter le retour des pigeons sur un balcon proche de l'Église Saint-Jacques ?",
          answer:
            "<p>Selon la configuration de votre balcon, des dispositifs peuvent être installés après le nettoyage : pics anti-pigeons sur les rebords ou corniches, filets de protection pour les loggias, ou gel répulsif. Ces solutions sont proposées en fonction de l'exposition et du niveau d'infestation constaté.</p>",
        },
        {
          question:
            "Comment gérez-vous les nuisances pour les voisins pendant l'intervention dans un immeuble dense de Montrouge ?",
          answer:
            "<p>La zone est confinée par bâchage pour éviter les projections vers les balcons inférieurs. L'humidification des fientes limite les poussières et les odeurs. Si nécessaire, nous pouvons prévenir les occupants concernés avant l'intervention pour limiter toute gêne.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription:
        "Détachage et rafraîchissement de vos canapés, tapis et matelas à Montrouge, avec extraction des salissures en profondeur et séchage maîtrisé pour retrouver un textile propre et sain.",
      whyUsBullets: [
      ...
      faqAdditions: [
        {
          question:
            "Comment traitez-vous les odeurs d'urine animale sur un canapé dans un appartement du quartier Ferry-Buffalo ?",
          answer:
            "<p>Les odeurs d'urine nécessitent un traitement enzymatique qui décompose les molécules responsables, pas seulement un masquage. Le produit agit en profondeur dans les fibres avant l'extraction. Selon l'ancienneté de la tache, un second passage peut être nécessaire pour une neutralisation complète.</p>",
        },
        {
          question:
            "Combien de temps avant de pouvoir réutiliser mon canapé après l'intervention à Montrouge ?",
          answer:
            "<p>Le séchage prend généralement 4 à 8 heures pour un canapé standard. Dans les appartements bien ventilés proches des Allées Jean Jaurès, ce délai peut être réduit. Nous conseillons d'ouvrir les fenêtres et d'éviter de s'asseoir tant que le tissu reste humide au toucher.</p>",
        },
        {
          question:
        ...
        {
          question:
            "À quelle fréquence faire nettoyer un canapé utilisé quotidiennement par une famille avec enfants ?",
          answer:
            "<p>Un entretien annuel convient pour un usage familial classique. Avec des enfants en bas âge ou des animaux, un passage tous les 6 à 8 mois limite l'accumulation de taches et d'allergènes. Entre deux interventions, aspirer régulièrement les coussins prolonge la propreté obtenue.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription:
        "Une remise en état complète de votre appartement après travaux, avant état des lieux ou lors d'un déménagement, avec un nettoyage minutieux de chaque pièce et surface.",
      whyUsBullets: [
      ...
      faqAdditions: [
        ...
        {
          question:
            "Comment se coordonner avec mon agence immobilière pour un nettoyage à Montrouge ?",
          answer:
            "<p>Nous travaillons régulièrement avec les agences locales. La coordination peut inclure la récupération des clés, un créneau calé sur le planning de l'agent, et un compte-rendu après intervention. Nous nous adaptons aux procédures de chaque agence pour fluidifier la remise du logement.</p>",
        },
        {
          question:
            "Quel niveau de propreté attendre pour récupérer mon dépôt de garantie ?",
          answer:
            "<p>L'objectif est un logement rendu dans un état comparable à l'entrée : sols propres, sanitaires détartrés, vitres nettoyées, placards vidés et essuyés. Si des points restent insatisfaisants après notre passage, nous revenons corriger sans frais supplémentaires.</p>",
        },
        {
          question:
            "Comment traitez-vous les parquets anciens dans les immeubles du quartier Ferry-Buffalo ?",
          answer:
            "<p>Les parquets massifs ou vitrifiés sont aspirés puis nettoyés avec un produit adapté au bois, sans excès d'eau. Nous évitons les détergents agressifs qui ternissent le vernis. Pour les parquets huilés, nous utilisons un savon spécifique qui nourrit le bois tout en éliminant les salissures.</p>",
        },
      ],
      ctaOverride: "",
    },
