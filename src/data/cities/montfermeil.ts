...
<p>Évaluation sur place : type de moquette (bouclé, velours, aiguilleté), zones de fort trafic (devant ascenseurs, boîtes aux lettres, entrées), nature des taches et contraintes d'accès (cages étroites, paliers, angles). <strong>Protection des bas de murs et des points sensibles,</strong> puis organisation du chantier par tronçons pour garder des circulations praticables pendant l'intervention.</p>
