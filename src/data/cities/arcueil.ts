...
const city: City = {
  ...
  hubIntro:
    "<p>Au pied des Aqueducs et du centre commercial de la Vache Noire, Arcueil concentre bureaux tertiaires, grands ensembles et quartiers pavillonnaires. Klinova s'y positionne comme partenaire de proximité pour syndics, gestionnaires et entreprises locales.</p>\n\n<p class=\"mt-4\">Notre organisation couvre <strong>la propreté des communs</strong>, l'entretien des sols techniques et la remise en état des espaces extérieurs. Chaque prestation fait l'objet d'un suivi terrain, avec reporting disponible sur demande pour les donneurs d'ordre professionnels.</p>\n\n<ul>\n  <li><strong>Coordination locale :</strong> Nos équipes connaissent les contraintes de stationnement en zone verte et les accès par digicode ou badge Vigik fréquents dans les résidences récentes.</li>\n  <li><strong>Interventions adaptées :</strong> Horaires décalés possibles pour limiter la gêne dans les immeubles à forte densité ou les locaux tertiaires du secteur Joliot-Curie.</li>\n  <li><strong>Suivi structuré :</strong> Un interlocuteur dédié centralise les demandes et transmet les comptes-rendus d'intervention aux syndics et gestionnaires.</li>\n</ul>",
  ...
  citySpecificChallenges: [
    ...
    "<strong>Stationnement contraint en zone verte</strong>, saturation aux heures de pointe RER.",
  ],
  ...
  faq: [
    ...
    {
      question:
        "Comment se passe la coordination avec le gardien ou le conseil syndical ?",
      answer:
        "<p>Nous prenons contact avant chaque intervention pour confirmer les accès, les horaires et les éventuelles contraintes (travaux en cours, zones sensibles). Un <strong>compte-rendu</strong> peut être transmis après passage si demandé.</p>",
    },
    {
      question: "Proposez-vous un devis avant intervention à Arcueil ?",
      answer:
        "<p>Chaque demande fait l'objet d'un échange préalable pour évaluer la surface, l'état des lieux et les contraintes d'accès. Le devis détaille le périmètre et la méthode, avec une <strong>estimation claire</strong> avant validation.</p>",
    },
  ],
  ...
  services: [
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Nous utilisons du <strong>matériel compact</strong> transportable à la main. L'équipe fractionne l'intervention par palier pour éviter d'encombrer les passages. Les protections sont posées au fur et à mesure de la progression, et le temps de séchage est anticipé pour libérer rapidement la circulation.</p>",
        },
        {
          question:
          ...
          answer:
            "<p>Un pré-détachage localisé précède l'injection-extraction. Les résidus de café ou de tanin nécessitent parfois plusieurs passes avec un produit adapté au type de fibre. Le résultat dépend de l'ancienneté de la tache, mais l'aspect général est nettement amélioré.</p>",
        },
        {
          question:
            "Sur un open-space tertiaire proche de la Vache Noire, préférez-vous le shampouinage ou l'injection-extraction ?",
          answer:
            "<p>L'injection-extraction reste la méthode privilégiée : elle extrait davantage de salissures et <strong>réduit le temps de séchage</strong>. Le shampouinage peut convenir pour un entretien léger, mais laisse plus d'humidité résiduelle, ce qui retarde la reprise d'activité dans des locaux à fort passage.</p>",
        },
        {
          question:
            "Quel délai de séchage prévoir après un nettoyage de moquette en copropriété sur l'avenue Laplace ?",
          answer:
            "<p>Selon l'épaisseur du textile et la ventilation du couloir, comptez entre 4 et 8 heures avant de pouvoir circuler normalement. Nous conseillons d'intervenir en fin de journée ou le week-end pour que le séchage s'effectue hors des heures de passage principal.</p>",
        },
      ],
      ctaOverride: "",
    },
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Les dépôts d'hydrocarbures incrustés sont traités avec un dégraissant professionnel appliqué avant le passage de l'autolaveuse. Plusieurs passes peuvent être nécessaires sur les zones les plus marquées. Le résultat dépend de l'ancienneté des taches et de la porosité du béton.</p>",
        },
        {
          question:
            "Quelle gestion des eaux de lavage appliquez-vous pour un sous-sol du centre commercial Vache Noire ?",
          answer:
            "<p>Les eaux chargées sont aspirées par l'autolaveuse et <strong>dirigées vers les évacuations</strong> prévues à cet effet. Nous vérifions au préalable l'état des regards et rigoles. Aucun rejet n'est effectué en dehors des circuits conformes, conformément aux exigences des gestionnaires de site.</p>",
        },
        {
          question:
            "Pour intervenir dans le parking Vache Noire, proposez-vous une fermeture partielle hors heures d'affluence ?",
          answer:
            "<p>Oui, nous planifions l'intervention en coordination avec le gestionnaire pour limiter la gêne. <strong>Un zonage par niveaux</strong> ou par travées permet de maintenir l'accès aux usagers. Les horaires décalés — tôt le matin ou en soirée — réduisent l'impact sur le flux de véhicules.</p>",
        },
        {
          question:
            "Quelle différence de technique entre un parking souterrain et un parking aérien à Arcueil ?",
          answer:
            "<p>En souterrain, la ventilation réduite impose un séchage plus long et une attention particulière aux évacuations. En extérieur, les mousses et dépôts végétaux s'ajoutent aux salissures classiques. Nous adaptons le matériel et les produits selon la configuration et l'exposition du site.</p>",
        },
      ],
      ctaOverride: "",
    },
    ...
    // 3) balcons
    {
      ...
      uniqueIntro:
        "<p>Dans le secteur des balcons donnant sur les Aqueducs d'Arcueil, on constate une accumulation rapide de <strong>dépôts noirs</strong> et de traces grasses. L'exposition aux flux de circulation depuis la D920 et l'A6 laisse un film sombre sur les sols et garde-corps. Les corniches attirent également les pigeons, dont les fientes s'incrustent dans les joints. Résultat : un espace extérieur qu'on hésite à utiliser, même aux beaux jours.</p>\n\n<p class=\"mt-4\">Retrouver un balcon propre change le quotidien. Sur les balcons filants en béton des immeubles années 60-70 comme sur les loggias récentes avec dalles sur plots, le confort visuel revient dès que les surfaces sont débarrassées de leur couche grisâtre. Les plantes reprennent leur place, le mobilier peut ressortir. L'impression de vivre dans un logement soigné se ressent immédiatement.</p>\n\n<p class=\"mt-4\">Une intervention structurée permet d'obtenir ce résultat sans risque pour les supports ni gêne pour les voisins du dessous. Diagnostic préalable, protection des menuiseries, traitement adapté au revêtement et contrôle de l'évacuation des eaux : chaque étape est pensée pour votre configuration.</p>",
      uniqueDeepDive:
        "<h3>Un sol débarrassé de ses dépôts incrustés</h3>\n<p>Le résultat visé : des dalles ou un béton retrouvant leur teinte d'origine, sans traces noires ni résidus verts. Pour y parvenir, les gros débris sont d'abord retirés manuellement. Un produit adapté au support est ensuite appliqué, suivi d'un <strong>brossage ciblé</strong> sur les zones encrassées.</p>\n\n<h3>Garde-corps et vitrages sans coulures</h3>\n<p>L'objectif est un ensemble homogène, sans démarcation entre sol propre et éléments périphériques ternes. Les barreaux métalliques ou les parois vitrées sont traités avec des solutions non agressives. Le <strong>rinçage est contrôlé</strong> pour éviter les projections vers les étages inférieurs.</p>\n\n<h3>Un espace prêt à être réutilisé</h3>\n<p>Le balcon doit pouvoir accueillir à nouveau mobilier et plantes rapidement. Le séchage est accéléré si nécessaire. Avant de partir, des <strong>conseils d'entretien</strong> sont transmis pour espacer les prochaines interventions selon l'exposition de votre balcon à la pollution ou aux feuillages environnants.</p>",
      specificChallenges: [
        "<strong>Pollution noire</strong> depuis la D920 et l'A6 formant un voile gras sur les garde-corps.",
        "<strong>Dépôts verts et mousses</strong> sur les balcons exposés nord dans le Bas d'Arcueil.",
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Sur ces supports poreux, nous évitons la haute pression agressive. <strong>Un brossage mécanique doux</strong> combiné à un produit désincrustant permet de retirer les dépôts sans fragiliser les joints ni créer de micro-fissures. Le rinçage reste modéré pour préserver l'étanchéité d'origine.</p>",
        },
        {
          question:
            "Sur un balcon donnant sur les Aqueducs, comment gérez-vous l'évacuation des eaux ?",
          answer:
            "<p>Nous installons des <strong>bâches de protection</strong> en périphérie et contrôlons le débit lors du rinçage. L'eau est dirigée vers les évacuations existantes. Si le balcon n'en dispose pas, nous utilisons un aspirateur à eau pour limiter tout écoulement vers les étages inférieurs.</p>",
        },
        {
          question:
            "Comment éliminer les mousses et dépôts verts sur les balcons exposés nord dans le Bas d'Arcueil ?",
          answer:
            "<p>Ces zones ombragées favorisent la prolifération végétale. Nous appliquons un traitement anti-mousse avant brossage, puis rinçons à pression contrôlée. Un produit préventif peut être proposé pour ralentir la réapparition, selon l'humidité ambiante de votre exposition.</p>",
        },
        {
          question:
            "Quelles solutions proposez-vous pour les balcons proches de la D920 sans recourir à la haute pression ?",
          answer:
            "<p>La pollution grasse de cet axe nécessite un dégraissant adapté plutôt qu'une pression élevée. Nous travaillons au brossage manuel ou mécanique doux après application du produit. Cette méthode préserve les joints fragiles tout en éliminant efficacement le film noir accumulé.</p>",
        },
      ],
      ctaOverride: "",
    },
    ...
    // 4) balcons-fientes
    {
      ...
      specificChallenges: [
        "<strong>Secteurs arborés</strong> proches du Parc du Coteau : nidification fréquente sur balcons exposés.",
        "<strong>Corniches et garde-corps</strong> des immeubles anciens attaqués par l'acidité des fientes.",
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>L'intervenant porte <strong>masque FFP2</strong>, combinaison jetable, lunettes et gants. Les fientes sont humidifiées avant manipulation pour éviter l'envol de particules. Le désinfectant utilisé est un produit virucide et bactéricide homologué, appliqué avec un temps de contact respecté avant rinçage.</p>",
        },
        {
          question:
            "Après le nettoyage de fientes dans un immeuble du Chaperon Vert, comment évacuez-vous les déchets ?",
          answer:
            "<p>Les déjections et résidus sont conditionnés dans des <strong>sacs étanches</strong> fermés sur place. L'évacuation se fait sans transit par les parties communes ouvertes. En grand ensemble, nous coordonnons l'intervention pour limiter les nuisances olfactives vis-à-vis du voisinage direct.</p>",
        },
        {
          question:
            "Les fientes ont attaqué la corniche d'un immeuble ancien à Jules Ferry : peut-on restaurer sans décapage lourd ?",
          answer:
            "<p>Si la dégradation reste superficielle, un nettoyage adapté au support suivi d'une désinfection permet de stopper la détérioration. En cas d'écaillage avancé ou de corrosion profonde, nous signalons les zones nécessitant une reprise par un professionnel du bâtiment.</p>",
        },
      ],
      ctaOverride: "",
    },
    ...
    // 5) canapes-tapis
    {
      ...
      specificChallenges: [
        ...
        "<strong>Matelas à assainir</strong> entre deux locataires avec délai court avant nouvel état des lieux.",
      ],
      faqAdditions: [
        {
          question:
          ...
          answer:
            "<p>Nous procédons par injection-extraction directement sur le tissu en place. Un pré-traitement cible les taches visibles, puis la machine injecte une solution nettoyante et aspire immédiatement les résidus. Cette technique convient aux canapés fixes des petits logements sans nécessiter de démontage.</p>",
        },
        {
          question:
            "Pour réduire les acariens sur un canapé chez une famille du quartier Kergomard, quel résultat puis-je attendre ?",
          answer:
            "<p>L'extraction en profondeur déloge une grande partie des allergènes logés dans les fibres. Le textile ressort assaini, avec une charge en acariens nettement diminuée. Pour les foyers sensibles, nous recommandons un entretien régulier afin de maintenir ce niveau d'hygiène dans la durée.</p>",
        },
        {
          question:
            "Dans un appartement sans ascenseur du centre-ville, quel temps de séchage pour un détachage canapé ?",
          answer:
            "<p>Comptez généralement trois à six heures selon l'épaisseur du tissu et la ventilation du logement. <strong>Notre extraction poussée</strong> limite l'humidité résiduelle. En été ou avec fenêtres ouvertes, le séchage s'accélère. Nous vous indiquons le délai estimé avant de quitter les lieux.</p>",
        },
        {
          question:
            "Comment dois-je préparer l'appartement et le stationnement pour une intervention près de Laplace ?",
          answer:
            "<p>Dégagez l'accès au mobilier concerné et prévoyez si possible un emplacement de stationnement à proximité, la zone étant souvent saturée. Nous pouvons convenir d'un créneau horaire où le stationnement est plus accessible. Aucune autre préparation particulière n'est nécessaire de votre côté.</p>",
        },
      ],
      ctaOverride: "",
    },
    ...
    // 6) terrasses
    {
      ...
      uniqueIntro:
        "<p>Les traces vertes et le noircissement progressif sont visibles sur de nombreuses terrasses du <strong>quartier Jules Ferry</strong> et du secteur Kergomard. Les dalles perdent leur teinte d'origine, les joints se couvrent de mousse, et certaines zones deviennent glissantes après la pluie. Ces dégradations s'installent saison après saison, rendant l'espace moins accueillant et parfois risqué.</p>\n\n<p class=\"mt-4\">Sur les carrelages des pavillons comme sur les <strong>dalles sur plots ou bois composite des attiques récents</strong>, le résultat d'un entretien adapté change l'usage quotidien. Une terrasse propre redevient un prolongement naturel du logement, utilisable sans hésitation pour les repas ou la détente. Les taches grasses de barbecue, les dépôts de feuilles et les lichens incrustés disparaissent.</p>\n\n<p class=\"mt-4\">L'intervention prend en compte le noircissement lié à la pollution atmosphérique et les mousses sur zones ombragées. Lorsque l'accès matériel passe par l'intérieur du logement, nous organisons le cheminement pour protéger vos sols et limiter toute gêne.</p>",
      uniqueDeepDive:
        "<h3>Dépôts et mousses accumulés</h3>\n<p>Les feuilles mortes, la terre et les débris sont retirés manuellement. Le <strong>balayage préalable</strong> dégage la surface pour évaluer l'état réel du support et repérer les zones où la mousse s'est enracinée dans les joints.</p>\n\n<h3>Encrassement et taches tenaces</h3>\n<p>Un <strong>produit adapté au matériau</strong> est appliqué : formulation spécifique pour pierre, bois ou composite. Le brossage mécanique ou manuel déloge les salissures incrustées. La haute pression contrôlée intervient sur les supports qui la tolèrent, en évitant les joints fragiles et les matériaux poreux.</p>\n\n<h3>Retour de la mousse et prévention</h3>\n<p>Un <strong>traitement anti-mousse</strong> est appliqué sur les zones exposées à l'humidité et à l'ombre. Les eaux de rinçage sont dirigées vers les points d'écoulement existants. Le mobilier et les plantes, déplacés ou bâchés en début d'intervention, retrouvent leur place une fois le séchage suffisant.</p>",
      specificChallenges: [
        "Mousses tenaces sur dalles ombragées des pavillons du quartier Kergomard.",
        "<strong>Noircissement accéléré</strong> par la pollution de l'axe D920 sur les terrasses exposées.",
        "<strong>Bois composite</strong> des attiques récents nécessitant une pression contrôlée pour éviter les marques.",
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Le bois composite ne supporte pas les pressions élevées qui marquent la surface. Nous utilisons une buse à jet large et une pression réduite, combinées à un produit nettoyant sans chlore. Le brossage manuel complète le travail sur les zones encrassées sans altérer les lames.</p>",
        },
        {
          question:
            "Comment éliminer les mousses et lichens sur les dalles de terrasse d'un pavillon dans le Bas d'Arcueil ?",
          answer:
            "<p>Le brossage mécanique décolle les mousses superficielles. Pour les lichens incrustés dans les joints, un produit biocide agit en profondeur avant rinçage. Un traitement préventif est ensuite appliqué pour ralentir la repousse, particulièrement efficace sur les zones ombragées par la végétation.</p>",
        },
        {
          question:
            "Pour une terrasse en pierre ancienne dans le quartier Jules Ferry, dois-je privilégier haute pression ou nettoyage doux ?",
          answer:
            "<p>La pierre ancienne, souvent poreuse, risque de s'effriter sous une pression trop forte. Nous privilégions un nettoyage doux avec brossage et produit adapté. La haute pression n'intervient qu'à faible intensité sur les zones les plus résistantes, après test sur une partie discrète.</p>",
        },
        {
          question:
            "Quelle est la meilleure période à Arcueil pour appliquer un traitement anti-mousse sur ma terrasse ?",
          answer:
            "<p>L'application idéale se situe en fin d'été ou début d'automne, avant les pluies prolongées. Le produit a le temps de pénétrer et d'agir avant la saison humide. Une seconde application au printemps prolonge la protection sur les terrasses particulièrement exposées à l'ombre.</p>",
        },
      ],
      ctaOverride: "",
    },
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>L'intervention couvre le <strong>dépoussiérage complet</strong>, le lavage des sols adaptés au revêtement, le nettoyage approfondi des sanitaires et de la cuisine, le traitement des vitres intérieures et des placards. Les traces sur les murs et les interrupteurs sont également traitées pour un rendu conforme aux attentes d'un état des lieux.</p>",
        },
        {
          question:
            "Comment coordonnez-vous le nettoyage avant état des lieux avec les agences avenue Laplace ?",
          answer:
            "<p>Nous échangeons directement avec l'agence pour caler le créneau d'intervention selon la date de l'état des lieux. <strong>Les accès sont transmis en amont</strong>. Un compte-rendu peut être fourni si demandé. Cette organisation évite les allers-retours et garantit que le logement soit prêt au moment convenu.</p>",
        },
        {
          question:
            "Quel niveau de propreté garantissez-vous pour un nettoyage complet avant remise des clés à Arcueil ?",
          answer:
            "<p>L'objectif est un logement visuellement propre et fonctionnel : sols sans traces, sanitaires détartrés, cuisine dégraissée, vitres nettes. Si un point ne convient pas lors du contrôle, nous intervenons à nouveau sur la zone concernée sans frais supplémentaires dans un délai raisonnable.</p>",
        },
        {
          question:
          ...
          answer:
            "<p>Nous avons besoin du code d'accès, des éventuels badges ou clés, et des coordonnées du gardien si une remise de clés est prévue. Ces éléments sont confirmés la veille de l'intervention. En cas de difficulté d'accès, nous vous contactons immédiatement pour éviter tout retard.</p>",
        },
      ],
      ctaOverride: "",
    },
