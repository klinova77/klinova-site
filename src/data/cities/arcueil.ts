      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Nous utilisons du matériel compact transportable à la main. L'équipe fractionne l'intervention par palier pour éviter d'encombrer les passages. Les protections sont posées au fur et à mesure de la progression, et le temps de séchage est anticipé pour libérer rapidement la circulation.</p>",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "<p>L'injection-extraction reste la méthode privilégiée : elle extrait davantage de salissures et réduit le temps de séchage. Le shampouinage peut convenir pour un entretien léger, mais laisse plus d'humidité résiduelle, ce qui retarde la reprise d'activité dans des locaux à fort passage.</p>",
        },
        {
          question:
    ...
    // 2) parkings
    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Les eaux chargées sont aspirées par l'autolaveuse et dirigées vers les évacuations prévues à cet effet. Nous vérifions au préalable l'état des regards et rigoles. Aucun rejet n'est effectué en dehors des circuits conformes, conformément aux exigences des gestionnaires de site.</p>",
        },
        {
          question:
            "Pour intervenir dans le parking Vache Noire, proposez-vous une fermeture partielle hors heures d'affluence ?",
          answer:
            "<p>Oui, nous planifions l'intervention en coordination avec le gestionnaire pour limiter la gêne. Un zonage par niveaux ou par travées permet de maintenir l'accès aux usagers. Les horaires décalés — tôt le matin ou en soirée — réduisent l'impact sur le flux de véhicules.</p>",
        },
        {
          question:
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Sur ces supports poreux, nous évitons la haute pression agressive. Un brossage mécanique doux combiné à un produit désincrustant permet de retirer les dépôts sans fragiliser les joints ni créer de micro-fissures. Le rinçage reste modéré pour préserver l'étanchéité d'origine.</p>",
        },
        {
          question:
            "Sur un balcon donnant sur les Aqueducs, comment gérez-vous l'évacuation des eaux ?",
          answer:
            "<p>Nous installons des bâches de protection en périphérie et contrôlons le débit lors du rinçage. L'eau est dirigée vers les évacuations existantes. Si le balcon n'en dispose pas, nous utilisons un aspirateur à eau pour limiter tout écoulement vers les étages inférieurs.</p>",
        },
        {
          question:
    ...
    // 4) balcons-fientes
    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>L'intervenant porte masque FFP2, combinaison jetable, lunettes et gants. Les fientes sont humidifiées avant manipulation pour éviter l'envol de particules. Le désinfectant utilisé est un produit virucide et bactéricide homologué, appliqué avec un temps de contact respecté avant rinçage.</p>",
        },
        {
          question:
            "Après le nettoyage de fientes dans un immeuble du Chaperon Vert, comment évacuez-vous les déchets ?",
          answer:
            "<p>Les déjections et résidus sont conditionnés dans des sacs étanches fermés sur place. L'évacuation se fait sans transit par les parties communes ouvertes. En grand ensemble, nous coordonnons l'intervention pour limiter les nuisances olfactives vis-à-vis du voisinage direct.</p>",
        },
        {
          question:
    ...
    // 5) canapes-tapis
    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Comptez généralement trois à six heures selon l'épaisseur du tissu et la ventilation du logement. Notre extraction poussée limite l'humidité résiduelle. En été ou avec fenêtres ouvertes, le séchage s'accélère. Nous vous indiquons le délai estimé avant de quitter les lieux.</p>",
        },
        {
          question:
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>L'intervention couvre le dépoussiérage complet, le lavage des sols adaptés au revêtement, le nettoyage approfondi des sanitaires et de la cuisine, le traitement des vitres intérieures et des placards. Les traces sur les murs et les interrupteurs sont également traitées pour un rendu conforme aux attentes d'un état des lieux.</p>",
        },
        {
          question:
            "Comment coordonnez-vous le nettoyage avant état des lieux avec les agences avenue Laplace ?",
          answer:
            "<p>Nous échangeons directement avec l'agence pour caler le créneau d'intervention selon la date de l'état des lieux. Les accès sont transmis en amont. Un compte-rendu peut être fourni si demandé. Cette organisation évite les allers-retours et garantit que le logement soit prêt au moment convenu.</p>",
        },
        {
          question:
