  ...
  faq: [
    {
      ...
      answer:
        "<p>Nous repérons les <strong>créneaux de stationnement autorisé</strong> et privilégions les <strong>horaires creux</strong>. Pour les secteurs proches du marché, nous évitons les <strong>jours de forte affluence</strong>. Le matériel est adapté pour limiter les allers-retours depuis le véhicule.</p>",
    },
    {
      question:
    ...
    },
    {
      ...
      answer:
        "<p>Nous prenons contact <strong>en amont</strong> pour récupérer <strong>badges</strong> et consignes spécifiques. Le gardien est informé du <strong>planning</strong> prévu. En cas d'imprévu (panne ascenseur, travaux), il nous alerte pour <strong>adapter l'intervention</strong> sans gêner les résidents.</p>",
    },
    {
      question: "Proposez-vous un devis avant intervention à Alfortville ?",
      answer:
        "<p>Oui, chaque demande fait l'objet d'un <strong>devis</strong> après échange sur les surfaces, la fréquence souhaitée et les contraintes d'accès. Le devis est transmis sous <strong>48 heures</strong>, sans engagement. Un <strong>passage sur site</strong> peut être organisé si nécessaire.</p>",
    },
  ],
  ...
  services: [
    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>L'injection-extraction convient mieux aux dalles textiles des espaces tertiaires. Cette méthode extrait les résidus en profondeur sans laisser d'excès d'humidité. Le séchage est plus rapide qu'avec un shampooing classique, ce qui facilite la reprise d'activité.</p>",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "<p>Le séchage varie de trois à six heures selon l'épaisseur du revêtement et la ventilation du local. L'extraction maximale de l'humidité en fin d'intervention réduit ce délai. Une consigne de non-piétinement est donnée pour les premières heures.</p>",
        },
      ],
      ctaOverride: "",
    },
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Les eaux chargées en huile et dégraissant sont dirigées vers les regards et rigoles existants. Nous vérifions leur bon écoulement avant intervention pour éviter toute stagnation. Aucun rejet sauvage n'est effectué, conformément aux règles en vigueur pour les copropriétés du Val-de-Marne.</p>",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "<p>Les jours de marché, l'accès aux parkings proches est compliqué par la circulation et le stationnement. Nous privilégions les interventions en début de semaine ou en soirée pour éviter les créneaux de forte affluence et faciliter le balisage des zones traitées.</p>",
        },
      ],
      ctaOverride: "",
    },
...

    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Le printemps et le début d'automne sont les périodes les plus adaptées. Après l'hiver, les dépôts accumulés sont visibles et le traitement anti-mousse appliqué protège la surface pour la belle saison. À l'automne, l'intervention prépare la terrasse avant les mois humides.</p>",
        },
      ],
      ctaOverride: "",
    },
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Nous intervenons sous 24 à 48 heures selon la surface et la disponibilité. Pour les logements proches de la gare, nous organisons la récupération des clés en amont avec l'agence ou le propriétaire afin de respecter le créneau imposé par l'état des lieux.</p>",
        },
        {
          question:
            "Quelle différence entre un nettoyage standard et une intervention fin de chantier dans le quartier Chantereine ?",
          answer:
            "<p>Un ménage fin de chantier inclut l'évacuation des résidus, le dépoussiérage complet des surfaces verticales et le retrait des traces de peinture ou d'enduit. Le protocole standard se concentre sur les sols, sanitaires et vitres sans cette phase préparatoire liée aux travaux.</p>",
        },
        {
          question:
