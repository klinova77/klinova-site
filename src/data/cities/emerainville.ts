...

    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Les eaux sont dirigées vers les rigoles existantes et évacuations officielles, jamais rejet direct au sol. Nous vérifions avant intervention la conformité des évacuations. Filtre temporaire possible si zone sensible. Respect strict des normes locales de gestion des eaux usées. Rapport d'intervention fourni au syndic ou gestionnaire.</p>",
        },
        {
          question:
            "À quelle fréquence faut-il nettoyer un parking très utilisé par les usagers RER ?",
          answer:
            "<p>Parking très fréquenté (>200 véhicules/jour) : entretien mensuel recommandé pour maintenir l'aspect et prévenir accumulation d'huile. Zones modérées (50-150 véhicules/jour) : nettoyage trimestriel suffisant. Parkings aériens commerces : fréquence ajustée selon météo (pluies, poussière saisonnière). Nous proposons un plan d'entretien adapté après diagnostic initial.</p>",
        },
      ],
      ctaOverride: "",
    },
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Oui. Le protocole vise à décrocher ce qui s’accumule dans les fibres (poils, poussières, odeurs) et à extraire en profondeur sans abîmer le tissu. Dans les pavillons avec jardin, c’est souvent la meilleure solution pour retrouver un rendu net et une vraie hygiène sur les assises très sollicitées.</p>",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "<p>Le séchage complet est généralement de 6 à 10 heures selon la ventilation et la température. Une utilisation légère est possible plus tôt, mais il est préférable d’attendre le séchage total pour préserver les fibres et le confort. Aérer la pièce accélère nettement le séchage.</p>",
        },
        {
          question:
            "Intervenez-vous facilement dans le secteur Emery malgré le stationnement autour du RER E ?",
          answer:
            "<p>Oui. Le matériel est prévu pour une intervention à domicile, et l’organisation tient compte du secteur gare (stationnement plus tendu). Dans les résidences avec digicode/badge, l’accès est géré en amont pour que l’intervention se déroule sans perte de temps et avec une gêne minimale.</p>",
        },
      ],
...

    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Nous nous adaptons à votre calendrier : horaires décalés si artisans encore présents, respect des accès (digicode, clés, gardien). Communication directe avec agence ou propriétaire avant/après intervention. Reporting photo disponible si demandé. Pas de gêne pour voisins ou autres intervenants.</p>",
        },
      ],
      ctaOverride: "",
    },
