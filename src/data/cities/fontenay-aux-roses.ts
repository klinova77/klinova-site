...
const city: City = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: "<p>Après réception de votre demande, nous revenons vers vous rapidement avec une <strong>proposition détaillée</strong>. Si une visite technique s'avère nécessaire — parking souterrain, surface importante — nous la programmons sans tarder pour affiner le chiffrage avant validation.</p>",
    },
    {
      question: "Intervenez-vous en urgence pour des situations imprévues ?",
      answer: "<p>Oui, nous traitons les demandes urgentes selon disponibilité. <strong>Dégât des eaux</strong>, souillure accidentelle dans un hall ou besoin de remise en état rapide : contactez-nous pour évaluer la faisabilité d'une intervention selon le type de prestation.</p>",
    },
    {
...
<p>Les marches moquettées concentrent usure et taches anciennes. Chaque marche est traitée individuellement avec <strong>extraction renforcée</strong> sur les nez de marche. Le temps de séchage varie selon la ventilation du lieu : nous indiquons une estimation réaliste et conseillons un balisage temporaire pour éviter le piétinement prématuré.</p>",
    ...
    // 5) canapes-tapis
    {
      ...
      whyUsBullets: [
        ...
        "Organisation souple avec gestion du stationnement et intervention rapide pour limiter l'indisponibilité du mobilier.",
      ],
