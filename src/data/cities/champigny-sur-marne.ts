...
const city: City = {
  ...
  customDescription:
    "Klinova intervient à Champigny-sur-Marne pour l'entretien des parties communes, parkings souterrains et espaces extérieurs. Une organisation adaptée aux contraintes du Plateau comme aux résidences des bords de Marne.",
  ...
  services: [
    {
      ...
      heroDescription:
        "Extraction des salissures incrustées dans vos moquettes par injection-extraction, avec séchage maîtrisé pour une remise en usage rapide de vos espaces.",
      whyUsBullets: [
      ...
      faqAdditions: [
        ...
        {
          question:
            "Combien de temps faut-il attendre avant de remarcher sur la moquette après votre passage ?",
          answer:
            "<p>Le séchage prend généralement entre trois et six heures selon l'épaisseur du revêtement et l'aération du local. Nous conseillons d'éviter le piétinement pendant ce délai pour ne pas marquer les fibres encore humides et préserver la propreté obtenue.</p>",
        },
        {
          question:
            "Votre méthode convient-elle aux dalles textiles des bureaux sur le Plateau ?",
          answer:
            "<p>L'injection-extraction s'adapte parfaitement aux dalles textiles courantes dans les locaux professionnels. La technique permet de traiter les zones de circulation intense sans détremper le support, avec un séchage rapide compatible avec la reprise d'activité.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      serviceKey: "parkings",
      heroDescription:
        "Décrassage complet des parkings souterrains et aériens, avec autolaveuse et gestion stricte des eaux de lavage pour des sols assainis et sécurisés.",
      whyUsBullets: [
      ...
      faqAdditions: [
        ...
        {
          question:
            "Quelle fréquence recommandez-vous pour les parkings de la Zone Industrielle du Plateau ?",
          answer:
            "<p>Le trafic poids lourds et la poussière industrielle justifient généralement un décrassage trimestriel. Pour les parkings à usage intensif avec véhicules de livraison, un passage bimestriel limite l'accumulation de graisse et préserve l'état du revêtement sur le long terme.</p>",
        },
        {
          question:
            "Adaptez-vous le lavage selon le revêtement des parkings à Champigny ?",
          answer:
            "<p>Oui, le diagnostic initial identifie le type de sol : béton brut, résine ou peinture. La pression et les produits sont ajustés en conséquence. Les revêtements résine des résidences récentes nécessitent une approche plus douce que le béton poreux des constructions anciennes.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      serviceKey: "balcons",
      heroDescription:
        "Une remise en état complète de votre balcon, du sol aux garde-corps, avec gestion maîtrisée des eaux de rinçage pour préserver votre voisinage.",
      whyUsBullets: [
      ...
      faqAdditions: [
        ...
        {
          question:
            "Quelle différence de traitement entre un balcon carrelé et des dalles sur plots dans une résidence récente ?",
          answer:
            "<p>Les dalles sur plots demandent une attention particulière aux interstices où s'accumulent débris et eau stagnante. Nous adaptons la pression et le rinçage pour nettoyer efficacement sans déplacer les dalles ni endommager le système de pose.</p>",
        },
        {
          question:
            "À quelle fréquence recommandez-vous un nettoyage pour un balcon exposé à la pollution de l'avenue du Général de Gaulle ?",
          answer:
            "<p>Les balcons situés près des axes passants accumulent plus rapidement suies et particules grasses. Un entretien annuel, idéalement au printemps, permet de maintenir un aspect propre et d'éviter que les dépôts ne s'incrustent durablement dans le revêtement.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      faqAdditions: [
        ...
        {
          question:
            "Comment la désinfection agit-elle sur les supports de mon balcon à Champigny ?",
          answer:
            "<p>Le produit utilisé est homologué virucide et bactéricide. Il est appliqué après le nettoyage mécanique et laissé en contact le temps nécessaire pour neutraliser les micro-organismes. Cette étape est indispensable pour un résultat sanitaire complet, pas seulement visuel.</p>",
        },
        {
          question:
            "Quelles solutions anti-retour proposez-vous après le traitement dans les immeubles des Mordacs ou du Bois l'Abbé ?",
          answer:
            "<p>Selon la configuration du balcon, nous pouvons recommander des pics anti-pigeons sur les rebords et corniches, des filets de protection pour les loggias ouvertes, ou un gel répulsif. Ces dispositifs réduisent significativement les risques de nouvelle colonisation.</p>",
        },
        {
          question:
...

    {
      ...
      faqAdditions: [
        {
          question:
            "Comment traitez-vous les taches d'urine animale sur un canapé dans les pavillons de Cœuilly ?",
          answer:
        ...
        {
          question:
            "À quelle fréquence recommandez-vous un nettoyage pour une famille avec enfants à Champigny ?",
          answer:
            "<p>Pour un usage familial intensif avec enfants ou animaux, un entretien annuel maintient les textiles en bon état. Si des taches apparaissent régulièrement, un passage tous les six à huit mois évite l'incrustation définitive. Les canapés clairs ou les tapis à poils longs demandent une attention plus fréquente.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription:
        "Une remise en état complète de votre terrasse, avec traitement des mousses et dépôts verts, adapté au carrelage, aux dalles ou au bois composite pour retrouver un espace extérieur agréable.",
      whyUsBullets: [
      ...
      faqAdditions: [
        ...
        {
          question:
            "Quelle différence de traitement entre une terrasse en carrelage et une en bois composite à Champigny-sur-Marne ?",
          answer:
            "<p>Le carrelage supporte un nettoyage plus appuyé avec dégraissant et haute pression modérée. Le bois composite nécessite un produit spécifique et une pression réduite pour éviter d'abîmer les fibres. Nous adaptons systématiquement la méthode au matériau identifié lors du diagnostic préalable.</p>",
        },
        {
          question:
            "À quelle fréquence recommandez-vous un nettoyage pour les terrasses exposées aux arbres dans le secteur Polangis ?",
          answer:
            "<p>Dans les zones ombragées et proches de la végétation, un entretien annuel — idéalement au printemps — permet de limiter l'accumulation de mousses et de dépôts organiques. Pour les terrasses très exposées, un passage supplémentaire à l'automne après la chute des feuilles peut être pertinent.</p>",
        },
        {
          question:
...

    {
      ...
      heroDescription:
        "Une remise en état complète de votre logement, du sol au plafond, avec coordination des accès et respect des délais pour une restitution sans accroc.",
      whyUsBullets: [
      ...
      faqAdditions: [
        ...
        {
          question:
            "Pouvez-vous vous coordonner avec mon agence immobilière pour un appartement situé dans le quartier du Maroc ?",
          answer:
            "<p>Oui, nous travaillons régulièrement avec les agences locales et les bailleurs sociaux de Champigny. Nous pouvons récupérer les clés, réaliser l'intervention et les restituer directement, en transmettant un compte-rendu si demandé.</p>",
        },
        {
          question:
            "Intervenez-vous après un dégât des eaux dans les immeubles anciens du centre-ville ?",
          answer:
            "<p>Nous traitons les logements après sinistre une fois l'assèchement terminé. L'intervention couvre le nettoyage des traces d'humidité, le dépoussiérage complet et le lavage des sols, en adaptant les produits aux revêtements fragilisés.</p>",
        },
        {
          question:
            "Comment se passe l'accès au logement si je ne peux pas être présent à Champigny ?",
          answer:
            "<p>Plusieurs options existent : remise des clés au gardien, dépôt en agence ou récupération via boîte à clés sécurisée. Nous confirmons l'accès la veille et vous informons dès la fin de l'intervention par message ou appel.</p>",
        },
      ],
      ctaOverride: "",
    },
