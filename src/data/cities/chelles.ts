...
const city: City = {
  ...
  services: [
    ...
    // =========================
    {
      ...
      uniqueIntro:
        "<p>À Chelles, les moquettes des halls d'entrée, cages d'escalier et paliers des copropriétés subissent une usure constante. Le passage quotidien des résidents, les intempéries et la proximité d'axes très fréquentés comme la RN34 laissent des traces visibles : poussières incrustées, taches localisées et ternissement général. Pour un syndic, cet état donne une impression de négligence qui peut affecter la valeur de l'immeuble et générer des réclamations.</p>\n<p class=\"mt-4\">Dans les bureaux ou les parties communes de résidences, une moquette sale devient un sujet récurrent de mécontentement. <strong>Un nettoyage technique approfondi et planifié</strong> est la seule réponse durable pour restaurer un cadre de vie sain et soigné, valorisant immédiatement l'image de la copropriété et le bien-être des occupants.</p>",
    ...
    // =========================
    {
      ...
      faqAdditions: [
        ...
        {
          question: "Faites-vous les vitres et les traces sur les murs ?",
          answer:
