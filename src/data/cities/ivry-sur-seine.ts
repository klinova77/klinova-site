...
faq: [
  {
    ...
    answer: `<p>Nous prenons contact avec le gardien ou le gestionnaire en amont pour convenir d'un créneau adapté. <strong>Les clés ou badges sont récupérés selon les modalités définies, et nous signalons notre présence à l'arrivée.</strong> Cette coordination évite les blocages d'accès et permet un déroulement fluide.</p>`,
  },
  {
  ...
  },
  {
    ...
    answer: `<p>Nous anticipons les contraintes de stationnement en identifiant les zones de dépose autorisées ou les accès livraison. <strong>Pour les interventions longues, nous sollicitons si besoin une autorisation temporaire auprès du syndic ou du gestionnaire</strong> afin d'éviter tout retard.</p>`,
  },
  {
    question: "Proposez-vous un devis avant intervention ?",
    answer: `<p><strong>Oui, chaque demande fait l'objet d'un échange préalable</strong> pour évaluer la surface, l'état des lieux et les contraintes d'accès. Le devis est transmis par écrit avant toute intervention, sans engagement tant qu'il n'est pas validé.</p>`,
  },
],
