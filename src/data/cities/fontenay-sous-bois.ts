...
const city: City = {
  ...
  customDescription:
    "Commune contrastée entre le Haut-Fontenay résidentiel de standing bordant le Bois de Vincennes et le Val de Fontenay, pôle économique dense. La végétation du Bois, la pollution de l'A86 et l'humidité des quartiers ombragés imposent un entretien spécialisé des surfaces pour préserver les villas bourgeoises, meulières de prestige et copropriétés modernes.",

  hubIntro:
    "<p>Fontenay-sous-Bois présente un <strong>parc immobilier diversifié</strong> nécessitant des protocoles différenciés selon les quartiers, du Village historique aux copropriétés denses du Val de Fontenay. Klinova intervient en partenariat avec les propriétaires de villas, les syndics et les gestionnaires pour assurer l'entretien des surfaces intérieures et extérieures, en tenant compte de la fracture urbaine créée par l'A86 et des facteurs de salissure spécifiques à chaque secteur.</p>\n<p>Nos équipes connaissent les spécificités locales : pollens collants et feuilles mortes massives du Bois de Vincennes dans le Haut-Fontenay, pollution noire de l'A86 au Val de Fontenay, humidité favorisant mousses et lichens dans le quartier des Voisins du Bois. Nous déployons des protocoles adaptés aux matériaux (meulières et pierres de taille anciennes nécessitant basse pression, surfaces vitrées modernes des copropriétés récentes) avec une organisation logistique tenant compte des contraintes d'accès variées.</p>\n<ul>\n  <li><strong>Adaptation aux deux pôles urbains :</strong> Protocoles basse pression et vapeur pour les villas et meulières du Haut-Fontenay (Village, Plateau, Voisins du Bois), méthodes pour copropriétés modernes du Val de Fontenay avec halls à fort passage et balcons exposés à la pollution urbaine.</li>\n  <li><strong>Maîtrise des facteurs de salissure contrastés :</strong> Traitement anti-mousse pour l'humidité du Plateau, élimination des pollens collants et feuilles massives du Bois, dégraissant renforcé pour la pollution noire de l'A86 au Val de Fontenay.</li>\n  <li><strong>Organisation logistique différenciée :</strong> Véhicules adaptés aux rues anciennes étroites du Village, vigilance pour les branches basses du Plateau, accès aux parkings privés des résidences du Val de Fontenay, planification tenant compte de la fracture urbaine A86/voies ferrées.</li>\n</ul>",

  citySpecificChallenges: [
    "<strong>Végétation du Bois de Vincennes</strong> générant pollens collants, sève des platanes et tilleuls, accumulation massive de feuilles mortes en automne dans le Haut-Fontenay (Village, Plateau, Voisins du Bois)",
    "<strong>Pollution atmosphérique de l'A86</strong> et du pôle RER Val de Fontenay déposant suie noire grasse sur vitrages et balcons des copropriétés du Bas-Fontenay et des Rigollots",
    "<strong>Fracture urbaine A86/voies ferrées</strong> imposant des temps de trajet variables entre quartiers et une organisation logistique différenciée selon le secteur d'intervention",
    "<strong>Matériaux contrastés</strong> nécessitant double expertise : meulières et pierres anciennes du Haut-Fontenay exigeant basse pression, copropriétés modernes du Val de Fontenay avec grandes surfaces vitrées et balcons en béton lasuré",
  ],
    ...
    // =========================
    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Nous planifions chaque intervention en tenant compte des temps de trajet variables imposés par l'A86 et les voies ferrées qui divisent la commune. Pour les parkings du Village aux rues anciennes étroites, nous utilisons des véhicules compacts et restons vigilants aux branches basses. Pour les parkings du Val de Fontenay, nous accédons via les parkings privés des résidences et évitons les heures de pointe du pôle tertiaire. Cette organisation logistique différenciée est essentielle dans une commune où les deux pôles urbains imposent des contraintes d'accès totalement différentes.</p>",
        },
      ],
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Oui. Nous organisons l’intervention en fonction des contraintes d’accès (digicode, gardien, consignes de copropriété) et du stationnement, notamment près de Val de Fontenay. Le but est de livrer un logement propre et présentable dans un délai compatible avec votre date de remise des clés.</p>",
        },
        {
          question:
            "Comment protégez-vous un parquet ancien dans le secteur Village lors d’un grand ménage ?",
          answer:
            "<p>Lors du diagnostic, nous identifions le type de parquet et son état. Nous privilégions des méthodes maîtrisées (sans excès d’eau, sans abrasion), avec des produits compatibles. L’objectif est un rendu net sans risque de voile ni d’altération des finitions.</p>",
        },
        {
          question:
            "Que comprend votre méthode pour cuisine et salle de bain ?",
          answer:
            "<p>Nous travaillons par zones : dépoussiérage, puis traitement ciblé. En cuisine, le <strong>dégraissage cuisine</strong> porte sur les surfaces accessibles (plans, crédences, façades selon l’état). En salle de bain, le <strong>détartrage sanitaires</strong> est adapté aux matériaux, avec une attention particulière aux zones qui se voient le plus (robinetterie, parois, joints).</p>",
        },
        {
          question:
            "Le logement peut-il être réutilisé le jour même après intervention ?",
          answer:
            "<p>Dans la majorité des cas, oui. Nous limitons l’humidité résiduelle et prévoyons une aération en fin de prestation. Pour les logements très encrassés ou certains revêtements, nous vous indiquons simplement le temps d’aération conseillé au moment du diagnostic.</p>",
        },
      ],
