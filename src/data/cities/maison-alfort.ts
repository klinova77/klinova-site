...
const city: City = {
  ...
  citySpecificChallenges: [
    ...
    "<strong>Flux piétons quotidiens massifs</strong> autour des trois stations de métro ligne 8 (École Vétérinaire de Maisons-Alfort, Maisons-Alfort – Stade, Maisons-Alfort – Les Juilliottes) et des gares RER D (Maisons-Alfort – Alfortville, Le Vert-de-Maisons), accentuant l'usure des moquettes de parties communes.",
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "<p>Oui. Nous nous déplaçons sans frais dans tous les quartiers de Maisons-Alfort, du Charentonneau à Liberté-Vert-de-Maisons, pour établir un diagnostic précis. Cette visite permet d'évaluer la surface à traiter, le type de revêtement, les contraintes d'accès (badges, ascenseurs, présence d'un gardien) et les éventuelles spécificités techniques. Vous recevez ensuite une <strong>proposition détaillée</strong>, sans engagement, tenant compte de la configuration réelle du site.</p>",
    },
    {
      question:
    ...
    },
    {
      ...
      answer:
        "<p>Chaque passage fait l'objet d'un <strong>compte-rendu écrit</strong> transmis au syndic ou au gestionnaire, précisant les surfaces traitées, les produits utilisés, les éventuelles observations techniques (siphon bouché, fissure, marquage effacé) et les recommandations de fréquence pour maintenir la propreté. Nous mettons également en place des contrats d'entretien annuels pour les copropriétés souhaitant planifier les interventions de manière préventive (nettoyage de moquettes tous les 12 à 18 mois, décrassage de parkings semestriel ou annuel).</p>",
    },
  ],
  ...
  services: [
    ...
    // =========================
    {
      ...
      specificChallenges: [
        "Les moquettes des halls situés près des stations métro ligne 8 (École Vétérinaire, Stade, Les Juilliottes) subissent <strong>un encrassement accéléré</strong> lié aux flux piétons quotidiens massifs.",
        "Les particules fines générées par la proximité des axes A4 et A86 s'incrustent dans les fibres et nécessitent <strong>une extraction puissante</strong> pour un résultat durable.",
        "Les marches d'escalier dans les immeubles anciens du Centre-ville et d'Alfort présentent <strong>des usures localisées</strong> demandant un traitement ciblé et plusieurs passes successives.",
      ],
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Nous intervenons aussi bien dans les cages d'escalier des petites copropriétés du Centre-ville que dans les halls vitrés des grands ensembles des Juilliottes ou de Liberté-Vert-de-Maisons. Le matériel est dimensionné selon la surface et les <strong>contraintes d'accès</strong> (escaliers étroits, absence d'ascenseur, badges). Chaque intervention fait l'objet d'un diagnostic préalable pour adapter la méthode et le temps nécessaire.</p>",
        },
        {
          question:
    ...
    // =========================
    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Nous dirigeons systématiquement l'eau vers l'évacuation du balcon à l'aide de raclettes et de chiffons absorbants. Si le balcon n'a pas <strong>d'évacuation fonctionnelle</strong> ou si la pente est mal orientée, nous récupérons l'eau manuellement pour éviter tout écoulement sur la façade ou vers les balcons inférieurs. Cette contrainte technique est anticipée lors de la prise de rendez-vous et intégrée dans l'organisation de l'intervention.</p>",
        },
        {
          question:
    ...
    // =========================
    {
      ...
      specificChallenges: [
        ...
        "L'accès aux balcons en étage dans les collectifs des Juilliottes ou d'Hector Berlioz impose une <strong>organisation précise</strong> (ascenseurs, badges, coordination avec gardien) et un conditionnement étanche des déchets pour éviter toute contamination des circulations communes.",
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Les produits virucides et bactéricides sont appliqués selon les dosages réglementaires et rincés après le temps de contact nécessaire (généralement 10 à 15 minutes). Après <strong>séchage complet</strong> (24 heures recommandées), le balcon est totalement sûr pour tous les occupants, y compris enfants et animaux domestiques. Nous vous communiquons les délais exacts de réintégration et les éventuelles précautions à respecter lors de l'intervention.</p>",
        },
        {
          question:
    ...
    // =========================
    {
      ...
      specificChallenges: [
        ...
        "Le <strong>séchage peut être ralenti</strong> dans les pièces humides ou mal aérées des Planètes ou d'Alfort, nécessitant des consignes précises (fenêtres ouvertes, chauffage modéré) pour éviter toute réhumidification prématurée.",
      ],
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Le séchage prend généralement entre 4 et 8 heures selon la ventilation, l'épaisseur du textile et l'<strong>humidité ambiante</strong>. Nous vous recommandons d'attendre 6 heures minimum avant de vous asseoir sur le canapé ou de marcher sur le tapis. Pour un matelas, il est préférable d'attendre une nuit complète (12 à 16 heures) avant de remettre les draps et de dormir dessus, surtout dans les logements du Charentonneau ou des Planètes où l'humidité peut ralentir le séchage.</p>",
        },
        {
          question:
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Oui. Nous cadrons le périmètre puis nous traitons les <strong>zones qui comptent le plus</strong> lors d’un contrôle : cuisine, salle d’eau, sols et finitions visibles (plinthes, poignées, interrupteurs, encadrements). La planification tient compte des accès (digicode/Vigik) et des contraintes de stationnement autour des stations.</p>",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "<p>Pas si l’accès est anticipé. Nous prévoyons le Vigik, l’ascenseur et le <strong>cheminement pour monter le matériel</strong> en une fois, puis nous travaillons de façon à conserver les sols propres jusqu’à la sortie. Les pièces d’eau (calcaire/joints) et les baies vitrées sont traitées en priorité selon le besoin.</p>",
        },
        {
