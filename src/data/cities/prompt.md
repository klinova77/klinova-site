...
- heroDescription :
  ...
  • Mentionner un problème ou contexte plausible (passages, dépôts, poussières, salissures, fientes, odeurs, etc.).
  • Ne pas copier mot pour mot uniqueIntro ; produire une formulation dédiée.

  Exemple :
  “À Torcy, les parkings des résidences récentes accumulent rapidement poussières, traces d’huile et salissures liées aux allées et venues quotidiennes.”
