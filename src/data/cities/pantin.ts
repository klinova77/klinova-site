...
const city: City = {
  ...
  faq: [
    {
      question:
        "Comment organisez-vous vos interventions avec les contraintes de stationnement à Pantin ?",
      answer:
        "<p>Le stationnement peut être contraint selon les secteurs. Nous anticipons en repérant les solutions à proximité (parkings publics, accès de service, zones de dépose) et en planifiant des créneaux adaptés. Pour les interventions longues, nous coordonnons avec le gardien ou le gestionnaire afin de sécuriser un <strong>accès véhicule ponctuel</strong> pour le déchargement.</p>",
    },
    {
      question: "Intervenez-vous dans les immeubles avec badge ou digicode ?",
      answer:
        "<p>Oui, c'est fréquent à Pantin, notamment dans les résidences récentes et les copropriétés réhabilitées. Nous récupérons les <strong>accès</strong> en amont auprès du syndic ou du gardien. Pour les bureaux sécurisés, nous nous adaptons aux protocoles d'entrée en vigueur.</p>",
    },
    {
    ...
    {
      question:
        "Proposez-vous un suivi régulier pour les copropriétés ou entreprises ?",
      answer:
        "<p>Nous mettons en place des contrats d'entretien avec une fréquence adaptée : hebdomadaire, mensuelle ou trimestrielle selon les besoins. Un <strong>reporting</strong> peut être transmis au syndic ou au responsable des services généraux pour assurer le suivi des prestations réalisées.</p>",
    },
  ],
  ...
  services: [
    {
      ...
      faqAdditions: [
        ...
        {
          question:
            "Après un shampouinage en profondeur, combien de temps faut-il avant de réutiliser une moquette de bureau proche de l'avenue Jean Lolive ?",
          answer:
            "<p>Le temps de séchage varie selon l'épaisseur du revêtement et la ventilation du local. En général, comptez 4 à 8 heures pour une remise en service. Nous conseillons d'intervenir en fin de journée afin que les moquettes soient praticables dès le lendemain matin, sans <strong>résidu d'humidité</strong>.</p>",
        },
        {
          question:
            "Quelle méthode recommandez-vous pour les moquettes épaisses des open-spaces afin d'éviter l'affaissement des fibres ?",
          answer:
            "<p>L'injection-extraction reste la technique la plus adaptée : elle nettoie en profondeur sans saturer le support. Nous ajustons la pression et le débit selon la densité des fibres. Un <strong>brossage doux</strong> en fin d'intervention redresse les poils et préserve l'aspect d'origine du revêtement.</p>",
        },
        {
          question:
            "Avec le stationnement limité autour des Grands Moulins, comment organisez-vous la livraison et la collecte du matériel ?",
          answer:
            "<p>Nous repérons les emplacements de dépose-minute ou les accès de service avant l'intervention. Le matériel est déchargé rapidement puis le véhicule stationné en zone autorisée. Cette organisation évite les contraventions et garantit une présence discrète sur site pendant toute la durée du chantier.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      serviceKey: "parkings",
      heroDescription:
        "Décrassage complet des sols de parking avec autolaveuse et dégraissant professionnel, gestion stricte des eaux usées et balisage sécurisé pour limiter la gêne aux usagers.",
      whyUsBullets: [
      ...
      faqAdditions: [
        {
          question:
            "Comment organisez-vous la rotation des véhicules dans un parking le long de l'avenue Jean Lolive ?",
          answer:
            "<p>Nous définissons un zonage par secteur avec le gestionnaire. Les véhicules sont déplacés progressivement vers les zones déjà traitées. Un balisage clair guide les usagers et évite toute confusion pendant l'intervention. La circulation reste possible sur les parties non concernées.</p>",
        },
        {
          question:
            "Quelle solution technique utilisez-vous pour évacuer les eaux de lavage dans un parking souterrain de résidence récente ?",
          answer:
            "<p>Les eaux chargées sont dirigées vers les regards existants après vérification de leur bon fonctionnement. Si nécessaire, nous aspirons les effluents pour éviter tout débordement. Aucun rejet n'est effectué vers la voirie ou les espaces communs extérieurs.</p>",
        },
        {
          question:
            "Comment traitez-vous les rampes glissantes pour garantir l'adhérence après le lavage ?",
          answer:
            "<p>Nous appliquons un dégraissant adapté qui élimine les résidus huileux sans laisser de film glissant. Un rinçage soigné complète le traitement. Sur les revêtements peints ou résine, la pression est ajustée pour préserver l'état de surface antidérapant.</p>",
        },
        {
          question:
            "Quels créneaux privilégiez-vous pour intervenir dans les parkings publics Hoche ou Église ?",
          answer:
            "<p>Les interventions sont programmées en dehors des heures de pointe, généralement tôt le matin ou en soirée. Nous évitons les jours de marché et les périodes d'affluence commerciale. Le planning est validé avec le gestionnaire pour minimiser l'impact sur les usagers.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      serviceKey: "balcons",
      heroDescription:
        "Une remise en état complète de votre balcon, avec traitement adapté au support, protection des menuiseries et gestion anti-coulures pour préserver vos relations de voisinage.",
      whyUsBullets: [
      ...
      faqAdditions: [
        {
          question:
            "Comment nettoyer un balcon en béton très encrassé près de la Place Olympe de Gouges sans abîmer les joints ?",
          answer:
            "<p>Nous appliquons un produit désincrustant adapté au béton, suivi d'un brossage mécanique doux. Les joints sont traités séparément avec une brosse fine pour retirer mousses et noircissures sans creuser la matière. Le rinçage à pression modérée évite toute dégradation.</p>",
        },
        {
          question:
            "Les balcons proches du Parc Diderot présentent mousse et taches vertes : quelle méthode utilisez-vous ?",
          answer:
            "<p>La végétation environnante favorise ces dépôts organiques. Nous utilisons un traitement anti-mousse appliqué avant brossage, qui décolle les couches vertes sans recourir à une pression excessive. Le résultat est visible dès le séchage, et l'effet dure plusieurs mois.</p>",
        },
        {
          question:
            "Quelle différence de traitement entre une loggia et un balcon ouvert dans le secteur Mairie-Hoche ?",
          answer:
            "<p>Une loggia semi-fermée retient davantage l'humidité et les poussières. Le rinçage y est plus délicat car l'évacuation naturelle est limitée. Nous adaptons le volume d'eau et utilisons une aspiration si nécessaire pour éviter les flaques résiduelles.</p>",
        },
        {
          question:
            "En cas d'accès difficile en étage élevé, comment organisez-vous l'intervention pour limiter la gêne ?",
          answer:
            "<p>Nous convenons d'un créneau avec vous et, si besoin, prévenons le gardien ou le syndic. Le matériel est monté en une seule fois. L'intervention reste concentrée sur quelques heures pour réduire les allers-retours dans les parties communes.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription:
        "Assainissement complet de votre balcon souillé par les fientes, avec désinfection virucide des surfaces et pose optionnelle de dispositifs anti-retour pour retrouver un espace extérieur sain.",
      whyUsBullets: [
      ...
      faqAdditions: [
        {
          question:
            "Les fientes accumulées sur un balcon proche du Canal de l'Ourcq présentent-elles un risque sanitaire réel ?",
          answer:
        ...
        {
          question:
            "Quel équipement utilisez-vous pour traiter un balcon très souillé dans les immeubles béton des Courtillières ?",
          answer:
            "<p>L'intervenant porte une combinaison jetable, un masque FFP2, des gants et des lunettes de protection. Les fientes sont humidifiées avant manipulation pour éviter l'envol de particules. Le sol béton et les garde-corps sont ensuite traités avec un produit virucide homologué, appliqué avec temps de contact respecté avant rinçage.</p>",
        },
        {
          question:
            "Quel traitement garantit une désinfection efficace sur les balcons proches du Parc Diderot ?",
          answer:
        ...
        {
          question:
            "Qui prend en charge l'évacuation des déchets contaminés après nettoyage en copropriété à Quatre-Chemins ?",
          answer:
...

    {
      ...
      heroDescription:
        "Extraction des salissures incrustées dans vos canapés, tapis et matelas, avec détachage ciblé et séchage maîtrisé pour retrouver un textile propre et sain.",
      whyUsBullets: [
      ...
      faqAdditions: [
        {
          question:
            "Un nettoyage complet élimine-t-il les allergènes et acariens sur un canapé tissu utilisé quotidiennement par une famille à Pantin ?",
          answer:
            "<p>L'injection-extraction déloge les acariens et résidus allergènes piégés dans les fibres. Le résultat améliore sensiblement la qualité de l'air intérieur, particulièrement appréciable dans les salons familiaux des quartiers résidentiels autour de l'Église Saint-Germain où le canapé est sollicité chaque jour.</p>",
        },
        {
          question:
            "Pour des taches d'urine anciennes sur tapis dans un logement proche du Parc Diderot, quelle prise en charge assure un retrait efficace des odeurs ?",
          answer:
            "<p>Un pré-traitement enzymatique cible les composés organiques responsables de l'odeur. L'extraction en profondeur retire ensuite les résidus incrustés. Sur des taches anciennes, plusieurs passages peuvent être nécessaires pour neutraliser complètement les effluves persistants.</p>",
        },
        {
          question:
            "Comment traitez-vous un canapé non déhoussable en tissu sans détremper la mousse intérieure dans un appartement ancien du quartier Quatre-Chemins ?",
          answer:
            "<p>La quantité d'eau injectée est calibrée pour pénétrer la fibre sans saturer la mousse. L'aspiration immédiate limite l'humidité résiduelle. Le séchage complet intervient généralement sous quelques heures avec une aération correcte du logement.</p>",
        },
        {
          question:
            "En zone rouge avec stationnement limité autour de l'Église, quel matériel privilégiez-vous pour une intervention canapé à domicile ?",
          answer:
            "<p>Nous utilisons un équipement compact et portable, transportable en étage sans encombrement excessif. Le véhicule peut stationner brièvement le temps du déchargement. Cette organisation permet d'intervenir efficacement malgré les contraintes de stationnement en centre-ville de Pantin.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription:
        "Une remise en état complète de votre logement, du sol aux finitions, avec coordination des accès et respect des délais pour état des lieux ou fin de chantier.",
      whyUsBullets: [
      ...
      faqAdditions: [
        ...
        {
          question:
            "Quel protocole appliquez-vous pour un nettoyage fin de chantier avec poussières fines et résidus de plâtre dans les ZAC ?",
          answer:
            "<p>L'intervention commence par un dépoussiérage complet des surfaces hautes vers le sol, puis une aspiration avec filtration adaptée aux particules fines. Les traces d'enduit ou de peinture sont traitées manuellement avant le lavage final des sols et des vitres intérieures.</p>",
        },
        {
          question:
            "Quel niveau de propreté livrez-vous pour garantir la validation d'un état des lieux par une agence immobilière ?",
          answer:
            "<p>Nous visons un rendu permettant la validation sans réserve : sols sans traces, vitres propres, sanitaires désinfectés, placards vidés et nettoyés. Un contrôle final vérifie chaque point avant votre passage avec l'agence ou le bailleur.</p>",
        },
        {
          question:
            "Comment coordonnez-vous l'intervention avec les artisans en cas de travaux encore en cours dans un appartement pantinois ?",
          answer:
            "<p>Nous échangeons directement avec le chef de chantier ou le maître d'œuvre pour caler notre passage après les dernières finitions. Si des retouches sont prévues, nous adaptons notre intervention pour éviter de repasser sur des zones déjà nettoyées.</p>",
        },
      ],
      ctaOverride: "",
    },
