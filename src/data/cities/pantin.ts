  ...
  services: [
    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Le temps de séchage varie selon l'épaisseur du revêtement et la ventilation du local. En général, comptez 4 à 8 heures pour une remise en service. Nous conseillons d'intervenir en fin de journée afin que les moquettes soient praticables dès le lendemain matin, sans résidu d'humidité.</p>",
        },
        {
          question:
            "Quelle méthode recommandez-vous pour les moquettes épaisses des open-spaces afin d'éviter l'affaissement des fibres ?",
          answer:
            "<p>L'injection-extraction reste la technique la plus adaptée : elle nettoie en profondeur sans saturer le support. Nous ajustons la pression et le débit selon la densité des fibres. Un brossage doux en fin d'intervention redresse les poils et préserve l'aspect d'origine du revêtement.</p>",
        },
        {
          question:
