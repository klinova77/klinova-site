...
const city: City = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "<p>Selon la nature de la demande et notre planning, nous pouvons intervenir sous <strong>24 à 48 heures</strong> pour les situations prioritaires. Un premier échange permet d'évaluer le contexte et de confirmer la disponibilité d'une équipe sur le secteur.</p>",
    },
    {
      question:
