  ...
  services: [
    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>L'injection-extraction reste la technique la plus adaptée aux dalles textiles. Elle limite l'apport d'eau tout en assurant une extraction efficace des salissures. La vapeur seule convient aux désinfections légères mais ne retire pas les particules incrustées. Nous ajustons la pression et le débit selon la densité du tissage.</p>",
        },
        {
          question:
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Le béton brut est poreux et peut se dégrader sous une pression trop forte. Nous utilisons un brossage mécanique adapté et une pression modérée. Le produit désincrustant agit en profondeur avant rinçage, ce qui limite l'agression mécanique tout en éliminant les salissures incrustées.</p>",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "<p>Avant de commencer, nous repérons le point d'évacuation et protégeons les abords. Le rinçage est orienté vers la descente d'eau, avec un débit maîtrisé. Si le balcon surplombe un autre espace, nous prévenons les occupants et installons une protection temporaire.</p>",
        },
        {
          question:
...

    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Nous utilisons un produit virucide et bactéricide homologué, appliqué sur l'ensemble des surfaces nettoyées. Le temps de contact est respecté avant rinçage pour garantir l'élimination des agents pathogènes. Cette étape est indispensable sur les supports poreux comme le béton ou la pierre ancienne.</p>",
        },
        {
          question:
...

    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Nous calons la date et l'heure directement avec l'agence ou le gestionnaire, en tenant compte du créneau de l'état des lieux. Les clés peuvent être récupérées en agence ou auprès du gardien. Un compte rendu est transmis si nécessaire pour confirmer la réalisation de la prestation.</p>",
        },
        {
          question:
