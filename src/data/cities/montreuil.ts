...
const city: City = {
  ...
  hubIntro:
    "<p>Montreuil présente un tissu urbain contrasté, entre Bas-Montreuil gentrifié et Haut-Montreuil résidentiel, avec des copropriétés de toutes tailles et des contraintes d'accès variées. <strong>Klinova intervient auprès des syndics, gestionnaires et propriétaires</strong> pour assurer l'entretien des parties communes, parkings et surfaces privées, en tenant compte des difficultés de circulation et de stationnement typiques de la commune.</p>\n<p>Nos équipes connaissent les spécificités locales : pollution atmosphérique intense près du Périphérique, poussières de chantier liées aux nombreuses rénovations, accès complexes dans les anciennes cours et impasses du Bas-Montreuil. Nous déployons du matériel portable et compact adapté aux contraintes logistiques, avec des protocoles ajustés à chaque support (briques poreuses, verrières industrielles, moquettes de grands ensembles).</p>\n<ul>\n  <li>Adaptation aux contraintes d'accès : <strong>Matériel portable pour les cours intérieures</strong> et impasses étroites du Bas-Montreuil, véhicules compacts pour circulation dans les secteurs saturés, planification en dehors des heures de pointe à Croix de Chavaux et Porte de Montreuil.</li>\n  <li>Maîtrise des salissures urbaines : Protocoles renforcés pour la pollution noire du Périphérique, <strong>gestion des poussières fines de rénovation</strong>, traitement adapté aux façades en brique poreuse typiques des immeubles faubouriens et HBM.</li>\n  <li>Organisation logistique rigoureuse : <strong>Coordination avec les syndics pour stationnement temporaire</strong>, information préalable des résidents dans les immeubles sans ascenseur, compte-rendu systématique pour garantir traçabilité et suivi de maintenance.</li>\n</ul>",
  ...
  citySpecificChallenges: [
    ...
    "Accès complexes dans les anciennes cours et impasses du Bas-Montreuil avec <strong>portails étroits</strong> nécessitant du matériel portable et une planification logistique fine",
    "Stationnement très difficile dans les secteurs centraux et Bas-Montreuil imposant <strong>coordination avec syndics</strong> et interventions en heures creuses pour limiter la gêne",
  ],
  ...
  services: [
    ...
    // =========================
    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p><strong>Absolument. Nous utilisons du matériel portable</strong> spécialement conçu pour ces configurations : machines d'injection-extraction transportables, tuyaux de 50 mètres pour atteindre les étages ou les cours intérieures. Nos techniciens ont l'habitude de monter le matériel dans les immeubles faubouriens sans ascenseur et de franchir les portails étroits des anciennes impasses de Montreuil. La visite préalable permet de valider la faisabilité technique.</p>",
        },
        {
          question:
            "Les poussières de chantier peuvent-elles abîmer définitivement les moquettes ?",
          answer:
            "<p><strong>Les particules de plâtre et de ciment sont abrasives</strong> et peuvent user prématurément les fibres si elles ne sont pas extraites régulièrement. Elles s'incrustent profondément et forment une couche dure qui ternit l'aspect général. Un nettoyage professionnel après des travaux importants dans l'immeuble ou à proximité extrait ces particules avant qu'elles ne causent des dégâts irréversibles. C'est particulièrement important à Montreuil où les chantiers de rénovation sont nombreux.</p>",
        },
        {
          question:
    ...
    // =========================
    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>La pollution atmosphérique du Périphérique et des flux routiers dépose quotidiennement des particules grasses difficiles à éviter. Nous recommandons <strong>un balayage hebdomadaire</strong> pour éliminer la poussière avant qu'elle ne s'incruste et ne se transforme en couche grasse collante, et un rinçage mensuel léger avec un jet d'eau. Un nettoyage professionnel annuel avec dégraissant permet de traiter les salissures tenaces et de préserver l'aspect des surfaces. C'est la réalité de vivre dans un environnement urbain dense comme Montreuil.</p>",
        },
        {
          question:
            "Les poussières de chantier des rénovations voisines peuvent-elles abîmer mon balcon ?",
          answer:
            "<p><strong>Les particules de plâtre et de ciment sont abrasives</strong> et peuvent rayer les surfaces fragiles si elles sont frottées à sec. Elles forment aussi une couche blanchâtre qui s'incruste dans les joints et les aspérités. Un nettoyage professionnel après des travaux importants dans l'immeuble ou à proximité élimine ces particules avant qu'elles ne causent des dégâts. C'est particulièrement important à Montreuil où les chantiers de rénovation et surélévations sont nombreux et génèrent une pollution de proximité intense.</p>",
        },
        {
          question:
    ...
    // =========================
    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Cela dépend de l'ancienneté de la contamination. Sur les garde-corps métalliques, l'acidité des fientes provoque <strong>une oxydation rapide</strong> qui fragilise la structure et nécessite parfois un traitement antirouille après nettoyage. Sur les murs en brique, elle érode la surface et déchausse les joints. Sur les carrelages, elle crée des taches brunâtres qui pénètrent profondément. Une intervention rapide limite les dégâts structurels. Les contaminations anciennes (plusieurs mois) peuvent laisser des marques résiduelles et nécessiter des réparations complémentaires, mais le nettoyage professionnel stoppe la dégradation active.</p>",
        },
        {
          question:
            "Comment éviter que les pigeons ne reviennent coloniser mon balcon ?",
          answer:
            "<p>Nous proposons la pose de solutions anti-pigeons adaptées à l'environnement urbain montreuillois : <strong>pics discrets sur les garde-corps et corniches</strong>, filets transparents pour les loggias des grands ensembles, répulsifs visuels pour les structures métalliques des lofts. Ces dispositifs s'intègrent à l'architecture urbaine tout en empêchant durablement la nidification. L'inspection régulière des points d'accès (charpentes, avancées de toit, structures industrielles) et l'intervention rapide dès les premiers signes de retour limitent également le risque de recolonisation massive et de nouveaux dégâts sur les supports.</p>",
        },
      ],
...

    {
      ...
      faqAdditions: [
        {
          question:
            "Intervenez-vous à Montreuil (93100) pour un nettoyage de fin de bail / état des lieux ?",
          answer:
            "<p>Oui. Nous cadrons le périmètre pour viser un rendu “contrôlable” : cuisine, salle d’eau, sols, vitrages accessibles, puis finitions (plinthes, portes, interrupteurs). À Montreuil, on anticipe aussi l’accès (badges) et le stationnement pour tenir le créneau sans bâcler la finition.</p>",
        },
        {
          question:
            "Pouvez-vous nettoyer un loft avec verrière ou grandes baies (Bas-Montreuil) ?",
          answer:
            "<p>Oui. Les lofts demandent surtout une méthode adaptée aux surfaces (béton ciré/résine) et aux vitrages (verrières, hauteurs). On sécurise le dépoussiérage fin, le dégraissage, puis on termine par les vitres accessibles et les finitions pour éviter le voile et les traces.</p>",
        },
        {
          question:
            "Le stationnement est compliqué : comment vous organisez-vous ?",
          answer:
            "<p>Nous planifions l’arrivée et le déchargement, et nous évitons les secteurs les plus saturés aux heures critiques (notamment autour Mairie/Croix de Chavaux). L’objectif est simple : limiter les allers-retours et garder du temps pour la finition.</p>",
        },
        {
          question:
            "Faites-vous un nettoyage après travaux (poussière fine, traces) ?",
          answer:
            "<p>Oui. Après rénovation, on traite la poussière fine et les traces sur menuiseries, plinthes et sols avant le nettoyage complet. C’est fréquent à Montreuil, notamment sur des remises en état rapides proches métro et dans les secteurs en travaux.</p>",
        },
      ],
