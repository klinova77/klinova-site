      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Nous utilisons des équipements compacts et modulables, transportables en plusieurs voyages si nécessaire. Le <strong>repérage préalable des accès</strong> permet d'anticiper les difficultés et d'organiser l'intervention sans bloquer les circulations ni abîmer les murs des cages d'escalier.</p>",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "<p>L'injection-extraction reste la base dans les deux cas. Pour une médiathèque à fort passage, nous augmentons le <strong>nombre de passes</strong> sur les zones de circulation. Dans un bureau, l'accent porte sur le détachage ciblé des postes de travail et le séchage rapide pour limiter l'interruption d'activité.</p>",
        },
      ],
      ctaOverride: "",
    },
