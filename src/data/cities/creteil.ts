...
const city: City = {
  ...
  hubIntro: `<p><strong>Klinova</strong> intervient à <strong>Créteil</strong> pour accompagner <strong>syndics de copropriété</strong>, <strong>gestionnaires immobiliers</strong> et <strong>bailleurs</strong> dans la maintenance des surfaces et l'entretien des équipements collectifs. Nous connaissons les <strong>contraintes d'accès</strong> autour de la Préfecture, les <strong>flux intenses</strong> du secteur Créteil Soleil et les spécificités des tours de Mont-Mesly comme des résidences de la Pointe du Lac.</p>
<p>Notre approche repose sur une <strong>organisation rigoureuse</strong>, un <strong>matériel adapté</strong> aux différentes typologies de bâti et un <strong>suivi précis</strong> de chaque intervention. Nous coordonnons nos passages avec les gardiens, adaptons nos horaires aux contraintes de circulation et <strong>documentons systématiquement</strong> les opérations réalisées.</p>
<ul>
  <li><strong>Parties communes et surfaces textiles</strong> : moquettes de halls, escaliers et paliers dans les copropriétés du Centre ancien, de la Préfecture et du Front de Lac, avec gestion des contraintes d'accès et adaptation aux <strong>flux piétons importants</strong>.</li>
  <li><strong>Parkings souterrains et aériens</strong> : décrassage des sols béton et résine, <strong>traitement des taches d'hydrocarbures</strong>, remise en état des marquages dans les parkings de résidences, de Créteil Soleil et du secteur Pompadour.</li>
  <li><strong>Espaces extérieurs privatifs</strong> : remise en état de balcons et terrasses pour les particuliers des quartiers Halage, Chenevier et bords de Marne, avec gestion adaptée des supports (carrelage, béton, dalles) et maîtrise de <strong>l'évacuation des eaux</strong>.</li>
  <li><strong>Textiles à domicile</strong> : rafraîchissement de canapés, tapis et matelas chez les particuliers des secteurs pavillonnaires et résidentiels, avec protocoles d'injection-extraction et <strong>conseils d'entretien</strong>.</li>
</ul>`,

  citySpecificChallenges: [
    "Encrassement accéléré des halls et parkings autour des stations de métro ligne 8 (Créteil-Préfecture, Créteil-Université, Créteil-L'Échat, Créteil-Pointe du Lac) et de la gare RER D Créteil-Pompadour en raison des flux piétons quotidiens massifs.",
    "Particules fines et poussières urbaines générées par l'A86 et l'échangeur Pompadour, impactant les balcons, vitres et surfaces extérieures des résidences situées en proximité des grands axes.",
    "Accumulation de feuilles et boues sur les balcons et terrasses des quartiers Halage, bords de Marne et Front de Lac en raison de la végétation dense et de la proximité du lac.",
    "Parties communes étendues dans les tours et grands ensembles de Mont-Mesly nécessitant une coordination précise avec les bailleurs et syndics pour limiter la gêne des résidents lors des interventions.",
  ],
  ...
  faq: [
    {
      ...
      answer:
        "<p>Nous mobilisons nos équipes locales pour des interventions urgentes à Créteil, notamment autour de la Préfecture, du CHU Henri-Mondor ou dans les copropriétés de Mont-Mesly. En cas de <strong>sinistre</strong> (dégât des eaux, pollution accidentelle) ou de <strong>livraison de chantier</strong> nécessitant une remise en état rapide, nous établissons un diagnostic par téléphone, confirmons la faisabilité technique et planifions le passage sous <strong>24 à 48 heures</strong> selon disponibilité. Le matériel est adapté à la surface et à la contrainte (autolaveuse, injection-extraction, haute pression contrôlée).</p>",
    },
    {
      question: "Le déplacement pour établir un devis à Créteil est-il facturé ?",
      answer:
    ...
    {
      question: "Proposez-vous un suivi régulier pour les copropriétés de Créteil ?",
      answer:
  ...
  services: [
    ...
    // =========================
    {
      ...
      uniqueIntro: `<p>Les traces de pas s'accumulent dans les halls vitrés de la Préfecture, les paliers des tours de Mont-Mesly et les escaliers des résidences du Centre ancien. Le passage quotidien des habitants empruntant le <strong>métro ligne 8</strong> ou le <strong>RER D</strong> marque les fibres, ternit les couleurs et <strong>incruste les salissures</strong> jusqu'à créer des zones grisâtres difficilement récupérables par un simple aspirateur.</p>
<p class="mt-4">Dans les copropriétés proches des stations <strong>Créteil-Université</strong> ou <strong>Créteil-L'Échat</strong>, les flux piétons intenses amplifient l'encrassement. Les moquettes perdent leur aspect d'origine en quelques mois, donnant une <strong>impression de négligence</strong> qui impacte la valeur perçue du bâtiment. Les syndics reçoivent des remarques, les conseils syndicaux cherchent des solutions économiques, et les tentatives avec des appareils domestiques échouent face à l'ampleur des surfaces et à la profondeur des salissures.</p>
<p class="mt-4">Un nettoyage par <strong>injection-extraction</strong> élimine les dépôts incrustés, ravive les teintes et <strong>assainit les fibres en profondeur</strong>. Les parties communes retrouvent une propreté visible qui rassure les occupants et valorise le patrimoine immobilier.</p>`,

      uniqueDeepDive: `<h3>Analyse technique préalable</h3>
<p>Le technicien examine la nature de la moquette (bouclée, velours, synthétique, laine), repère les zones de <strong>fort trafic</strong> (entrées de halls, paliers d'ascenseurs, marches d'escalier) et identifie les taches spécifiques (boue séchée, graisse, traces de semelles). Dans les immeubles de la Préfecture ou du Front de Lac, il évalue les contraintes d'accès (ascenseurs, badges, présence d'un gardien) et vérifie la compatibilité du revêtement avec <strong>l'injection d'eau chaude</strong>.</p>

<h3>Extraction haute performance</h3>
<p class="mt-4">La machine d'injection-extraction projette une solution nettoyante chauffée sous <strong>pression contrôlée</strong>, puis aspire instantanément l'eau chargée de salissures. Les zones à fort passage reçoivent plusieurs passes successives pour garantir un détachage complet. Les angles, bas de murs et contremarches sont traités au détail pour éviter toute zone oubliée. L'extraction puissante limite l'humidité résiduelle et réduit les <strong>délais de séchage</strong> à quelques heures selon la ventilation naturelle.</p>

<h3>Suivi et recommandations d'entretien</h3>
<p class="mt-4">Après séchage, le technicien vérifie l'absence de traces résiduelles et remet au syndic ou au gestionnaire un <strong>rapport</strong> détaillant les surfaces traitées. Pour les copropriétés du Centre ancien ou de Mont-Mesly, une fréquence de <strong>12 à 18 mois</strong> est généralement recommandée selon l'intensité du passage et la qualité de l'entretien courant (aspirations régulières, tapis d'entrée).</p>`,

      specificChallenges: [
        "Les flux piétons massifs autour des stations de métro ligne 8 (Créteil-Préfecture, Créteil-Université) génèrent un encrassement rapide des moquettes de halls et d'escaliers.",
        "Les marches d'escalier dans les immeubles anciens du Centre ancien présentent des usures localisées nécessitant un traitement ciblé et plusieurs passes.",
...
<p class="mt-4">Un décrassage structuré par <strong>autolaveuse</strong> et <strong>haute pression</strong> redonne clarté aux sols, facilite la circulation et rassure les utilisateurs sur la qualité de l'entretien général de la résidence.</p>`,
      ...
      uniqueDeepDive: `<h3>Coordination préalable et organisation par zones</h3>
...
<p class="mt-4">Les eaux de lavage sont aspirées par l'autolaveuse ou dirigées vers les siphons et caniveaux existants. En l'absence d'évacuation adaptée, nous récupérons les effluents pour <strong>évacuation conforme</strong>. À l'issue du passage, le gestionnaire reçoit un <strong>compte-rendu</strong> précisant les surfaces traitées, les éventuelles anomalies constatées (siphon bouché, fissure, marquage effacé) et les recommandations de fréquence pour maintenir la propreté (généralement <strong>un à deux décrassages complets par an</strong> selon l'intensité d'usage).</p>`,
      ...
      faqAdditions: [
        ...
        {
          question: "Faut-il vider entièrement le parking pour permettre le nettoyage ?",
          answer:
...
<p class="mt-4">Une intervention professionnelle élimine les <strong>salissures incrustées</strong>, ravive les supports et rend l'espace de nouveau utilisable. Les habitants retrouvent un balcon propre où poser une chaise, installer des plantes, prendre un café le matin sans marcher dans la saleté.</p>`,
      ...
      uniqueDeepDive: `<h3>Préparation et protection des ouvertures</h3>
...
<p class="mt-4">Après rinçage, le balcon sèche naturellement en quelques heures selon l'exposition et la météo. Nous recommandons un <strong>balayage régulier</strong> pour éviter l'accumulation de feuilles et de poussières, et un nettoyage léger au moins <strong>deux fois par an</strong> pour maintenir la propreté sans devoir recourir systématiquement à un passage professionnel. Les occupants des quartiers Halage ou Chenevier peuvent ainsi profiter de leur espace extérieur toute l'année sans contrainte.</p>`,
      ...
      faqAdditions: [
        ...
        {
          question: "L'eau de rinçage va-t-elle couler chez mes voisins du dessous ?",
          answer:
        ...
        {
          question: "Les produits utilisés sont-ils compatibles avec mes plantes et mes animaux ?",
          answer:
...
<p class="mt-4">Un traitement professionnel sécurisé élimine les fientes, <strong>désinfecte les surfaces en profondeur</strong> et permet de retrouver un balcon utilisable sans risque pour la santé des occupants.</p>`,
      ...
      uniqueDeepDive: `<h3>Sécurité et confinement du chantier</h3>
...
<p class="mt-4">Après rinçage final et évacuation des eaux, le balcon est aéré pendant plusieurs heures. Un délai de <strong>24 heures</strong> avant réutilisation est généralement recommandé pour garantir un séchage complet et une dissipation totale des produits. Nous informons l'occupant sur les solutions de dissuasion possibles (picots, filets) pour limiter le retour des pigeons, notamment dans les secteurs de la Pointe du Lac ou de Mont-Mesly où la pression aviaire est élevée. Les sacs de déchets contaminés sont évacués de manière sécurisée.</p>`,
      ...
      faqAdditions: [
        {
          question: "Les fientes de pigeons représentent-elles vraiment un risque sanitaire ?",
          answer:
        ...
        {
          question: "Le nettoyage peut-il endommager mon balcon (peinture, béton, garde-corps) ?",
          answer:
...
<p class="mt-4">Un nettoyage professionnel par <strong>injection-extraction</strong> élimine les salissures en profondeur, ravive les couleurs, <strong>neutralise les odeurs</strong> et réduit significativement la présence d'acariens et d'allergènes. Les textiles retrouvent un aspect proche du neuf et redeviennent agréables à utiliser au quotidien.</p>`,
      ...
      uniqueDeepDive: `<h3>Diagnostic textile et pré-traitement ciblé</h3>
...
<p class="mt-4">Le canapé, le tapis ou le matelas sèche naturellement en <strong>4 à 8 heures</strong> selon la ventilation de la pièce et l'épaisseur du textile. Nous conseillons d'aérer le logement, d'éviter de réutiliser immédiatement les surfaces traitées et de maintenir un <strong>aspirateur régulier</strong> pour limiter les réaccumulations. Pour les familles avec enfants ou animaux des quartiers pavillonnaires de Chenevier, un nettoyage annuel ou bisannuel suffit généralement à maintenir un niveau d'hygiène correct.</p>`,
      ...
      faqAdditions: [
        ...
        {
          question: "Combien de temps faut-il attendre avant de réutiliser mon canapé ou mon tapis ?",
          answer:
