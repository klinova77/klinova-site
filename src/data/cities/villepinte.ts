...
const city: City = {
  ...
  customDescription:
    "Klinova assure l'entretien des parties communes, parkings et espaces extérieurs à Villepinte. Entre le Parc des Expositions et les quartiers résidentiels du Vieux Pays, une équipe réactive et des méthodes adaptées aux contraintes locales.",
  ...
  services: [
    {
      ...
      heroDescription:
        "Extraction des salissures piétinées et détachage ciblé sur vos moquettes de bureaux ou d'hôtels, avec séchage maîtrisé pour une remise en service rapide.",
      whyUsBullets: [
      ...
      faqAdditions: [
        {
          question:
            "Les cages d'escalier étroites du quartier Vieux Pays empêchent le passage de matériel volumineux : comment procédez-vous ?",
          answer:
            "<p>Nous utilisons des modules d'injection-extraction compacts, transportables à la main. L'équipe monte le matériel par étapes et protège les marches avant chaque passage. Cette organisation permet d'intervenir même dans les configurations anciennes sans endommager les revêtements adjacents.</p>",
        },
        {
          question:
            "Pour les moquettes des halls d'hôtels situés près de la gare RER Parc des Expositions, quelle méthode offre le meilleur rendu ?",
          answer:
            "<p>L'injection-extraction reste la technique la plus adaptée aux moquettes velours à fort passage. Elle déloge les salissures en profondeur tout en limitant le temps de séchage. Sur des fibres synthétiques denses, nous ajustons la pression pour préserver la texture d'origine.</p>",
        },
        {
          question:
...

    {
      serviceKey: "parkings",
      heroDescription:
        "Décrassage complet des sols de parking avec autolaveuse et traitement dégraissant, gestion stricte des eaux usées et coordination accès pour limiter la gêne aux usagers.",
      whyUsBullets: [
      ...
      faqAdditions: [
        ...
        {
          question:
            "Faut-il adapter le procédé selon que le parking est souterrain ou aérien autour de Paris Nord 2 ?",
          answer:
            "<p>Oui. En souterrain, la ventilation limitée impose un séchage plus long et une gestion stricte des eaux. En aérien, les dépôts de suies et poussières noires sont plus importants, ce qui demande un balayage préalable renforcé et parfois un rinçage haute pression complémentaire.</p>",
        },
        {
          question:
            "Quels créneaux recommandez-vous pour un lavage complet les jours de salon au Parc des Expositions ?",
          answer:
            "<p>Nous privilégions les interventions tôt le matin ou en soirée, avant l'afflux de visiteurs ou après leur départ. La coordination avec le gestionnaire permet de définir un planning qui évite les pics de circulation et garantit un accès sécurisé aux équipes.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      serviceKey: "balcons",
      heroDescription:
        "Une remise en état complète de votre balcon, avec traitement des dépôts incrustés, protection des menuiseries et gestion maîtrisée de l'eau pour éviter toute gêne aux voisins.",
      whyUsBullets: [
...

    {
      ...
      faqAdditions: [
        {
          question:
            "Les balcons proches du Parc du Sausset sont recouverts de fientes : quels risques sanitaires cela représente-t-il ?",
          answer:
        ...
        {
          question:
            "Comment procédez-vous pour l'évacuation des déchets issus du nettoyage de fientes de pigeons ?",
          answer:
            "<p>Les déjections et résidus sont conditionnés dans des sacs étanches dès le ramassage. Ces sacs sont ensuite évacués de manière sécurisée à la fin de l'intervention. Cette méthode évite toute dispersion de particules contaminées dans les parties communes ou sur les balcons voisins.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      faqAdditions: [
        {
          question:
            "Proposez-vous un traitement anti-acariens pour canapé et matelas dans un logement familial à Villepinte ?",
          answer:
            "<p>Le protocole d'extraction en profondeur élimine une grande partie des acariens et allergènes présents dans les fibres. Pour les foyers avec enfants ou personnes sensibles, un traitement complémentaire peut être appliqué après séchage. L'efficacité dépend de la régularité des interventions et de l'aération du logement.</p>",
        },
        {
          question:
            "Comment nettoyez-vous un canapé tissu non déhoussable sans abîmer la mousse intérieure ?",
          answer:
            "<p>La technique d'injection-extraction contrôle précisément la quantité d'eau injectée et la puissance d'aspiration. Le textile est nettoyé en profondeur sans saturer la mousse. Un test préalable sur zone discrète vérifie la tenue des couleurs et la réaction du tissu avant de traiter l'ensemble de l'assise.</p>",
        },
        {
          question:
            "Quel est le temps de séchage après un shampouinage canapé réalisé en appartement au centre de Villepinte ?",
          answer:
            "<p>Le séchage varie entre 4 et 12 heures selon l'épaisseur du textile, la ventilation de la pièce et la saison. En appartement, une bonne aération accélère le processus. Des consignes précises sont données en fin d'intervention pour éviter toute réutilisation prématurée du mobilier.</p>",
        },
        {
          question:
            "Faut-il déplacer les meubles ou préparer le logement avant le nettoyage d'un tapis grand format ?",
          answer:
            "<p>Idéalement, dégager les petits objets posés sur le tapis facilite l'intervention. Pour les meubles lourds, l'équipe peut les déplacer légèrement si l'accès le permet. En pavillon comme en appartement, prévoir un espace de stationnement proche simplifie le déchargement du matériel d'extraction.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      faqAdditions: [
        {
          question:
            "Comment éliminer les mousses incrustées sur une terrasse pavillonnaire du Clos Montceleux ?",
          answer:
            "<p>Les mousses installées dans les joints demandent un brossage mécanique suivi d'un traitement anti-mousse. Sur les dalles gravillonnées fréquentes dans ce quartier, nous adaptons la pression pour ne pas déchausser les graviers. Un produit préventif ralentit la repousse pendant plusieurs mois.</p>",
        },
        {
          question:
            "Quel procédé utilisez-vous pour nettoyer une terrasse en bois composite sans l'abîmer ?",
          answer:
            "<p>Le bois composite ne supporte pas la haute pression classique qui peut délaminer les lames. Nous utilisons une pression réduite combinée à un nettoyant spécifique qui décolle les salissures sans agresser la surface. Le séchage est rapide et le rendu uniforme.</p>",
        },
        {
          question:
            "Faut-il privilégier haute pression ou nettoyage doux sur une terrasse en dalles anciennes ?",
          answer:
            "<p>Cela dépend de l'état des joints et de la porosité des dalles. Sur les terrasses anciennes du Vieux Pays, nous testons d'abord sur une zone discrète. Si les joints sont fragilisés, un nettoyage basse pression avec brossage manuel évite de creuser les interstices.</p>",
        },
        {
          question:
            "À quelle fréquence nettoyer une terrasse exposée aux dépôts noirs en bordure de l'A104 ?",
          answer:
            "<p>Les terrasses proches de l'autoroute accumulent plus vite les suies et particules. Un entretien annuel au printemps suffit généralement, mais les expositions nord ou ombragées peuvent nécessiter un passage supplémentaire à l'automne pour éviter l'installation des mousses.</p>",
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription:
        "Une remise en état complète de votre logement, du sol aux plafonds, avec coordination des accès et respect des délais pour une restitution ou une entrée dans les meilleures conditions.",
      whyUsBullets: [
      ...
      faqAdditions: [
        {
          question:
            "Que comprend un nettoyage fin de chantier pour un appartement livré en ZAC de la Pépinière ?",
          answer:
            "<p>L'intervention couvre l'évacuation des poussières de plâtre et résidus de découpe, le lavage complet des sols, le nettoyage des vitres intérieures et le détartrage des sanitaires neufs. Les traces de peinture ou de colle sur les menuiseries sont traitées manuellement pour ne pas abîmer les surfaces.</p>",
        },
        {
          question:
        ...
        {
          question:
            "Comment évaluez-vous le volume de travail pour un T3 dans le quartier Parc de la Noue ?",
          answer:
            "<p>L'évaluation tient compte de la surface, de l'état général du logement et du type de prestation demandée. Un T3 en sortie locataire standard représente environ 3 à 4 heures de travail. Une fin de chantier ou un logement très encrassé nécessite un temps plus long, précisé après visite ou photos.</p>",
        },
        {
          question:
            "Comment retirez-vous les traces de peinture et colle après rénovation dans un appartement neuf ?",
          answer:
            "<p>Les projections de peinture sur carrelage ou vitres sont grattées à la lame puis nettoyées au produit adapté. Les résidus de colle sur parquet ou menuiseries sont traités avec un solvant doux pour éviter toute dégradation. Chaque support reçoit un traitement spécifique selon sa sensibilité.</p>",
        },
      ],
      ctaOverride: "",
    },
