...
const city: City = {
  ...
  faq: [
    ...
    {
      question:
        "La gestion des accès Vigik ou des clés est-elle bien encadrée ?",
      answer:
  ...
  testimonial: {
    text: "Klinova a remis à niveau les moquettes et le parking d'une copropriété à Vaires-sur-Marne, avec un chantier bien organisé et un retour très positif des résidents.",
    author: "S. Dupont",
  ...
  services: [
    ...
    // =========================
    {
      ...
      faqAdditions: [
        {
          question:
            "Dans quels types de copropriétés intervenez-vous à Vaires-sur-Marne ?",
          answer:
    ...
    // =========================
    {
      ...
      specificChallenges: [
        ...
        "Coulures à éviter systématiquement vers les balcons du dessous, avec <strong>gestion par raclette et bâchage</strong>.",
      ],
    ...
    // =========================
    {
      ...
      specificChallenges: [
        ...
        "Séchage parfois plus lent en hiver dans les logements <strong>peu aérés</strong> ou peu exposés.",
      ],
...

    {
      ...
      uniqueIntro:
        "<p><strong>Vaires-sur-Marne</strong>, commune de Seine-et-Marne d'environ 13 000 habitants, s'étire le long de la Marne et du canal de Chelles. Révélée au monde entier lors des Jeux Olympiques de Paris 2024 — le stade nautique olympique d'Île-de-France y a accueilli les épreuves d'aviron et de canoë-kayak —, la ville conjugue un cadre naturel préservé et un tissu résidentiel à dominante pavillonnaire.</p>\n\n<p class=\"mt-4\">Avec l'île de loisirs de Vaires-Torcy (350 hectares partagés entre les deux communes), le bois de Vaires classé Natura 2000 et la proximité immédiate de la Marne, Vaires bénéficie d'un environnement exceptionnellement vert et aquatique. Cette situation génère une humidité ambiante favorable au développement des mousses et algues sur les surfaces extérieures.</p>\n\n<p class=\"mt-4\">Le parc immobilier vairisien — pavillons traditionnels, maisons des années 20-30, résidences des années 60-70 comme le parc de l'Aulnay, constructions récentes — présente des terrasses aux revêtements variés : <strong>dalles béton</strong>, carrelage, pierre, bois ou composite, chacun nécessitant un protocole de nettoyage adapté.</p>",
      uniqueDeepDive:
        "<h3>Analyse préalable et préparation du site</h3>\n<p>Mobilier de terrasse, jardinières et éléments décoratifs sont déplacés ou protégés. Les façades, menuiseries et clôtures adjacentes sont bâchées. Un balayage préliminaire retire feuilles, aiguilles et débris végétaux accumulés par la proximité des espaces boisés.</p>\n\n<h3>Nettoyage ciblé selon le revêtement</h3>\n<p>Le produit est sélectionné en fonction du <strong>support identifié</strong> : formule douce pour les dalles anciennes, solution alcaline pour béton et carrelage minéral, traitement spécifique pour bois et composite. L'action mécanique par brossage adapté déloge les incrustations biologiques et les dépôts organiques. Le rinçage s'effectue à pression ajustée pour préserver les joints et la texture de surface.</p>\n\n<h3>Application préventive et recommandations</h3>\n<p>Un traitement protecteur est appliqué sur les zones les plus exposées à l'humidité du bord de Marne et des espaces boisés. Les eaux de rinçage sont orientées vers les points d'écoulement existants. Des conseils d'entretien saisonnier sont transmis pour maintenir le résultat face à l'environnement naturel dense de Vaires.</p>",
      specificChallenges: [
        "Pavillons proches de la Marne et du canal de Chelles : <strong>humidité permanente</strong> favorisant la prolifération rapide des mousses et algues vertes.",
        "Quartier des Pêcheurs et ZAC des Pêcheurs : zone exposée aux <strong>risques d'inondation</strong>, terrasses souvent ombragées par la végétation riveraine.",
...

    {
      ...
      specificChallenges: [
        ...
        "Typologies mixtes : <strong>cités cheminotes et bâti ancien</strong> (accès/escaliers) vs résidences récentes (Vigik/digicode).",
      ],

      faqAdditions: [
        {
          question:
            "Intervenez-vous pour un nettoyage d’état des lieux à Vaires-sur-Marne (77360) ?",
          answer:
            "<p>Oui. On suit une logique <strong>“état des lieux”</strong> : cuisine et salle d’eau en priorité, sols ensuite, puis finitions (plinthes, poignées, interrupteurs, bas de portes). Le but est un rendu net et homogène, sans traces au sol ni dépôts visibles en pièces d’eau.</p>",
        },
        {
          question:
            "Pouvez-vous faire un nettoyage après travaux (poussières fines) à Vaires-sur-Marne ?",
          answer:
            "<p>Oui. Après travaux, on intervient en <strong>plusieurs passes</strong> pour éviter que la poussière revienne : surfaces et menuiseries d’abord, sols ensuite, puis contrôle des rebords et angles. Cela donne un résultat propre sans voile, surtout sur stratifié et carrelage.</p>",
        },
        {
          question:
            "Nettoyez-vous les vérandas et grandes baies vitrées des pavillons ?",
          answer:
            "<p>Oui, c’est fréquent sur Vaires (pavillons). On peut intégrer les vitrages accessibles dans la prestation, en adaptant la méthode pour éviter traces et reprises visibles, notamment sur les grandes surfaces vitrées.</p>",
        },
        {
          question:
            "Comment gérez-vous le stationnement près de la gare de Vaires-Torcy ?",
          answer:
            "<p>On anticipe le déchargement et le créneau. Autour de la gare, certains horaires sont plus chargés ; quand c’est possible, on privilégie des créneaux plus calmes et on organise l’intervention pour limiter les allers-retours.</p>",
        },
      ],
