      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Oui. On suit une logique “état des lieux” : cuisine et salle d’eau en priorité, sols ensuite, puis finitions (plinthes, poignées, interrupteurs, bas de portes). Le but est un rendu net et homogène, sans traces au sol ni dépôts visibles en pièces d’eau.</p>",
        },
        {
          question:
            "Pouvez-vous faire un nettoyage après travaux (poussières fines) à Vaires-sur-Marne ?",
          answer:
            "<p>Oui. Après travaux, on intervient en plusieurs passes pour éviter que la poussière revienne : surfaces et menuiseries d’abord, sols ensuite, puis contrôle des rebords et angles. Cela donne un résultat propre sans voile, surtout sur stratifié et carrelage.</p>",
        },
        {
          question:
