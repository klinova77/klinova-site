  ...
  faq: [
    {
      ...
      answer:
        "<p><strong>Réactivité :</strong> oui, selon la nature du besoin. On commence par qualifier la demande (surface, accès, contraintes) puis on propose un créneau compatible avec l’occupation. Sur Rosny-sous-Bois, on anticipe souvent la circulation autour des pôles gares et centres commerciaux pour tenir les délais.</p>",
    },
    {
      question:
        "Les déplacements pour un devis sont-ils facturés si le site est “à l’écart” ou difficile d’accès ?",
      answer:
        "<p><strong>Visite de diagnostic :</strong> elle sert à éviter les erreurs (surface réelle, revêtements, points d’eau, accès sous-sol). Les déplacements pour devis sont en pratique intégrés à notre organisation sur l’Île-de-France : on planifie la visite efficacement, même si l’accès demande un badge ou un RDV gardien.</p>",
    },
    {
      question:
        "Comment gérez-vous le stationnement et les accès quand c’est compliqué (badge, portail, sous-sol étroit) ?",
      answer:
        "<p><strong>Organisation :</strong> on valide en amont le mode d’accès (digicode, badge, portail) et le point de déchargement. Si le stationnement est contraint, on prévoit un passage tôt ou sur un créneau calme, et on limite les allers-retours pour ne pas perturber les résidents.</p>",
    },
    {
      question:
        "Intervenez-vous en urgence après un sinistre ou une fin de chantier ?",
      answer:
        "<p><strong>Remise en état :</strong> oui, avec un cadrage strict. On vérifie d’abord ce qui relève du nettoyage (poussières, traces, dépôts) et les contraintes de sécurité/accès. Ensuite, on cale une opération ciblée avec le bon matériel, puis un contrôle final pour valider le niveau de propreté attendu.</p>",
    },
  ],
  ...
  services: [
    ...
    // =========================
    {
      ...
      faqAdditions: [
        ...
        {
          question:
            "Comment évitez-vous de gêner les résidents quand la cage d’escalier est étroite ?",
          answer:
            "<p>On balise, on travaille par <strong>tranches</strong> (paliers/volées), et on sécurise les passages. Dans certains cas, on cale une intervention tôt ou sur un créneau plus calme. On communique clairement : zones en cours, zones accessibles, et consignes simples pour éviter les traces pendant le séchage.</p>",
        },
      ],
      ctaOverride: "",
    },
    ...
    // =========================
    {
      ...
      faqAdditions: [
        ...
        {
          question:
            "Les vieilles taches d’huile au pied des places, c’est rattrapable à 100% ?",
          answer:
            "<p>On vise un <strong>nettoyage maximal</strong>, mais certaines taches anciennes ont pénétré le béton ou la résine. Le dégraissage et la haute pression contrôlée améliorent fortement l’aspect et réduisent le gras en surface. On annonce ce qui est réaliste après la visite, zone par zone.</p>",
        },
        {
          question:
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Non si la pression est <strong>contrôlée</strong> et si le produit est adapté. On privilégie le brossage et le rinçage maîtrisé plutôt qu’une haute pression agressive. Le but est de décoller la salissure sans “creuser” le joint, et de laisser le support propre et stable.</p>",
        },
        {
          question:
            "Mon voisin du dessous craint les coulures : comment vous évitez ça en façade ?",
          answer:
            "<p>On travaille avec une <strong>gestion d’eau</strong> stricte : protection, tirage vers l’évacuation, raclettes et reprise des zones sensibles. Si besoin, on limite les volumes d’eau et on procède par petites zones. L’objectif est un nettoyage efficace sans transformer le balcon en gouttière.</p>",
        },
        {
          question:
            "J’ai des plantes et un petit animal : les produits posent problème ?",
          answer:
            "<p>On adapte. On protège les pots, on évite les projections, et on choisit un nettoyant compatible avec l’usage domestique. On rince correctement et on vous donne des consignes simples. L’idée n’est pas de “parfumer” : c’est de <strong>retirer</strong> les salissures et de rendre le balcon sain.</p>",
        },
        {
          question:
            "Après l’intervention, quand peut-on remettre un tapis ou s’installer dehors ?",
          answer:
            "<p>Dès que le support est <strong>sec</strong>. En général, une bonne aération et une extraction d’eau efficace permettent de réutiliser le balcon dans la journée, selon la météo et le revêtement. On vous indique sur place les zones qui sèchent plus lentement (joints, angles).</p>",
        },
      ],
      ctaOverride: "",
    },
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Le principal risque vient des <strong>poussières</strong> : en grattant à sec, on disperse des particules potentiellement contaminées. Sans masque adapté, lunettes et confinement, on en met partout (balcon, intérieur, façade). Un pro sécurise d’abord, humidifie, retire et désinfecte avec méthode.</p>",
        },
        {
          question:
            "Après désinfection, est-ce que le balcon est “sûr” pour un enfant ou un animal ?",
          answer:
            "<p>Oui, une fois le <strong>temps de contact</strong> respecté, le rinçage fait et le support sec. On vous indique le délai de réutilisation et les précautions simples (aération, éviter de marcher pieds nus tant que c’est humide). L’objectif est un retour à un usage normal, sans résidus gênants.</p>",
        },
        {
          question: "Est-ce que ça peut abîmer la peinture ou le garde-corps ?",
          answer:
            "<p>L’accumulation de fientes abîme souvent plus que le nettoyage. On adapte la méthode : pression <strong>modérée</strong>, brossage contrôlé, produit compatible avec le support. Sur une peinture fragile, on teste une zone et on privilégie le retrait progressif plutôt qu’une action agressive.</p>",
        },
        {
          question:
            "Que faites-vous des nids et des déchets retirés pendant la décontamination ?",
          answer:
            "<p>Tout est <strong>conditionné</strong> en sacs étanches pour éviter la dispersion pendant la manutention. On retire l’ensemble du balcon (fientes, nids, débris), puis on termine par la désinfection et un rinçage propre. Vous récupérez un espace assaini, sans résidus laissés sur place.</p>",
        },
      ],
      ctaOverride: "",
    },
    ...
    // =========================
    {
      ...
      faqAdditions: [
        ...
        {
          question:
            "Sur une tache d’urine ancienne sur canapé, est-ce que l’odeur peut disparaître ?",
          answer:
            "<p>On traite d’abord la cause : tache <strong>organique</strong>. Pré-traitement enzymatique, puis extraction en profondeur. Le résultat dépend de l’ancienneté et de la pénétration dans la mousse, mais on améliore très souvent l’odeur et l’aspect. On vous dit sur place ce qui est réaliste après test.</p>",
        },
        {
          question:
            "Après le passage, je peux m’asseoir tout de suite sur le canapé ou remettre le tapis ?",
          answer:
            "<p>L’objectif est un séchage <strong>le jour même</strong> grâce à l’extraction maximale, mais il faut attendre que le support soit sec au toucher. On vous indique les zones qui sèchent plus lentement (coussins épais, coutures). Une bonne aération accélère nettement la reprise d’usage.</p>",
        },
        {
          question:
            "Qu’est-ce que je dois préparer avant votre arrivée (meubles, accès, espace) ?",
          answer:
            "<p>Très simple : libérer l’accès au textile, retirer les objets fragiles autour, et prévoir un petit <strong>espace de travail</strong> pour poser le matériel. Dans un appartement, on s’adapte : on limite les déplacements, on protège si besoin, et on vous guide sur les gestes utiles pour que l’intervention soit fluide.</p>",
        },
      ],
      ctaOverride: "",
    },
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Oui. On suit un déroulé orienté contrôle d’état des lieux : cuisine et salle d’eau (dégraissage + calcaire), sols, puis finitions visibles (plinthes, interrupteurs, portes). Dans les résidences du secteur Bois-Perrier, l’accès (Vigik/digicode/gardien) est confirmé avant l’intervention.</p>",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "<p>On privilégie un créneau et un point de déchargement réalistes, et on organise l’ordre des tâches pour limiter les allers-retours. Autour de Rosny 2, éviter les pics du week-end et des heures d’affluence améliore nettement la fluidité de l’intervention.</p>",
        },
        {
          question:
