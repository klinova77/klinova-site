...
const city: City = {
  ...
  citySpecificChallenges: [
    ...
    "Végétation de la Forêt de Notre-Dame produisant <strong>pollens massifs au printemps</strong> et verdissement rapide des toitures et murets par mousses favorisées par l'ombre et l'humidité forestière",
    "Étalement urbain important créant <strong>des distances d'intervention longues</strong> entre le Bouquet (Nord) et la Grenouillère (Sud), avec la Francilienne formant une barrière physique",
  ...
  services: [
    ...
    // =========================
    {
      ...
      specificChallenges: [
        ...
        "Poussière commerciale de la zone Carrefour : Les résidences de la Grenouillère et des Pince-Vents proches du pôle commercial subissent un brassage d'air générant <strong>des dépôts de poussière supplémentaires</strong> qui s'agglomèrent avec l'humidité.",
      ],
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Oui. On cible ce qui compte le plus à l’état des lieux : cuisine et salle d’eau (dégraissage + calcaire), sols, poussières sur surfaces, puis finitions visibles (poignées, interrupteurs, plinthes). Sur le secteur Gare, l’accès (badge/gardien) et le stationnement sont confirmés avant l’intervention.</p>",
        },
        {
          question:
            "Faites-vous le nettoyage après travaux (poussières de plâtre, peinture, coupes) ?",
          answer:
            "<p>Oui. Après travaux, on travaille en plusieurs passes pour éviter que la poussière fine ne se redépose : dépoussiérage des surfaces et menuiseries, puis sols, puis contrôle final des rebords, prises, plinthes et zones de passage. C’est ce qui donne un rendu vraiment “fini”.</p>",
        },
        {
          question:
            "Est-ce que vous faites aussi les vitres (baies, Velux, vérandas) dans les maisons ?",
          answer:
            "<p>Oui, sur les vitrages accessibles. À Pontault-Combault, beaucoup de pavillons ont baies vitrées, Velux ou véranda : on vise un rendu sans traces et on ajuste la méthode selon l’exposition (proximité RN4/A104 = dépôts plus marqués).</p>",
        },
        {
          question:
            "Comment gérez-vous la logistique quand le secteur Carrefour ou la gare est saturé ?",
          answer:
            "<p>On choisit un créneau pertinent, on prévoit un point de déchargement réaliste et on optimise l’ordre des tâches pour limiter les allers-retours. C’est souvent la différence entre une intervention “qui traîne” et une intervention efficace.</p>",
        },
      ],
