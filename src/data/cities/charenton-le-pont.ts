      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Oui, en priorité lorsque la date est fixée. Nous validons les accès (interphone, Vigik, clés) et la logistique en amont, car le stationnement est souvent le point critique. Cela permet de sécuriser l’intervention et d’éviter les retards le jour de la restitution.</p>",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "<p>Elle vise les zones qui génèrent le plus de remarques : surfaces de cuisine accessibles avec dégraissage ciblé, et salle de bain/sanitaires avec détartrage adapté. Nous complétons par les plinthes, points de contact et finitions visuelles pour un rendu cohérent dans tout le logement.</p>",
        },
        {
          question:
