      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Oui, en priorité lorsque la date est fixée. Nous validons <strong>les accès (interphone, Vigik, clés)</strong> et la logistique en amont, car le stationnement est souvent le point critique. Cela permet de sécuriser l’intervention et d’éviter les retards le jour de la restitution.</p>",
        },
        {
          question:
            "Comment nettoyez-vous un parquet ancien sans l’abîmer dans un appartement du Centre-Ville ?",
          answer:
            "<p>Nous commençons par identifier le type de parquet et son état. La méthode privilégie un nettoyage maîtrisé, avec une humidité limitée et des produits compatibles, pour éviter voile, gonflement ou traces. L’objectif est un rendu propre et régulier, sans agresser la finition.</p>",
        },
        {
          question:
            "Que comprend exactement une remise en état pour une cuisine et une salle de bain avant remise des clés ?",
          answer:
            "<p>Elle vise les zones qui génèrent le plus de remarques : surfaces de cuisine accessibles avec <strong>dégraissage ciblé</strong>, et salle de bain/sanitaires avec détartrage adapté. Nous complétons par les plinthes, points de contact et finitions visuelles pour un rendu cohérent dans tout le logement.</p>",
        },
        {
          question:
            "Est-ce qu’une visite technique est nécessaire avant d’intervenir à Charenton-le-Pont ?",
          answer:
            "<p>Selon l’état réel du logement, une visite technique peut être nécessaire. Elle permet d’aligner le périmètre (pièces, niveau d’encrassement, vitres, contraintes d’accès) et de choisir les bonnes méthodes, surtout dans les immeubles anciens ou les résidences avec règles de copropriété.</p>",
        },
      ],
