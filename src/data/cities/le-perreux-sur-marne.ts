...
const city: City = {
  ...
  citySpecificChallenges: [
    "<strong>Zones bleues étendues en centre-ville</strong> : stationnement à sécuriser en amont, surtout près de la gare.",
    "<strong>Digicodes et badges fréquents</strong> : accès à cadrer pour éviter les blocages le jour J.",
    "<strong>Sous-sols parfois profonds</strong> : traitement par zones avec attention aux rampes et aux angles.",
    "<strong>Proximité de la Marne</strong> : humidité et dépôts verts à intégrer dans le choix des méthodes.",
  ],
  ...
  services: [
    ...
    // =========================
    {
      ...
      specificChallenges: [
        "Dans le Centre-Ville, les <strong>tapis d’escalier se ternissent vite</strong> sur les marches centrales.",
        "Les <strong>escaliers étroits</strong> imposent de limiter l’encombrement et de protéger les bas de murs.",
        "Sur la limite Val de Fontenay, le séchage doit rester compatible avec l’activité.",
        "Les <strong>taches grasses et odeurs persistantes</strong> demandent un pré-traitement propre, pas une solution “miracle”.",
      ],
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>On choisit selon l’objectif : profondeur vs rapidité. Si l’encrassement est incrusté (taches, odeurs), l’injection-extraction est pertinente. Si la priorité est la remise en service rapide, une méthode basse humidité peut suffire, avec un rendu visuel amélioré et un séchage plus court.</p>",
        },
        {
          question:
            "Autour de la gare Nogent–Le Perreux (côté Le Perreux), comment traitez-vous les zones de passage qui ternissent vite ?",
          answer:
            "<p>On renforce le traitement sur les bandes de trafic : pré-traitement, passes supplémentaires, puis extraction soignée. Sur ces zones, l’objectif est de réduire les traces grasses, raviver l’aspect et limiter les odeurs. On explique aussi ce qui relève d’une usure des fibres, surtout sur moquettes anciennes.</p>",
        },
        {
          question:
    ...
    // =========================
    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>On prépare le chantier : protections, choix du point de rinçage, volumes d’eau limités. L’objectif est de maîtriser l’écoulement et d’éviter les coulures chez les voisins du dessous. Quand l’accès est plus contraint, on privilégie des séquences courtes, avec un nettoyage plus “piloté” que massivement arrosé.</p>",
        },
      ],
      ctaOverride: "",
    },
    ...
    // =========================
    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>On cale le point de dépose et l’itinéraire avant de venir, pour éviter des allers-retours inutiles. Le matériel est organisé “compact”, et on protège les zones de passage dans le logement. Cette préparation permet de garder un déroulé propre et d’avancer sans gêner l’occupant plus que nécessaire.</p>",
        },
        {
          question:
          ...
          answer:
            "<p>On demande quelques infos simples (nature de la tache, ancienneté, accès), puis on propose un créneau réaliste. Sur les secteurs où le stationnement est contraint, on anticipe la logistique pour arriver prêt à travailler. L’objectif est de traiter vite, mais correctement : pré-traitement, extraction et séchage expliqué.</p>",
        },
        {
          question:
...

    {
      ...
      specificChallenges: [
        ...
        "Terrasses des propriétés du Parc : <strong>accès parfois contraints</strong> dans ce lotissement privé aux allées étroites.",
        "Dalles béton des pavillons années 60-70 des Joncs-Marins : <strong>porosité variable</strong> et joints fragilisés par le temps.",
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Oui. Nous intervenons régulièrement avant restitution : nettoyage complet, focus cuisine/salle d’eau, sols et finitions visibles. Le périmètre est défini en amont (accès, étage, vitrages accessibles) pour éviter les surprises le jour J.</p>",
        },
        {
          question:
            "Pouvez-vous intervenir dans une maison avec parquet et pièces vitrées (véranda, bow-window) ?",
          answer:
            "<p>Oui. Nous adaptons les gestes et l’humidité pour préserver le parquet et obtenir un rendu propre sur les vitrages accessibles, encadrements et rebords. C’est souvent ce qui “fait” la différence dans les villas et demeures de caractère.</p>",
        },
        {
          question:
            "Proposez-vous un nettoyage après travaux au Perreux-sur-Marne ?",
          answer:
            "<p>Oui. Après travaux, l’enjeu principal est la poussière fine : nous structurons le dépoussiérage, traitons les surfaces et finissons par les détails. Le but est un logement utilisable rapidement, sans traces résiduelles visibles.</p>",
        },
        {
          question:
            "Le stationnement est-il un problème pour une intervention ?",
          answer:
            "<p>Le centre-ville peut être plus contraint. Nous anticipons le créneau et l’accès (badge, gardien), et nous privilégions une organisation simple pour limiter la gêne, surtout autour de la mairie et des axes les plus fréquentés.</p>",
        },
      ],
