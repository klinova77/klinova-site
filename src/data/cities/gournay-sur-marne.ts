...
const city: City = {
  ...
  faq: [
    ...
    {
      question:
        "Comment gérez-vous les contraintes de stationnement en zone pavillonnaire ?",
      answer:
  ...
  services: [
    ...
    // =========================
    {
      ...
      faqAdditions: [
        ...
        {
          question:
            "Intervenez-vous dans tous types de bâtiments à Gournay-sur-Marne ?",
          answer:
        ...
        {
          question:
            "Comment limitez-vous la gêne pour les résidents pendant l'intervention ?",
          answer:
    ...
    // =========================
    {
      ...
      faqAdditions: [
        {
          question:
            "Pourquoi les parkings de Gournay-sur-Marne s'encrassent-ils rapidement ?",
          answer:
    ...
    // =========================
    {
      ...
      faqAdditions: [
        {
          question:
            "Le nettoyage peut-il abîmer le carrelage ou les joints de mon balcon ?",
          answer:
        ...
        {
          question:
            "Comment évitez-vous que l'eau de lavage coule chez les voisins du dessous ?",
          answer:
        ...
        {
          question:
            "Les produits utilisés présentent-ils un risque pour les plantes ou les animaux ?",
          answer:
        ...
        {
          question:
            "Combien de temps faut-il attendre avant de réutiliser le balcon ?",
          answer:
    ...
    // =========================
    {
      ...
      faqAdditions: [
        {
          question:
            "Puis-je nettoyer moi-même les fientes de pigeons sur mon balcon ?",
          answer:
        ...
        {
          question:
            "Les produits de désinfection sont-ils sans danger après séchage ?",
          answer:
    ...
    // =========================
    {
      ...
      faqAdditions: [
        {
          question:
            "Le nettoyage permet-il d'éliminer les acariens et allergènes ?",
          answer:
        ...
        {
          question:
            "Pouvez-vous traiter les odeurs d'urine ou les taches anciennes ?",
          answer:
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Nous proposons une remise en état du logement structurée : sols et plinthes, cuisine (zones accessibles), salle de bain et sanitaires, points de contact et vitres accessibles. Le périmètre est défini avant l’intervention, ce qui permet d’aller à l’essentiel pour un rendu net et cohérent le jour de la remise.</p>",
        },
        {
          question:
            "Traitez-vous les vérandas et grandes baies vitrées que l’on trouve souvent à Gournay ?",
          answer:
            "<p>Oui, sur les vitres accessibles. Nous intégrons un passage soigné sur les vitrages et les rebords, avec des produits adaptés pour limiter les traces. Pour les hauteurs ou accès spécifiques, on le précise au moment du cadrage.</p>",
        },
        {
          question:
            "Intervenez-vous sur un appartement en résidence en centre-ville avant état des lieux ?",
          answer:
            "<p>Oui. Nous calons l’accès (clé, badge/digicode) et planifions l’intervention en tenant compte du stationnement autour de la Place de la Libération. L’objectif est un <strong>nettoyage avant état des lieux</strong> propre et homogène, avec contrôle visuel final.</p>",
        },
        {
          question:
            "Comment évitez-vous l’humidité résiduelle après intervention, surtout près de la Marne ?",
          answer:
            "<p>Nous privilégions des techniques qui limitent l’eau sur les sols et recommandons une aération en fin d’intervention. Cela aide à retrouver un logement confortable rapidement, notamment quand l’air est plus humide sur les Bords de Marne.</p>",
        },
      ],
