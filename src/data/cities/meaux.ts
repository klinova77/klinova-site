...
const city: City = {
  ...
  citySpecificChallenges: [
    ...
    "<strong>Humidité fluviale de la Marne</strong> favorisant verdissement rapide des soubassements, murets et zones ombragées par mousses et micro-algues, particulièrement sur les berges et dans les quartiers sud près du Parc du Pâtis",
    "<strong>Forte concentration de pigeons</strong> dans le centre ancien (secteur cathédrale et marché) entraînant salissures importantes sur balcons, rebords de fenêtres et façades du bâti historique",
    "<strong>Contraintes d'accès du centre médiéval</strong> avec rues très étroites, parfois piétonnes ou à accès limité, imposant portage de matériel et organisation fine dans le Site Patrimonial Remarquable",
  ],
