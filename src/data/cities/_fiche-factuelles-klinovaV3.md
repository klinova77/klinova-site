FICHE DE COLLECTE DE MATIÈRE – VILLES (KLINOVA) — V3
...
3.1 Typologies (cocher) : anciens / petits collectifs / grands ensembles / pavillons / résidences récentes / ZAC (✅/⚠️)
3.2 Contraintes fréquentes : halls ouverts / escaliers étroits / sous-sols / digicodes-badges / stationnement difficile (✅/⚠️)
...
SECTION 7 — BANQUE D’ANCRAGES (ANTI-BOILERPLATE)
Fournir 12–18 ancrages vérifiés (✅) si possible.
Format par ancrage :
ANCRAGE # :
- Libellé court :
...
Interdit : adjectifs, tourisme, confusion station limite.
