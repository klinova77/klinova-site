...
const city: City = {
  ...
  testimonial: {
    text: "Notre copropriété près du Parc Carette avait des problèmes récurrents de taches sur les moquettes des couloirs. L'intervention de Klinova a permis de ravoir des zones qu'on pensait irrécupérables. L'équipe a été discrète et très pro.",
    author: "Mme Vasseur",
  ...
  services: [
    ...
    // =========================
    {
      ...
      faqAdditions: [
        ...
        {
          question: "Installez-vous des pics anti-pigeons après le nettoyage ?",
          answer:
...

    {
      ...
      faqAdditions: [
        ...
        {
          question: "Dois-je préparer quelque chose avant votre arrivée ?",
          answer:
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Quand il y a un enjeu de remise des clés : logement vidé, changement d’occupant, vente/location, ou surfaces marquées (sols, cuisine, salle de bain). La remise en état du logement est plus complète et suit un ordre d’intervention précis, alors qu’un nettoyage standard reste plus léger.</p>",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "<p>Nous adaptons la méthode au parquet : pas d’excès d’eau, pas d’abrasion, et des produits compatibles. L’objectif est d’obtenir une propreté nette sans voile ni gonflement du bois, avec une aération conseillée en fin d’intervention.</p>",
        },
        {
          question:
