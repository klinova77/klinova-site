      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Le matériel d'injection-extraction se compose d'éléments modulables, transportables à la main dans les cages d'escalier sans ascenseur. Les flexibles et la cuve se montent sur place. Les <strong>protections de sol</strong> sont posées avant chaque passage pour éviter les traces sur les marches.</p>",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "<p>Le créneau d'intervention est fixé en amont avec le gardien ou le gestionnaire pour identifier un <strong>point de dépose temporaire</strong>. Le matériel est déchargé rapidement, puis le véhicule stationné sur un emplacement autorisé à proximité. Cette organisation évite les allers-retours et limite la gêne.</p>",
        },
      ],
      ctaOverride: "",
    },
