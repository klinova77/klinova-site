...
const city: City = {
  ...
  hubIntro:
    "<p>Vincennes réunit un centre-ville très fréquenté et un parc immobilier exigeant, mêlant immeubles haussmanniens et résidences récentes. Klinova intervient en partenariat étroit avec les syndics et gestionnaires pour assurer la maintenance courante et les décrassages programmés, en tenant compte des contraintes d'accès et du standing attendu.</p>\n<p>Nos équipes connaissent les spécificités locales : <strong>rues étroites, stationnement limité</strong>, halls de prestige à préserver. Nous déployons un matériel compact et des protocoles adaptés à chaque site, avec un reporting systématique pour garantir le suivi et la traçabilité des interventions.</p>\n<ul>\n  <li><strong>Planification fine</strong> : coordination avec les résidents et rotation des véhicules pour limiter la gêne dans les rues étroites du centre-ville et autour des pôles de transport.</li>\n  <li><strong>Matériel adapté</strong> : équipements compacts et techniques d'injection-extraction ou haute pression modulables selon les surfaces (moquettes, carrelages, béton).</li>\n  <li><strong>Traçabilité complète</strong> : compte-rendu d'intervention remis au syndic avec photos avant/après, produits utilisés et recommandations de fréquence pour les prochaines opérations.</li>\n</ul>",

  citySpecificChallenges: [
    "Encrassement rapide des halls et circulations communes en raison du <strong>flux piéton intense</strong> lié au RER A et au métro ligne 1",
    "Dépôts végétaux, pollens et traces vertes sur balcons et garde-corps dus à la proximité immédiate du Bois de Vincennes",
    "<strong>Stationnement très tendu</strong> et rues étroites dans le centre-ville imposant du matériel compact et une planification rigoureuse",
    "Exigence esthétique élevée dans les immeubles anciens de standing nécessitant des <strong>protocoles soignés</strong> et un séchage maîtrisé",
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "<p><strong>Nous utilisons des véhicules compacts</strong> et planifions chaque intervention en repérant les emplacements de livraison ou les zones de dépose minute. Pour les opérations longues (parking souterrain, décrassage complet de halls), nous coordonnons avec le syndic pour obtenir une autorisation temporaire ou décaler l'intervention en heures creuses.</p>",
    },
    {
      question:
        "Proposez-vous un suivi régulier pour les copropriétés exigeantes ?",
      answer:
        "<p><strong>Oui, nous établissons un calendrier annuel ou semestriel</strong> avec le conseil syndical. Chaque passage fait l'objet d'un compte-rendu avec photos et observations (usure, taches récurrentes, recommandations). Ce suivi permet d'anticiper les dégradations et de maintenir un niveau de propreté constant, apprécié dans les immeubles de standing vincennois.</p>",
    },
  ],
  ...
  services: [
    ...
    // =========================
    {
      ...
      specificChallenges: [
        ...
        "Moquettes anciennes dans les immeubles de standing : Les fibres délicates des résidences haussmanniennes exigent une <strong>pression modérée</strong> et un réglage précis pour éviter l'écrasement ou la décoloration.",
        "Humidité résiduelle dans les rez-de-chaussée : Les halls ouverts sur rue ou les <strong>sous-sols mal ventilés</strong> ralentissent le séchage, imposant une extraction renforcée et des conseils d'aération adaptés.",
      ],
    ...
    // =========================
    {
      ...
      uniqueIntro:
        "<p>Les parkings souterrains de Vincennes, qu'ils desservent les résidences du centre-ville ou les copropriétés proches du Bois, accumulent rapidement une couche de <strong>poussière noire</strong> mêlée à des traces d'hydrocarbures. La proximité du RER A et du métro ligne 1 génère un trafic automobile soutenu : les véhicules entrent et sortent plusieurs fois par jour, déposant particules fines et résidus de freinage sur les sols en béton ou en résine.</p>\n<p class=\"mt-4\">Au fil des mois, les marquages au sol se ternissent, les rampes deviennent glissantes, les angles et pieds de murs noircissent. Les copropriétaires remarquent cet encrassement, le conseil syndical reçoit des demandes d'intervention, mais la coordination d'un décrassage complet semble complexe : faut-il vider le parking ? Comment gérer l'eau de lavage ? Quelle organisation pour limiter la gêne ?</p>\n<p class=\"mt-4\">Un décrassage structuré et planifié répond à ces préoccupations. Il restaure la propreté des sols, améliore la visibilité des places et des zones de circulation, et renforce la <strong>sécurité</strong> en réduisant les risques de glissade. L'intervention devient un acte de gestion préventive, valorisant le patrimoine immobilier et le confort d'usage.</p>",
      ...
      specificChallenges: [
        "Encrassement renforcé par le trafic du RER A et du métro ligne 1 : Les <strong>particules fines et résidus de freinage</strong> s'accumulent rapidement dans les parkings proches des pôles de transport, nécessitant un décrassage plus fréquent.",
    ...
    // =========================
    {
      ...
      specificChallenges: [
        ...
        "Joints de carrelage très encrassés : Les immeubles anciens du centre-ville présentent souvent des <strong>joints poreux</strong> qui retiennent particules fines et humidité, exigeant un brossage manuel et un rinçage multiple pour éliminer les résidus incrustés.",
    ...
    // =========================
    {
      ...
      specificChallenges: [
        ...
        "Séchage ralenti dans les logements peu ventilés : Les <strong>appartements sans balcon</strong> ou exposés au nord du centre-ville imposent une extraction renforcée et des conseils d'aération adaptés pour garantir un séchage complet sous 8 heures.",
      ],
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Le séchage complet intervient sous 4 à 8 heures selon la ventilation. Vous pouvez marcher légèrement sur le tapis dès 2h, mais évitez de vous installer sur le canapé avant séchage total. Aérez la pièce, orientez un ventilateur si possible. Pour un usage le soir même, planifiez l'intervention le matin.</p>",
        },
        {
...

    {
      ...
      specificChallenges: [
        ...
        "Flux RER A / métro 1 : <strong>poussières de voirie</strong> et traces sur vitrages bas, surtout près des grands axes.",
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Oui. On suit une logique “état des lieux” : <strong>cuisine et salle d’eau en priorité</strong>, sols ensuite, puis finitions (plinthes, interrupteurs, poignées, rebords). L’objectif est un rendu homogène, sans traces au sol ni dépôts visibles sur les points sensibles.</p>",
        },
        {
          question:
            "Pouvez-vous intervenir après des travaux (peinture, ponçage léger) ?",
          answer:
            "<p>Oui. Après travaux, on procède en passes pour éviter le <strong>retour de poussière</strong> : surfaces et menuiseries d’abord, sols ensuite, puis contrôle des rebords et angles. Cela limite le “voile” sur les sols et les reprises visibles.</p>",
        },
        {
          question:
