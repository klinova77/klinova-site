...
const city: City = {
  ...
  citySpecificChallenges: [
    "Hygrométrie élevée liée à la boucle de la Marne : <strong>prolifération rapide de dépôts verts</strong> sur les expositions Nord/Est",
    "Pollution végétale intense : <strong>pollens gluants des tilleuls</strong> au printemps et saturation des évacuations par les feuilles en automne",
    "Accessibilité contrainte (Presqu'île) : nécessité d'une logistique anticipant <strong>les flux pendulaires des ponts</strong>",
    "Fragilité du bâti ancien : interdiction de la haute pression agressive sur <strong>les joints de meulière</strong> et les parements historiques",
  ],
  ...
  services: [
    ...
    // =========================
    {
      ...
      specificChallenges: [
        ...
        "Séchage en milieu humide : La proximité de la Marne impose <strong>une puissance d'extraction supérieure</strong> pour garantir un sol sec le soir même.",
        "Taches tanniques : Les feuilles mortes automnales laissent des marques brunes tenaces que seul <strong>un traitement acide ciblé</strong> peut effacer.",
      ],
    ...
    // =========================
    {
      ...
      uniqueIntro:
        "<p>Un parking mal entretenu est le premier signal de dévalorisation d'un immeuble. À Saint-Maur, les parkings souffrent de deux maux : l'apport massif de <strong>débris végétaux</strong> (feuilles, bogues) collés aux pneus, et le développement de <strong>mousses glissantes</strong> dû à l'humidité des nappes phréatiques proches. Ce n'est pas juste sale, c'est dangereux (risque de chute) et anxiogène.</p>\n<p class=\"mt-4\">Oubliez le simple coup de balai du gardien qui ne fait que déplacer la poussière. Klinova déploie de véritables autolaveuses industrielles. Nous décrassons, nous dégraissons les taches d'huile moteur, et nous aspirons les boues liquides.</p>\n<p class=\"mt-4\">L'impact est immédiat : un sol clair, des marquages visibles, une atmosphère saine et une plus-value maintenue pour chaque appartement. C'est une intervention technique qui redonne le sourire aux copropriétaires lors de l'assemblée générale.</p>",
