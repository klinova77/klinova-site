...
const city: City = {
  ...
  customDescription:
    "Klinova intervient à Noisiel pour l'entretien des parties communes, parkings souterrains et espaces extérieurs. Une organisation adaptée aux contraintes du Luzard comme aux ruelles de la Cité Menier.",
  ...
  services: [
    {
      ...
      heroDescription:
        "Extraction des salissures incrustées dans les fibres textiles, avec séchage contrôlé pour une remise en service rapide des espaces traités.",
      whyUsBullets: [
    ...
    },
    {
      serviceKey: "parkings",
      heroDescription:
        "Décrassage complet des sols de parkings souterrains et aériens, avec gestion stricte des eaux de lavage et coordination d'accès pour limiter la gêne aux résidents.",
      whyUsBullets: [
      ...
      faqAdditions: [
        {
          question:
            "Comment gérez-vous les eaux de lavage dans les parkings souterrains du Luzard ?",
          answer:
            "<p><strong>Les eaux chargées</strong> sont systématiquement dirigées vers les regards et rigoles existants. Nous vérifions au préalable que les évacuations ne sont pas obstruées. Aucun rejet n'est effectué vers la voirie ou les espaces verts. Cette gestion respecte les contraintes des sous-sols de la Ville Nouvelle.</p>",
        },
        {
          question:
            "À quelle fréquence recommandez-vous un décrassage pour les parkings collectifs du secteur Cours des Roches ?",
          answer:
            "<p>Pour des parkings à rotation moyenne, un passage semestriel maintient un niveau de propreté correct. Si le trafic est plus intense ou si des taches d'huile apparaissent régulièrement, un rythme trimestriel limite l'incrustation des salissures et facilite chaque intervention suivante.</p>",
        },
        {
          question:
            "Quelle méthode privilégiez-vous pour un parking aérien fréquenté comme celui du Super U ?",
          answer:
            "<p>Sur enrobé ou béton lissé en extérieur, le lavage haute pression avec dégraissant biodégradable convient bien. L'intervention se cale en dehors des heures d'affluence commerciale. Le balisage oriente les clients vers les zones déjà traitées et sèches.</p>",
        },
        {
          question:
            "Comment traitez-vous les taches d'huile anciennes incrustées sur les rampes d'accès ?",
          answer:
            "<p>Un dégraissant concentré est appliqué en <strong>pré-traitement sur les zones marquées</strong>. Après un temps de contact, le passage de l'autolaveuse ou du nettoyeur haute pression déloge les résidus. Certaines taches très anciennes s'atténuent sans disparaître totalement si le béton est poreux.</p>",
        },
      ],
      ctaOverride: "",
    },
    {
      serviceKey: "balcons",
      heroDescription:
        "Une remise en état complète de votre balcon ou loggia, avec traitement des dépôts incrustés, protection des menuiseries et gestion anti-coulures pour un espace extérieur à nouveau utilisable.",
      whyUsBullets: [
      ...
      faqAdditions: [
        {
          question:
            "Quel produit et quelle méthode utilisez-vous pour le carrelage et les joints des balcons Place Émile-Menier ?",
          answer:
            "<p>Nous sélectionnons un détergent adapté au type de carrelage, souvent légèrement alcalin pour dissoudre les dépôts urbains sans attaquer les joints. Le brossage est manuel sur les joints fragiles, mécanique sur les surfaces résistantes. Le rinçage reste contrôlé pour éviter toute infiltration.</p>",
        },
        {
          question:
            "Comment éliminer les dépôts verts et mousses sur les loggias proches du Parc de Noisiel sans abîmer le support ?",
          answer:
            "<p>Ces dépôts organiques nécessitent un traitement spécifique : application d'un produit anti-mousse, temps de pose adapté, puis brossage doux. Sur béton brut, nous évitons la haute pression directe qui peut creuser la surface. Le rinçage est effectué à pression modérée.</p>",
        },
        {
          question:
            "Comment gérez-vous l'évacuation d'eau et les coulures lors d'un nettoyage de loggia sur dalle au Luzard ?",
          answer:
            "<p>Avant intervention, nous vérifions les évacuations existantes et installons des protections en périphérie. L'eau est dirigée vers les points d'écoulement, et nous utilisons des quantités maîtrisées pour limiter les projections. Les voisins du dessous sont prévenus si nécessaire.</p>",
        },
        {
          question:
            "Quelles méthodes non haute-pression recommandez-vous pour une loggia fermée afin d'éviter les dégâts ?",
          answer:
            "<p>Sur loggia fermée, nous privilégions le brossage manuel avec produit adapté, suivi d'un rinçage à basse pression ou à l'eau claire. Cette approche évite les projections sur les vitrages et menuiseries, tout en garantissant un résultat propre sur le sol et les garde-corps.</p>",
        },
      ],
      ctaOverride: "",
    },
    {
      ...
      faqAdditions: [
        {
          question:
            "Les corniches proches du Parc de Noisiel sont couvertes de fientes : quels risques sanitaires immédiats faut-il craindre ?",
          answer:
        ...
        {
          question:
            "Quel protocole EPI et quel désinfectant utilisez-vous pour fientes séchées sur balcon béton au Luzard ?",
          answer:
            "<p>L'équipe intervient avec masque FFP2, combinaison jetable, gants et lunettes de protection. Les fientes séchées sont humidifiées avant retrait pour neutraliser les poussières. Un désinfectant virucide et bactéricide homologué est ensuite appliqué sur le béton avec un temps de contact respecté avant rinçage.</p>",
        },
        {
          question:
            "Après l'enlèvement mécanique des fientes sur rebords métalliques, quelle désinfection garantissez-vous ?",
          answer:
            "<p>Une fois les dépôts retirés, un produit désinfectant à spectre large est pulvérisé sur les garde-corps et rebords métalliques. Ce traitement élimine les agents pathogènes résiduels et prévient la corrosion liée à l'acidité des fientes. Le rinçage final assure un rendu propre et sécurisé.</p>",
        },
        {
          question:
            "Comment organisez-vous l'évacuation et le tri des déchets contaminés après nettoyage balcon sur le Boulevard Salvador Allende ?",
          answer:
            "<p>Les fientes et résidus sont conditionnés dans des sacs étanches dès leur collecte. L'évacuation se fait de manière discrète pour limiter la gêne dans les résidences du Boulevard Salvador Allende. Les déchets sont ensuite acheminés vers notre véhicule pour élimination conforme aux normes sanitaires.</p>",
        },
      ],
      ctaOverride: "",
    },
    {
      ...
      heroDescription:
        "Détachage ciblé et extraction en profondeur de vos canapés, tapis et matelas, avec séchage optimisé pour retrouver un textile frais et sain en quelques heures.",
      whyUsBullets: [
      ...
      faqAdditions: [
        {
          question:
            "Pour les foyers avec enfants dans les résidences du Luzard, comment éliminez-vous acariens et allergènes sur canapés et tapis ?",
          answer:
            "<p>L'injection-extraction atteint les fibres en profondeur où se logent acariens et poussières allergènes. La chaleur et l'aspiration combinées réduisent significativement leur présence. Après séchage, le textile retrouve une hygiène améliorée, particulièrement appréciable dans les chambres d'enfants ou les pièces de vie très utilisées.</p>",
        },
        {
          question:
            "Quelle méthode utilisez-vous pour un canapé tissu non déhoussable dans un appartement sur dalle ?",
          answer:
            "<p>Nous procédons par injection d'eau tiède et produit adapté, puis extraction immédiate. Cette technique évite de détremper le textile tout en délogeant les salissures incrustées. La pression est modulée selon la densité du tissu. Le séchage reste rapide grâce à l'extraction poussée, même sans ventilation optimale.</p>",
        },
        {
          question:
            "Comment traitez-vous des taches anciennes et auréoles sur un tapis dans une maison de la Pièce-aux-Chats ?",
          answer:
    ...
    },
    {
      ...
      heroDescription:
        "Remise en état complète de votre terrasse à Noisiel, avec traitement adapté au support et application anti-mousse pour retrouver une surface saine et praticable.",
      whyUsBullets: [
      ...
      faqAdditions: [
        {
          question:
            "Comment éliminez-vous mousses et lichens sur les terrasses-jardins patrimoniales de la Cité Menier sans abîmer la pierre ?",
          answer:
            "<p>Un produit anti-mousse biodégradable est appliqué et laissé agir avant brossage manuel. La haute pression n'intervient qu'à faible intensité sur les pierres et briques anciennes. Cette méthode préserve les joints et la patine du matériau tout en éliminant les végétaux incrustés.</p>",
        },
        {
          question:
            "Quel risque pour les dalles sur plots et quelle méthode privilégiez-vous dans le secteur Ferme du Buisson ?",
          answer:
            "<p>Les dalles sur plots supportent mal une pression trop forte qui peut les déplacer ou endommager les joints. Nous utilisons un nettoyage basse pression combiné à un brossage mécanique. L'eau s'évacue naturellement entre les plots sans stagner sous le revêtement.</p>",
        },
        {
          question:
            "Quel traitement anti-mousse appliquez-vous sur les pavés et briques des terrasses à Noisiel ?",
          answer:
            "<p>Après nettoyage, un produit préventif à action lente est pulvérisé sur l'ensemble de la surface. Il empêche la repousse des mousses pendant plusieurs mois. La formulation respecte les matériaux poreux et ne modifie pas l'aspect naturel de la brique ou de la pierre.</p>",
        },
        {
          question:
            "Quelle saison recommandez-vous pour un décrassage complet de terrasse proche de la Marne ?",
          answer:
            "<p>Le printemps et le début d'automne offrent les meilleures conditions : températures douces pour le séchage et humidité modérée. Éviter les périodes de gel ou de forte chaleur qui compliquent l'action des produits. Un nettoyage avant l'été permet de profiter pleinement de l'espace extérieur.</p>",
        },
      ],
      ctaOverride: "",
    },
    {
      ...
      heroDescription:
        "Une remise en état complète de votre logement, des sols aux vitres, avec traitement des résidus de chantier ou préparation soignée avant état des lieux.",
      whyUsBullets: [
      ...
      faqAdditions: [
        {
          question:
            "Pour un nettoyage de fin de chantier dans la Cité Menier, quelles traces de peinture et colle traitez-vous en priorité ?",
          answer:
            "<p>Nous retirons les projections de peinture sur les menuiseries, les coulures sur les vitres et les résidus de colle sur les parquets anciens. Les voiles de plâtre ou de ciment sur les sols sont décapés sans abîmer le revêtement d'origine, fréquent dans ce quartier patrimonial.</p>",
        },
        {
          question:
        ...
        {
          question:
            "Quel niveau de propreté garantissez-vous pour remise en location d'un T2 près du Lycée Gérard de Nerval ?",
          answer:
            "<p>Le logement est livré avec sols lavés, vitres intérieures nettoyées, sanitaires désinfectés et placards essuyés. Ce niveau correspond aux attentes des agences pour un état des lieux entrant sans réserve. Si un point nécessite une repasse, nous revenons sans frais supplémentaires.</p>",
        },
        {
          question:
            "Avec digicodes et stationnement limité au Luzard, comment planifiez-vous l'accès et le matériel pour un ménage professionnel ?",
          answer:
            "<p>Nous récupérons les codes d'accès et badges en amont. Le matériel est conditionné pour un portage à pied si le stationnement reste éloigné. Nous privilégions les créneaux hors marché pour éviter les restrictions de circulation et garantir une intervention fluide.</p>",
        },
      ],
      ctaOverride: "",
    },
