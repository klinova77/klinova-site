...
const city: City = {
  ...
  customDescription: "Klinova intervient à Romainville pour l'entretien des parties communes, parkings souterrains et espaces extérieurs. Une équipe réactive, des méthodes adaptées au bâti récent de la ZAC de l'Horloge comme aux résidences du centre-ville.",

  // hubIntro : HTML autorisé (voir règles ci-dessous)
  // - 2 paragraphes <p>...</p>
  // - puis une liste à puces <ul><li>...</li></ul>
  hubIntro: `<p>Desservie par le métro 11 (Romainville-Carnot), entre la Corniche des Forts et le pôle Biocitech, Romainville connaît une transformation rapide. Klinova accompagne syndics, gestionnaires et particuliers dans l'entretien régulier de leurs espaces communs et privatifs.</p>
...
<ul>
  ...
  faq: [
    {
      question: "Comment organisez-vous vos interventions dans les résidences sécurisées de Romainville ?",
      answer: `<p>Nous récupérons les <strong>badges Vigik</strong> ou codes d'accès en amont auprès du syndic ou du gardien. Pour les résidences récentes de la ZAC de l'Horloge, nous planifions les passages en coordination avec le gestionnaire afin d'éviter les créneaux de forte affluence.</p>`
    },
    {
      question: "Proposez-vous un devis avant intervention ?",
      answer: `<p>Oui, chaque demande fait l'objet d'un <strong>diagnostic préalable</strong> — sur place ou à distance selon la nature du besoin. Le devis détaille les prestations, le matériel mobilisé et les délais estimés. Aucune facturation sans validation écrite.</p>`
    },
    {
      question: "Pouvez-vous intervenir en urgence après un sinistre ou un dégât des eaux ?",
      answer: `<p>Nous traitons les demandes urgentes sous 24 à 48 heures selon disponibilité. L'équipe évalue l'étendue des dégâts, sécurise la zone si nécessaire et procède à l'<strong>assainissement adapté</strong> — aspiration, séchage, désinfection selon le contexte.</p>`
    },
    {
      question: "Comment gérez-vous le stationnement dans les rues étroites du centre-ville ?",
      answer: `<p>Nos équipes repèrent les <strong>zones de dépose autorisées</strong> avant chaque intervention. En centre-ville, nous privilégions les créneaux matinaux hors marché et utilisons du matériel compact pour limiter l'encombrement sur la voie publique.</p>`
    }
  ],
  ...
  services: [
    {
      ...
      heroDescription: "Extraction des salissures incrustées dans vos moquettes de bureaux ou parties communes, avec séchage maîtrisé pour une remise en service rapide adaptée à vos contraintes d'activité.",
      whyUsBullets: [
...
<p class="mt-4">L'intervention s'organise après un diagnostic précis du support : type de moquette, nature des taches, configuration des accès. Ce repérage permet d'adapter le matériel aux contraintes du site, notamment pour les locaux à <strong>flux pendulaire important</strong> où la remise en service doit rester rapide.</p>`,
      uniqueDeepDive: `<h3>Fibres assainies et aspect ravivé</h3>
...
<p>L'extraction maximale limite l'humidité résiduelle. Selon l'épaisseur du revêtement et la ventilation du local, le séchage complet intervient sous 4 à 12 heures. Des consignes de non-piétinement sont transmises pour garantir un résultat durable.</p>`,
      ...
      faqAdditions: [
        {
          question: "Les cages d'escalier du centre-ville de Romainville sont souvent étroites : comment organisez-vous le passage du matériel ?",
        ...
        {
          question: "Pour les sièges moquette d'une salle de spectacle, quel délai de remise en service après nettoyage ?",
          answer: `<p>L'extraction intensive limite l'humidité résiduelle. Selon la ventilation de la salle et l'épaisseur du tissu, le séchage complet intervient généralement sous 6 à 10 heures. Une intervention en soirée permet une réouverture dès le lendemain matin sans gêne pour la programmation.</p>`
        },
        {
          question: "Dans des bureaux techniques comme ceux du parc Biocitech, quelle méthode protège les fibres et les équipements proches ?",
          answer: `<p>L'injection-extraction reste la méthode privilégiée : elle évite l'excès d'eau et le risque de détrempage. Les équipements informatiques ou de laboratoire sont protégés par bâchage. La pression d'injection est ajustée selon la densité de la moquette pour préserver la trame textile.</p>`
        },
        {
          question: "Comment adaptez-vous la méthode selon l'épaisseur de moquette en parties communes des résidences récentes ?",
          answer: `<p>Le diagnostic initial identifie le type de fibre (bouclée, velours ras ou épais). Pour les moquettes épaisses, nous augmentons le temps d'extraction afin de retirer l'humidité en profondeur. Les dalles textiles fines reçoivent un passage plus rapide avec pression réduite pour éviter toute déformation.</p>`
        }
      ],
      ctaOverride: ""
    },
    ...
    {
      serviceKey: "parkings",
      heroDescription: "Décrassage mécanisé des sols de parking avec autolaveuse et traitement dégraissant, gestion stricte des eaux usées et remise en circulation rapide des places.",
      whyUsBullets: [
      ...
      uniqueDeepDive: `<h3>Zones de circulation et places de stationnement</h3>
...
<p>Les rigoles collectrices et regards sont curés pour garantir un écoulement correct. Les eaux de lavage chargées en huile et détergent sont dirigées vers les points d'évacuation conformes, sans rejet sauvage. Un contrôle visuel final vérifie l'état des surfaces et permet d'établir une recommandation de fréquence d'entretien adaptée au trafic du parking.</p>`,
      ...
      faqAdditions: [
        {
          question: "Dans les parkings souterrains de la ZAC de l'Horloge, comment gérez-vous les eaux de lavage et les évacuations techniques ?",
          answer: `<p>Les eaux chargées en huile et détergent sont canalisées vers les regards existants après vérification de leur bon fonctionnement. Nous curons les rigoles en amont pour éviter tout refoulement. Aucun rejet n'est effectué vers la voirie ou les espaces communs extérieurs.</p>`
        },
        {
          question: "Pour des taches d'huile anciennes sur béton dans le secteur Paddock, quelle méthode appliquez-vous et quel résultat attendre ?",
          answer: `<p>Un dégraissant concentré est appliqué sur les zones incrustées avant passage de l'autolaveuse. Les taches récentes disparaissent généralement. Les auréoles anciennes s'atténuent nettement mais peuvent laisser une légère marque résiduelle selon la porosité du béton.</p>`
        },
        {
          question: "Avec le flux commercial du Paddock, quels horaires d'intervention et quel balisage proposez-vous pour limiter la gêne ?",
          answer: `<p>Les interventions sont programmées en début de matinée ou en soirée, hors pics d'affluence. Un balisage signalétique délimite les zones en cours de lavage. La rotation par secteur permet de maintenir une partie des places accessibles pendant toute la durée du chantier.</p>`
        },
        {
          question: "Quelles différences techniques appliquez-vous entre un parking souterrain et un parking aérien récent à Romainville ?",
          answer: `<p>En souterrain, la ventilation réduite impose un séchage plus long et une gestion stricte des eaux. En aérien, l'évacuation naturelle simplifie le rinçage mais l'exposition aux intempéries génère davantage de dépôts organiques. Le réglage de pression et le choix du produit s'adaptent à chaque configuration.</p>`
        }
      ],
      ctaOverride: ""
    },
    ...
    {
      serviceKey: "balcons",
      heroDescription: "Une remise en état complète de votre balcon à Romainville, avec traitement adapté au support, protection des voisins du dessous et séchage contrôlé pour profiter rapidement de votre extérieur.",
      whyUsBullets: [
...
<p class="mt-4">Notre intervention repose sur un diagnostic du support et de l'encrassement, suivi d'un protocole adapté. Protection des menuiseries, gestion de l'eau pour éviter les coulures chez vos voisins, traitement ciblé : chaque étape vise un résultat visible et durable.</p>`,
      uniqueDeepDive: `<h3>Dépôts accumulés et surfaces fragiles</h3>
...
<p>Un dispositif anti-écoulement canalise l'eau de rinçage. Les évacuations sont vérifiées avant intervention. Le séchage est accéléré si nécessaire. Nous terminons par des conseils d'entretien adaptés à votre exposition et au type de revêtement.</p>`,
      ...
      faqAdditions: [
        {
          question: "Comment nettoyer sans endommager les dalles sur plots des balcons de la ZAC de l'Horloge ?",
          answer: `<p>Les dalles sur plots des résidences récentes de Romainville présentent des joints ouverts sensibles à la haute pression. Nous utilisons un brossage doux combiné à un rinçage à pression modérée, orienté pour éviter l'infiltration d'eau sous les dalles. Le résultat est propre sans fragiliser le système de pose.</p>`
        },
        {
          question: "Pour des dépôts verts et mousse sur balcons exposés nord, quelle solution garantit une élimination durable ?",
        ...
        {
          question: "Quelles différences de méthode entre nettoyage d'une loggia et d'un balcon ouvert en centre-ville ?",
          answer: `<p>Une loggia fermée limite la ventilation naturelle : le séchage prend plus de temps et l'humidité stagne. Nous adaptons le volume d'eau utilisé et vérifions l'évacuation avant intervention. Sur un balcon ouvert, le rinçage peut être plus généreux, mais la protection des voisins du dessous reste identique.</p>`
        },
        {
          question: "En cas d'accès difficile à l'étage élevé en copropriété centre-ville, comment s'organise l'intervention ?",
          answer: `<p>Dans les immeubles anciens du centre de Romainville, les escaliers étroits et l'absence d'ascenseur compliquent le transport du matériel. Nous prévoyons un équipement léger et modulable. La coordination avec le gardien ou le syndic permet de réserver l'accès et d'éviter toute gêne pour les autres occupants.</p>`
        }
      ],
      ctaOverride: ""
    },
...
<p>Après collecte, chaque surface reçoit un produit virucide homologué avec temps de contact respecté. Un rinçage final précède l'aération du balcon. Si des corniches ou rebords favorisent le stationnement des pigeons, des solutions dissuasives — pics ou filets — peuvent être installées pour réduire le risque de réinfestation.</p>`,
      ...
      faqAdditions: [
        {
          question: "Les balcons proches de la Corniche des Forts sont couverts de fientes : quels risques sanitaires réels et quel délai pour une intervention ?",
        ...
        {
          question: "Après dépose des fientes sur un balcon Place Carnot, quelle désinfection technique appliquez-vous ?",
          answer: `<p>Une fois les dépôts retirés et conditionnés en sacs étanches, nous appliquons un produit virucide et bactéricide homologué sur l'ensemble des surfaces : sol, garde-corps, vitrages. Le temps de contact est respecté avant rinçage. Cette étape élimine les agents pathogènes résiduels et neutralise les odeurs persistantes.</p>`
        },
        {
          question: "Dans une copropriété Cité Marcel Cachin, comment organisez-vous l'enlèvement des déchets et la coordination avec les voisins ?",
          answer: `<p>Avant l'intervention, nous informons les occupants des balcons adjacents pour qu'ils rentrent leur linge et ferment leurs fenêtres. La zone est bâchée pour éviter toute projection. Les déchets sont conditionnés en sacs étanches et évacués directement, sans transit par les parties communes. Le gardien est prévenu si nécessaire.</p>`
        },
        {
          question: "Les fientes répétées abîment le béton des balcons à Romainville : quelles solutions contre la corrosion ?",
          answer: `<p>L'acidité des fientes attaque progressivement le béton et la peinture des garde-corps métalliques. Après assainissement complet, nous recommandons l'installation de pics ou filets sur les rebords favorisant le stationnement des pigeons. Cette prévention limite la récurrence et protège les supports d'une dégradation accélérée.</p>`
        }
      ],
      ctaOverride: ""
    },

    {
      ...
      heroDescription: "Détachage ciblé et extraction en profondeur de vos canapés, tapis et matelas, avec séchage optimisé pour retrouver un textile frais et assaini sous 24 à 48 heures.",
      whyUsBullets: [
...
<p>Le traitement principal combine injection d'une solution adaptée et extraction immédiate des résidus. La pression et la température sont ajustées selon l'épaisseur et la sensibilité du textile. L'extraction maximale réduit le temps de séchage à 6-12 heures selon la ventilation. Des consignes précises accompagnent la remise en service pour prolonger la propreté obtenue.</p>`,
      ...
      faqAdditions: [
        {
          question: "Pour les familles du quartier Bas-Pays, quel impact concret du nettoyage canapé sur la réduction des acariens et des allergènes ?",
        ...
        {
          question: "Comment traitez-vous des taches d'urine anciennes sur un canapé tissu avec des odeurs persistantes liées aux animaux domestiques ?",
          answer: `<p>Un pré-traitement enzymatique cible les composés organiques responsables des odeurs. L'injection-extraction déloge ensuite les résidus incrustés en profondeur. Sur les taches anciennes, plusieurs passages peuvent être nécessaires. Le résultat dépend de l'ancienneté et de la nature du textile, mais l'amélioration est généralement nette dès le séchage.</p>`
        },
        {
          question: "Pour un canapé tissu non déhoussable dans un appartement récent, quelle technique préconisez-vous entre vapeur et shampoing ?",
          answer: `<p>L'injection-extraction est privilégiée : elle nettoie en profondeur sans détremper le textile. La vapeur seule convient pour un rafraîchissement léger mais n'extrait pas les salissures incrustées. Sur les tissus fragiles ou les velours des résidences récentes, la pression et la température sont ajustées après test sur zone cachée.</p>`
        },
        {
          question: "Avec le stationnement limité près de Place Carnot, quelles contraintes logistiques implique une intervention de nettoyage canapé à domicile ?",
          answer: `<p>Le matériel portable permet d'intervenir même sans place de stationnement immédiate. En centre-ville de Romainville, nous anticipons les créneaux horaires moins encombrés et prévoyons un temps de manutention adapté. L'intervention reste possible en étage sans ascenseur, avec un équipement conçu pour la mobilité en milieu urbain dense.</p>`
        }
      ],
      ctaOverride: ""
    },

    {
      ...
      heroDescription: "Une remise en état complète de votre terrasse, du retrait des dépôts verts au traitement anti-mousse, pour retrouver un espace extérieur propre et utilisable.",
      whyUsBullets: [
...
<p>Les garde-corps et murets périphériques sont traités. L'eau est évacuée vers les points d'écoulement existants. Un traitement anti-mousse préventif peut être appliqué pour prolonger le résultat. Avant de partir, nous partageons quelques recommandations d'entretien saisonnier adaptées à votre exposition.</p>`,
      ...
      faqAdditions: [
        {
          question: "Pour une terrasse bois composite en attique dans la ZAC de l'Horloge, quelle pression utilisez-vous sans risquer d'abîmer les lames ?",
          answer: `<p>Le bois composite supporte mal une pression trop forte. Nous réglons le nettoyeur haute pression à un niveau modéré et maintenons une distance suffisante pour déloger les salissures sans marquer les lames. Un produit adapté aux composites complète le traitement.</p>`
        },
        {
          question: "Comment traitez-vous la mousse et le lichen sur une terrasse ombragée dans le Bas-Pays ?",
          answer: `<p>Un produit anti-mousse est appliqué avant le passage haute pression pour ramollir les dépôts. Le brossage mécanique déloge ensuite les lichens incrustés. Un traitement préventif peut être posé en fin d'intervention pour freiner la repousse pendant plusieurs mois.</p>`
        },
        {
          question: "Quel traitement anti-mousse proposez-vous pour des dalles anciennes afin d'obtenir un effet durable à Romainville ?",
          answer: `<p>Après le nettoyage, nous appliquons un produit filmogène qui pénètre les pores de la dalle. Ce traitement limite la réapparition des mousses pendant une à deux saisons selon l'exposition. Il convient aux dalles béton ou pierre naturelle courantes sur les pavillons.</p>`
        },
        {
          question: "Avant un nettoyage haute pression sur une terrasse de maison, comment protégez-vous le mobilier et les plantes ?",
          answer: `<p>Le mobilier léger est déplacé hors de la zone de travail. Les jardinières et plantations sont bâchées ou éloignées. Les baies vitrées et seuils reçoivent une protection pour éviter les projections. Tout est remis en place une fois la surface sèche.</p>`
        }
      ],
      ctaOverride: ""
    },

    {
      ...
      heroDescription: "Une remise en état complète de votre logement, avec nettoyage méthodique de chaque pièce et coordination adaptée aux délais de chantier ou d'état des lieux.",
      whyUsBullets: [
...
<p class="mt-4">Un compte-rendu peut être transmis si l'intervention s'inscrit dans une coordination avec une agence ou un propriétaire.</p>`,
      ...
      faqAdditions: [
        {
          question: "Pour un nettoyage fin de chantier dans un appartement livré en ZAC de l'Horloge, quelles étapes diffèrent d'un ménage classique ?",
        ...
        {
          question: "Si un état des lieux est prévu sous 48 heures près du métro Romainville-Carnot, pouvez-vous intervenir rapidement ?",
          answer: `<p>Nous organisons des interventions en délai court selon la disponibilité de nos équipes. Pour un appartement de type T2 ou T3, une remise en état complète peut être planifiée sous 24 à 48 heures. Le créneau est confirmé après échange sur la surface et l'état du logement.</p>`
        },
        {
          question: "Comment coordonnez-vous l'intervention avec des artisans ou une agence immobilière pour une remise en état locative ?",
          answer: `<p>Nous pouvons caler notre passage après la fin des travaux ou avant une visite agence. Un contact direct avec l'interlocuteur concerné permet d'ajuster l'horaire et de transmettre un compte-rendu si nécessaire. Cette coordination évite les allers-retours et respecte le planning de remise.</p>`
        },
        {
          question: "Pour un T2 ou T3 avant état des lieux, quel niveau de propreté peut-on attendre et comment le vérifier ?",
          answer: `<p>L'objectif est un logement prêt à être restitué ou occupé : sols propres, sanitaires détartrés, vitres nettes, placards vidés et essuyés. Un contrôle visuel est effectué avant départ. Sur demande, un compte-rendu écrit ou photographique peut accompagner l'intervention.</p>`
        }
      ],
      ctaOverride: ""
    }
