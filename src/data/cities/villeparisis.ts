  ...
  services: [
    ...
    // =========================
    {
      ...
      specificChallenges: [
        ...
        "<strong>Cages d'escalier étroites</strong> dans certains immeubles : matériel portatif nécessaire pour contremarches, angles et paliers.",
      ],
    ...
    // =========================
    {
      ...
      specificChallenges: [
        "<strong>Poussière de chantier</strong> du quartier Vieux-Pays qui s'infiltre et grise rapidement les canapés en tissu clair.",
