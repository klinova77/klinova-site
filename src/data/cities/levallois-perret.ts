...
<ul>\
  ...
  faq: [
    ...
    },
    {
      ...
      answer: "<p>Nous envoyons le devis <strong>rapidement</strong> après réception des informations (surface, type de prestation, accès). Si une visite technique est nécessaire — parkings profonds ou surfaces importantes — nous la planifions rapidement selon vos disponibilités.</p>",
    },
    {
  ...
  services: [
...

    {
      ...
      whyUsBullets: [
        ...
        "Organisation anticipée du stationnement et intervention rapide, pour retrouver vos textiles utilisables rapidement.",
      ],
