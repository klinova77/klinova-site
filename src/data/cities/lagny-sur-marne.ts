...
const city: City = {
  ...
  citySpecificChallenges: [
    ...
    "<strong>Accumulation de fientes de pigeons</strong> sur les balcons, garde-corps et appuis de fenêtres, notamment dans le centre ancien et près de l'abbatiale.",
    "<strong>Contraintes d'accès logistique</strong> pour les engins de nettoyage dans les ruelles étroites, zones piétonnes et parkings aux rampes pentues.",
    "<strong>Gestion fine des eaux de lavage</strong> (parkings, balcons) pour respecter les réseaux existants et l'environnement en bord de Marne.",
  ],
  ...
  services: [
    ...
    // =========================
    {
      ...
      specificChallenges: [
        "<strong>Fort passage dans les halls</strong> des copropriétés proches de la gare de Lagny-Thorigny, accélérant l'usure des moquettes.",
        "Poussières fines et particules liées à la circulation sur la Francilienne, incrustées dans les fibres.",
        "<strong>Humidité en rez-de-chaussée</strong> pour les immeubles en bord de Marne, favorisant les taches tenaces.",
    ...
    // =========================
    {
      ...
      specificChallenges: [
        "<strong>Poussière noire grasse</strong> et résidus de pneus dans les parkings souterrains, liés à la circulation dense sur la Francilienne et la RD 934.",
        "<strong>Taches d'huile persistantes</strong> et marquages effacés dans les parkings aériens des zones commerciales ou près de la gare.",
        "<strong>Rampes étroites et bas plafonds</strong> dans les parkings anciens, compliquant l'accès des machines.",
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p><strong>Nous récupérons les eaux avec l’autolaveuse</strong> et organisons l’évacuation selon les points disponibles sur site (siphons, regards, zones prévues), afin d’éviter tout écoulement incontrôlé et tout encrassement des réseaux. Aucun résidu n'est laissé dans les siphons ou les réseaux non adaptés.</p>",
        },
      ],
      ctaOverride: "",
    },
    ...
    // =========================
    {
      ...
      specificChallenges: [
        "<strong>Dépôts de poussière fine</strong> et pollution liés à la proximité de la Francilienne et des axes routiers, encrassant rapidement les balcons.",
        "<strong>Joints noircis et dépôts verts</strong> tenaces sur les balcons exposés aux arbres ou aux jardinières, nécessitant des produits spécifiques.",
    ...
    // =========================
    {
      ...
      specificChallenges: [
        ...
        "<strong>Corrosion des supports métalliques</strong> comme les garde-corps et rambardes due à l'acidité des fientes, exigeant un nettoyage et une protection adaptés.",
        "<strong>Évacuation des déchets contaminés</strong>, dans le respect des normes sanitaires et environnementales.",
      ],
    ...
    // =========================
    {
     ...
     uniqueDeepDive:
      ...
      specificChallenges: [
        ...
        "<strong>Pièces peu ventilées</strong> ou humides, ralentissant le séchage et exigeant une gestion rigoureuse de l'aération.",
        "<strong>Odeurs tenaces</strong> liées aux animaux ou à l'humidité, nécessitant des traitements spécifiques pour une élimination durable.",
      ],
...

    {
      ...
      uniqueIntro:
        "<p>Lagny-sur-Marne, commune historique de Seine-et-Marne, s’organise autour de son centre ancien, de quartiers résidentiels pavillonnaires et de secteurs plus récents. Bordée par la Marne, la ville bénéficie d’un cadre agréable mais exposé à une humidité régulière sur les surfaces extérieures.</p>\n\n<p class=\"mt-4\">Les terrasses situées à proximité des bords de Marne, dans les quartiers anciens ou en lisière d’espaces végétalisés, sont particulièrement sensibles à l’apparition de <strong>mousses, algues et traces noires</strong>. L’ombre, la rosée matinale et le ruissellement accentuent l’encrassement biologique des sols extérieurs.</p>\n\n<p class=\"mt-4\">Le parc immobilier latignacien est varié : maisons anciennes du centre-ville, pavillons des années 60 à 90, résidences contemporaines. Les terrasses y sont réalisées en dalles béton, carrelage extérieur, pierre naturelle ou reconstituée, bois ou bois composite, chaque matériau nécessitant une méthode de nettoyage spécifique.</p>",
      uniqueDeepDive:
        "<h3>Diagnostic du support et préparation</h3>\n<p>Avant toute intervention, le revêtement est identifié et son état évalué. <strong>Le mobilier, les pots et les éléments décoratifs</strong> sont déplacés ou protégés. Les zones adjacentes (façades, baies vitrées, garde-corps) sont bâchées, notamment dans les terrasses du centre ancien où les abords sont souvent proches.</p>\n\n<h3>Nettoyage adapté au matériau</h3>\n<p>Le protocole est ajusté selon le support : solution alcaline pour dalles béton et carrelages minéraux, produit spécifique pour pierre naturelle ou reconstituée, traitement dédié pour bois et composite. <strong>L’action mécanique par brossage contrôlé</strong> permet de décoller mousses, biofilm et salissures incrustées. Le rinçage est effectué à pression maîtrisée afin de préserver joints et surfaces.</p>\n\n<h3>Prévention et conseils d’entretien</h3>\n<p>Lorsque l’exposition à l’humidité est marquée — notamment près de la Marne — <strong>un traitement préventif</strong> peut être proposé pour limiter la reformation rapide des mousses. Les eaux de rinçage sont dirigées vers les écoulements existants. Des recommandations simples sont transmises pour prolonger le résultat dans le temps.</p>",
      specificChallenges: [
        "Terrasses proches des bords de Marne : <strong>humidité persistante</strong> favorisant la repousse rapide des mousses et algues.",
        ...
        "Résidences récentes avec carrelage ou grès cérame : <strong>reliefs de surface</strong> retenant les salissures et traces noires.",
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p><strong>La proximité de la Marne et l’humidité hivernale</strong> favorisent naturellement le développement des mousses et algues à Lagny-sur-Marne. Après le nettoyage, un traitement préventif ciblé peut ralentir la repousse. Un entretien régulier et l’évacuation des débris végétaux permettent de conserver une terrasse plus propre plus longtemps.</p>",
        },
        {
          question:
            "Nettoyez-vous les terrasses en pierre du centre ancien de Lagny sans les abîmer ?",
          answer:
            "<p><strong>Les terrasses en pierre naturelle ou ancienne</strong> nécessitent des précautions spécifiques. Nous évitons les produits agressifs et adaptons la pression de rinçage pour préserver la porosité et les joints. Le nettoyage est progressif et respectueux du matériau, notamment dans le centre historique.</p>",
        },
        {
          question:
            "Quelle différence entre un simple nettoyage haute pression et votre intervention ?",
          answer:
            "<p><strong>Un passage haute pression standard peut dégrader les joints</strong>, marquer la surface ou fragiliser les matériaux anciens. Notre intervention combine un produit adapté au support, un brossage mécanique contrôlé et un rinçage calibré, pour un nettoyage efficace sans détériorer la terrasse.</p>",
        },
        {
          question:
...

    {
      ...
      specificChallenges: [
        ...
        "Jour de marché Place de la Fontaine : <strong>affluence et accès plus compliqué</strong> (choix du créneau).",
        "Accès gare / pont : <strong>flux pendulaires côté Lagny-Thorigny</strong>, congestion possible autour du Pont de Fer.",
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Oui. C’est un cas très fréquent à Lagny, notamment en centre-ville et dans les quartiers récents. Nous cadrons <strong>l’accès (digicode/clé), l’étage et le périmètre attendu</strong>, puis nous livrons une remise en état propre et cohérente pour la remise des clés.</p>",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "<p><strong>Oui, sur les vitres accessibles.</strong> Les logements récents sont très lumineux : un passage soigné sur vitrages et rebords fait une vraie différence sur le rendu final, surtout avant un état des lieux.</p>",
        },
        {
          question:
