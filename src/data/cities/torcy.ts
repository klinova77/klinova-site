...
const city: City = {
  ...
  faq: [
    ...
    {
      question:
        "Pouvez-vous intervenir malgré les contraintes de stationnement près de la gare ?",
      answer:
  ...
  services: [
    ...
    // =========================
    {
      ...
      faqAdditions: [
        {
          question:
            "Quelles sont les particularités des interventions dans les copropriétés de Torcy ?",
          answer:
        ...
        {
          question:
            "Le nettoyage par injection-extraction risque-t-il d'abîmer les moquettes ?",
          answer:
        ...
        {
          question:
            "Comment organisez-vous les interventions pour limiter la gêne des résidents ?",
          answer:
    ...
    // =========================
    {
      ...
      faqAdditions: [
        {
          question:
            "Pourquoi les parkings de Torcy s'encrassent-ils si rapidement ?",
          answer:
    ...
    // =========================
    {
      ...
      faqAdditions: [
        {
          question:
            "Le nettoyage à haute pression risque-t-il d'endommager mon carrelage ou mes joints ?",
          answer:
        ...
        {
          question:
            "Les produits utilisés sont-ils dangereux pour mes plantes ou animaux domestiques ?",
          answer:
        ...
        {
          question:
            "Combien de temps faut-il attendre avant de pouvoir réutiliser le balcon ?",
          answer:
    ...
    // =========================
    {
      ...
      faqAdditions: [
        ...
        {
          question:
            "Les fientes peuvent-elles avoir abîmé mon balcon de façon irréversible ?",
          answer:
    ...
    // =========================
    {
      ...
      faqAdditions: [
        {
          question:
            "Votre nettoyage élimine-t-il efficacement les acariens et allergènes ?",
          answer:
        ...
        {
          question:
            "Pouvez-vous traiter les taches d'urine et les odeurs tenaces d'animaux ?",
          answer:
...

    {
      ...
      faqAdditions: [
        {
          question:
            "Intervenez-vous pour un nettoyage d’état des lieux à Torcy (77200) ?",
          answer:
            "<p>Oui. On suit une logique état des lieux : cuisine et salle d’eau en priorité, puis sols, puis finitions (plinthes, poignées, interrupteurs, bas de portes). C’est particulièrement demandé autour de la gare RER A et des quartiers Le Mail / Les Gradins.</p>",
        },
        {
          question:
        ...
        {
          question:
            "Nettoyez-vous aussi des maisons (Bel-Air, Beauregard) avec plusieurs étages ?",
          answer:
            "<p>Oui. Sur maison, on structure l’intervention par niveaux et par usages (pièces d’eau/cuisine, chambres, escaliers). L’enjeu est l’homogénéité : sols sans traces, poussière bien extraite, et finitions propres sur les zones de contact et de passage.</p>",
        },
      ],
