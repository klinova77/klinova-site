...
const city: City = {
  ...
  hubIntro:
    "<p>Serris présente un parc immobilier récent et exigeant, avec des copropriétés de haut standing, des résidences de services et des appart-hôtels nécessitant des protocoles adaptés aux standards hôteliers. <strong>Klinova intervient en partenariat avec les syndics, conciergeries et gestionnaires</strong> pour assurer l'entretien des parties communes, parkings souterrains et surfaces privées, en tenant compte des contraintes d'accès sécurisées et du trafic touristique intense.</p>\n<p>Nos équipes connaissent les spécificités locales : flux piétons massifs liés à Disneyland Paris et au RER A Val d'Europe, parkings souterrains aux hauteurs limitées (1m90), poussières de chantiers des secteurs en développement. Nous déployons des véhicules utilitaires compacts et des protocoles ajustés aux matériaux de standing (pierres naturelles, carrelages grand format, parquets stratifiés) avec une traçabilité complète pour répondre aux exigences des résidences sécurisées.</p>\n<ul>\n  <li><strong>Adaptation aux résidences sécurisées</strong> : Coordination avec conciergeries et syndics pour codes d'accès, badges et barrières automatiques, protocoles discrets conformes aux standards hôteliers des résidences de services et appart-hôtels.</li>\n  <li><strong>Maîtrise des contraintes logistiques</strong> : Véhicules utilitaires compacts adaptés aux parkings souterrains à hauteur limitée (1m90), planification en dehors des pics de saturation touristique week-ends et vacances, stationnement géré en sous-sols privés.</li>\n  <li><strong>Protocoles adaptés aux matériaux de standing</strong> : Méthodes soignées pour pierres de taille et enduits clairs sensibles aux coulures, carrelages grand format et pierres naturelles des halls, parquets stratifiés haute résistance typiques du parc immobilier serrisien récent.</li>\n</ul>",

  citySpecificChallenges: [
    "<strong>Flux piétons massifs</strong> liés à Disneyland Paris et au RER A Val d'Europe générant une usure accélérée des moquettes et sols des halls d'immeubles, particulièrement près de la gare",
    "<strong>Parkings souterrains à hauteur limitée</strong> stricte (1m90) imposant des véhicules utilitaires compacts et une planification logistique précise pour accéder aux résidences",
    "<strong>Poussières de construction</strong> des secteurs en développement encrassant rapidement les surfaces extérieures et les parkings des résidences récentes",
    "<strong>Résidences sécurisées à codes, badges</strong> et barrières automatiques nécessitant une coordination parfaite avec syndics et conciergeries pour chaque intervention",
  ],
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>Oui, quand les créneaux sont compatibles. On vise un rendu “prêt à accueillir” : salle d’eau sans traces, cuisine dégraissée, sols uniformes, et finitions visibles (poignées, interrupteurs, plinthes). L’accès (badge, interphone, consignes) est confirmé en amont pour éviter toute perte de temps.</p>",
        },
        {
          question:
            "Pouvez-vous intervenir pour un état des lieux (entrée/sortie) sur Val d’Europe ?",
          answer:
            "<p>Oui. On suit une logique état des lieux : pièces d’eau et cuisine en priorité, puis sols, puis finitions. C’est particulièrement adapté aux logements autour de la gare RER A Val d’Europe où la rotation locative est élevée.</p>",
        },
        {
          question:
            "Proposez-vous un nettoyage après travaux (poussière de plâtre, peinture) à Serris ?",
          answer:
            "<p>Oui. Après travaux, on procède en plusieurs passes pour éviter la redéposition de poussière fine : surfaces et menuiseries, puis sols, puis contrôle final des rebords, plinthes et zones de passage. Le but est un rendu net, sans voile sur les sols et les vitrages accessibles.</p>",
        },
        {
          question:
            "Comment gérez-vous le stationnement et les accès en résidence sécurisée ?",
          answer:
            "<p>On prépare l’intervention : point de dépose, parking possible (souvent souterrain), digicode/badge, et règles de copropriété. Ensuite, on organise le déroulé pour limiter les allers-retours et réduire la gêne, tout en gardant un niveau de finition élevé.</p>",
        },
      ],
