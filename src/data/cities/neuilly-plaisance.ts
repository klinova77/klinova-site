  ...
  faq: [
    {
      ...
      answer:
        "<p><strong>Oui, quand le contexte l’impose.</strong> Dans les secteurs où les entrées sont très sollicitées, on peut planifier tôt le matin ou sur des créneaux plus calmes. L’idée est de préserver la circulation, sécuriser les zones traitées et laisser un séchage compatible avec l’usage normal des lieux.</p>",
    },
    {
      question:
        "Comment se passe la coordination avec une copropriété quand l’accès est contrôlé ?",
      answer:
        "<p><strong>On anticipe les accès au lieu de les subir.</strong> Digicodes, badges, portes de sous-sol, zones à baliser : on clarifie en amont ce qui doit être ouvert, quand, et par qui. Sur place, on travaille par zones pour éviter de bloquer inutilement les halls, couloirs ou rampes.</p>",
    },
    {
      question:
        "Peut-on attendre un rendu plus net sur les zones noircies par la poussière le long des axes passants ?",
      answer:
        "<p><strong>Oui, avec une méthode adaptée et un vrai travail de détail.</strong> Les salissures grasses et fines demandent souvent une phase de dégraissage ciblé, puis une extraction ou un lavage mécanisé. On privilégie un rendu visuel propre, sans promettre de “comme neuf” : l’état initial et le support restent déterminants.</p>",
    },
    {
      question:
        "En cas d’urgence (dégât, salissure importante), pouvez-vous intervenir rapidement ?",
      answer:
        "<p><strong>Souvent oui, selon disponibilité et accès.</strong> Le plus important est d’avoir les informations utiles : surface, support, contraintes d’eau/évacuation, et conditions d’accès. Cela permet de choisir le bon procédé et de sécuriser la zone, plutôt que de “foncer” avec une solution inadaptée.</p>",
    },
  ],
  ...
  services: [
    ...
    // =========================
    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>On travaille par zones et on sécurise les portions en cours de traitement, plutôt que de bloquer tout l’accès. Dans les halls étroits, on planifie les étapes (pré-traitement, extraction, séchage) pour limiter la gêne, et on s’adapte aux horaires où la circulation est la plus faible.</p>",
        },
        {
          question:
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>On découpe le parking en zones et on définit une séquence d’ouverture/fermeture partielle. Les consignes sont claires avant le démarrage : emplacements à libérer, horaires, circulation maintenue. Cette approche évite les blocages et permet d’avancer régulièrement, même en sous-sol profond.</p>",
        },
        {
          question:
            "Quel niveau de balisage mettez-vous en place pour sécuriser les usagers ?",
          answer:
            "<p>Le balisage sert à protéger les piétons, éviter les traversées de zone humide et sécuriser les rampes. On positionne une signalétique visible aux entrées et sur les changements de zone. L’objectif est d’éviter les surprises et de maintenir une circulation maîtrisée pendant l’opération.</p>",
        },
        {
          question:
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>On commence par un retrait des gros dépôts, puis un produit adapté au support avec un temps d’action suffisant. Le brossage permet de décoller ce qui est incrusté dans les joints. Ensuite, on rince de façon maîtrisée pour éviter de disperser la saleté, surtout quand l’humidité favorise un retour rapide.</p>",
        },
        {
          question:
            "Sur un sol en grès cérame ou béton, adaptez-vous la méthode pour éviter d’abîmer joints et surfaces ?",
          answer:
            "<p>Oui. On ajuste la chimie et l’action mécanique : brossage manuel sur zones sensibles, pression contrôlée si haute pression utilisée, et rinçage raisonné. L’objectif est d’enlever les salissures sans ouvrir les joints ni fragiliser les supports, ce qui ferait revenir l’encrassement plus vite.</p>",
        },
      ...
      faqAdditions: [
        {
          ...
          answer:
            "<p>On commence par les EPI et le confinement, puis on humidifie avant tout retrait. Cette étape limite l’envol de particules. Ensuite seulement, on retire et on nettoie les supports, en gardant une zone contrôlée. Le but est de protéger l’intérieur du logement et l’environnement immédiat.</p>",
        },
        {
          question:
            "Dans un quartier résidentiel calme, comment gérez-vous le bâchage et la gêne pour les voisins ?",
          answer:
            "<p>Le bâchage sert à contenir, pas à “encombrer”. On protège les zones à risque, on travaille par séquences courtes et on évite les ruissellements. La communication est simple : durée, zones concernées, aération. L’objectif est d’assainir sans créer de nuisances inutiles.</p>",
        },
        {
          question:
    ...
    // =========================
    {
      ...
      faqAdditions: [
        ...
        },
        {
          ...
          answer:
            "<p>Tout part du diagnostic : type de fibre, tenue des couleurs, sensibilité à l’eau. On ajuste le pré-traitement, l’humidité, et l’action mécanique. L’objectif est d’assainir sans sur-mouiller ni “tirer” la fibre, et de garder un séchage compatible avec la vie du logement.</p>",
        },
        {
          question:
            "Près de l’Avenue du Maréchal Joffre, comment traitez-vous des taches incrustées sur un tapis ?",
          answer:
            "<p>On ne se contente pas d’un passage global : on réalise un détachage ciblé adapté à la tache (tanins, gras, encre), puis on nettoie l’ensemble pour éviter les auréoles. L’aspiration industrielle est essentielle pour extraire au maximum et limiter les reprises, surtout sur tapis très sollicités.</p>",
        },
        {
          question:
...

    {
      ...
      faqAdditions: [
        ...
        {
          question:
            "Le secteur Gare RER A est compliqué pour se garer : comment faites-vous ?",
          answer:
            "<p>Nous planifions l’arrivée et le déchargement, et nous privilégions des créneaux moins chargés quand c’est possible. L’objectif est de limiter les allers-retours et de sécuriser le temps de finition, plutôt que de le perdre en logistique.</p>",
        },
        {
          question:
            "Faites-vous un nettoyage après travaux (poussière de plâtre, traces) ?",
          answer:
            "<p>Oui. Après chantier, on traite d’abord la poussière fine et les traces sur menuiseries, plinthes et sols, puis on passe au nettoyage complet. C’est un besoin fréquent sur Neuilly-Plaisance, notamment dans les rénovations de pavillons sur le Plateau.</p>",
        },
      ],
