...
const balcons: ServiceConfig = {
  ...
  pricingTiers: [
    {
      name: "Balcon standard (entretien / remise en état)",
      description:
        "À partir de 190€ TTC. Tarif indicatif selon surface, état, accès et évacuation.",
      priceType: "from",
      from: 190,
      vatIncluded: true,
      currency: "EUR",
    ...
    {
      name: "Balcon très encrassé / accès complexe",
      description:
        "Sur devis après diagnostic (surface importante, joints très encrassés, accès difficile, contraintes d’eau/évacuation).",
      priceType: "quote",
      currency: "EUR",
    },
  ],

  // Si tu veux garder le legacy en plus, ok, sinon tu peux supprimer ce bloc.
