...
const city: City = {
  ...
  customDescription: "Klinova assure l'entretien des parties communes, parkings et espaces extérieurs à Bagneux. Du quartier de la Pierre Plate aux résidences neuves de l'écoquartier O'Mathurins, une équipe réactive et des méthodes adaptées au bâti local.",

  // hubIntro : HTML autorisé (voir règles ci-dessous)
  hubIntro: `<p>Terminus du Métro 4 et futur hub du Grand Paris Express, Bagneux connaît une transformation urbaine intense. Klinova accompagne syndics, gestionnaires et occupants dans le maintien de la propreté des immeubles et espaces communs, malgré les contraintes liées aux chantiers et à la densification.</p>
...
<ul>
  ...
  faq: [
    ...
    {
      question: "Pouvez-vous intervenir dans des résidences avec gardien ou accès par badge ?",
      answer: `<p>Oui, c'est fréquent à Bagneux. Nous coordonnons avec le gardien ou le syndic pour récupérer les <strong>accès nécessaires</strong> (badge Vigik, code). Les horaires sont calés pour limiter la gêne des résidents et respecter les consignes de chaque copropriété.</p>`
    },
    {
      question: "Quel délai prévoir pour obtenir un devis après une demande ?",
      answer: `<p>Nous répondons généralement sous <strong>24 à 48 heures</strong>. Si une visite technique est nécessaire — par exemple pour évaluer l'état d'un parking souterrain ou la surface d'un balcon — nous la planifions rapidement selon vos disponibilités.</p>`
    },
    {
      question: "Intervenez-vous en urgence si une dégradation survient dans les parties communes ?",
      answer: `<p>Nous traitons les demandes urgentes en priorité, selon la nature du problème et notre planning. Pour une <strong>salissure importante</strong> ou un incident ponctuel, contactez-nous directement : nous évaluons la faisabilité d'une intervention rapide.</p>`
    }
  ],
  ...
  services: [
    {
      ...
      heroDescription: "Extraction des salissures incrustées dans vos moquettes à Bagneux, avec séchage maîtrisé pour une remise en service rapide des espaces professionnels et résidentiels.",
      whyUsBullets: [
...
<p class="mt-4">Le flux piéton élevé sur les axes proches de la N20 et autour des pôles culturels génère une usure localisée qu'un simple aspirateur ne suffit pas à traiter. Une intervention structurée permet d'extraire les particules enfouies tout en préservant la tenue des fibres.</p>`,
      uniqueDeepDive: `<h3>1. Fibres assainies et couleurs ravivées</h3>
...
<p>L'extraction maximale limite le temps de séchage, généralement compris entre 4 et 8 heures selon l'épaisseur et la ventilation du local. Nous indiquons les zones à ne pas piétiner et recommandons une fréquence d'entretien adaptée à l'usage.</p>`,
      specificChallenges: [
        "Moquettes des équipements publics soumises à un passage intensif après chaque événement.",
        "Dalles textiles des bureaux d'O'Mathurins exposées aux poussières de chantier environnantes.",
        "Escaliers étroits du centre ancien compliquant l'acheminement du matériel d'extraction.",
        "Velours ras des halls de résidences récentes nécessitant un séchage rapide pour limiter la gêne.",
        "Taches de tanin et café incrustées dans les espaces d'accueil à fort trafic."
      ],
      faqAdditions: [
        {
          question: "Avec les escaliers étroits du centre-ville, comment acheminez-vous les machines jusqu'aux locaux du Théâtre Victor Hugo ?",
          answer: `<p>Nous utilisons des équipements compacts et modulables, transportables en plusieurs voyages si nécessaire. Le repérage préalable des accès permet d'anticiper les difficultés et d'organiser l'intervention sans bloquer les circulations ni abîmer les murs des cages d'escalier.</p>`
        },
        {
          question: "Après une représentation au Théâtre Victor Hugo, combien de temps avant que la moquette soit de nouveau utilisable ?",
          answer: `<p>Le séchage dure généralement entre 4 et 6 heures selon la ventilation de la salle. En programmant l'intervention en fin de soirée, la moquette est praticable dès le lendemain matin, sans odeur résiduelle ni sensation d'humidité au toucher.</p>`
        },
        {
          question: "Comment protégez-vous les plinthes et angles dans les petits bureaux du quartier O'Mathurins ?",
          answer: `<p>Des protections plastifiées sont posées le long des plinthes et aux angles avant le début du traitement. Cette précaution évite les projections et les traces d'humidité sur les finitions murales, particulièrement dans les espaces récents aux matériaux sensibles.</p>`
        },
        {
          question: "Quelle méthode privilégiez-vous pour une moquette de médiathèque par rapport à celle d'un bureau ?",
          answer: `<p>L'injection-extraction reste la base dans les deux cas. Pour une médiathèque à fort passage, nous augmentons le nombre de passes sur les zones de circulation. Dans un bureau, l'accent porte sur le détachage ciblé des postes de travail et le séchage rapide pour limiter l'interruption d'activité.</p>`
        }
      ],
      ctaOverride: ""
    },
    {
      serviceKey: "parkings",
      heroDescription: "Décrassage complet des sols de parkings souterrains et aériens, avec gestion stricte des eaux de lavage et coordination des accès pour limiter la gêne aux résidents.",
      whyUsBullets: [
...
<p class="mt-4">Klinova organise chaque chantier en tenant compte du <strong>trafic pendulaire</strong> et des contraintes propres aux résidences. Balisage sécurisé, rotation des véhicules par zones, récupération contrôlée des eaux usées : l'intervention se déroule sans bloquer l'accès aux résidents plus longtemps que nécessaire.</p>`,
      uniqueDeepDive: `<h3>1. Diagnostic et préparation du site</h3>
...
<p class="mt-4">Un compte-rendu avec recommandations de fréquence est transmis au donneur d'ordre.</p>`,
    ...
    {
      serviceKey: "balcons",
      heroDescription: "Remise en état complète de votre balcon à Bagneux : sols, garde-corps et vitrages traités avec gestion des coulures pour préserver le voisinage.",
      whyUsBullets: [
...
<p class="mt-4">La <strong>pollution liée à l'Avenue Aristide Briand</strong> et les poussières de chantiers omniprésentes à Bagneux accélèrent ce phénomène. Une intervention structurée permet de traiter chaque surface selon sa nature, en protégeant les voisins des écoulements.</p>`,
      uniqueDeepDive: `<h3>1. Dépôts incrustés et joints encrassés</h3>
...
<p class="mt-4">Le séchage naturel permet une réutilisation rapide de l'espace, généralement sous quelques heures selon l'exposition.</p>`,
      ...
      faqAdditions: [
        {
          question: "Le nettoyage risque-t-il d'abîmer le carrelage récent de mon balcon à la ZAC Victor Hugo ?",
          answer: `<p>Nous adaptons la pression et les produits au type de revêtement. Sur les dalles et carrelages récents fréquents dans ce quartier, nous privilégions un brossage doux et un rinçage contrôlé qui préservent les joints sans altérer la surface. Un test préalable permet de valider la méthode.</p>`
        },
        {
          question: "Comment gérez-vous l'eau de rinçage sur un balcon donnant sur l'Avenue Aristide Briand ?",
          answer: `<p>Nous canalisons les écoulements pour éviter toute projection vers la voirie ou les balcons inférieurs. Des protections sont installées en périphérie, et le rinçage s'effectue par petites quantités. Cette précaution limite les désagréments pour le voisinage et la façade de l'immeuble.</p>`
        },
        {
          question: "Intervenez-vous différemment sur une loggia fermée par rapport à un balcon ouvert dans les tours des Tertres ?",
          answer: `<p>Une loggia vitrée demande une attention particulière au séchage et à la ventilation. Nous ouvrons les accès pendant et après l'intervention pour accélérer l'évacuation de l'humidité. Le traitement des vitrages intérieurs complète le nettoyage du sol et des garde-corps.</p>`
        },
        {
          question: "Pouvez-vous nettoyer mon balcon sans utiliser de haute pression pour protéger le revêtement ?",
          answer: `<p>Oui, nous proposons un protocole sans haute pression adapté aux supports fragiles ou aux joints récents. Le brossage manuel combiné à des produits désincrustants offre un résultat équivalent sur les salissures courantes, sans risque pour les finitions de votre balcon.</p>`
        }
      ],
      ctaOverride: ""
    },
    {
      ...
      heroDescription: "Assainissement complet de votre balcon souillé par les fientes de pigeons, avec désinfection virucide des surfaces et mise en place de solutions anti-retour pour retrouver un espace sain.",
      whyUsBullets: [
...
<p>Après nettoyage du sol, des garde-corps et des vitrages, un produit virucide homologué est appliqué avec temps de contact respecté. Un rinçage final précède la remise en service du balcon. Si nécessaire, des pics ou filets anti-pigeons peuvent être posés sur les rebords et corniches pour limiter le retour des oiseaux.</p>`,
      ...
      faqAdditions: [
        {
          question: "Les balcons donnant sur le Parc François Mitterrand sont couverts de fientes : quels risques sanitaires et dans quel délai intervenez-vous ?",
          answer: `<p>Les fientes de pigeons contiennent des agents pathogènes (bactéries, champignons) qui peuvent provoquer des infections respiratoires. La proximité du parc attire les oiseaux en nombre. Nous intervenons généralement sous 48 à 72 heures pour stopper l'accumulation et assainir l'espace.</p>`
        },
        {
          question: "Quel protocole et quels EPI utilisez-vous pour la désinfection sur les loggias des grands ensembles à Bagneux ?",
          answer: `<p>L'intervenant porte masque FFP2, combinaison jetable, gants et lunettes. La loggia est confinée par bâchage pour protéger l'intérieur et les voisins. Les fientes sont humidifiées avant ramassage, puis un désinfectant virucide est appliqué sur toutes les surfaces avec temps de contact respecté.</p>`
        },
        {
          question: "Après retrait des fientes sur un balcon proche du cimetière parisien, quelle désinfection garantissez-vous pour éliminer germes et spores ?",
          answer: `<p>Nous utilisons un produit virucide et bactéricide homologué, appliqué après nettoyage complet des surfaces. Le temps de contact est respecté avant rinçage final. Cette désinfection élimine les agents pathogènes présents dans les résidus organiques et réduit les risques sanitaires.</p>`
        },
        {
          question: "Comment organisez-vous l'évacuation des déchets contaminés et la coordination avec les voisins en copropriété dense ?",
          answer: `<p>Les fientes et résidus sont conditionnés dans des sacs étanches dès le ramassage. L'évacuation se fait de manière sécurisée pour éviter toute dispersion dans les parties communes. En immeuble dense, nous informons le voisinage immédiat et adaptons les horaires pour limiter les nuisances.</p>`
        }
      ],
      ctaOverride: ""
    },
    {
      ...
      heroDescription: "Détachage et rafraîchissement de vos canapés, tapis et matelas à Bagneux, avec extraction des salissures en profondeur et séchage maîtrisé pour une utilisation rapide.",
      whyUsBullets: [
...
<p class="mt-4">L'extraction finale retire le maximum d'humidité. Les consignes de séchage sont adaptées à la saison et à la ventilation du logement.</p>`,
      ...
      faqAdditions: [
        {
          question: "Quel résultat attendre contre les acariens après le nettoyage d'un canapé dans une maison du Bas-Longchamps ?",
        ...
        {
          question: "Pouvez-vous traiter les taches et odeurs d'urine d'animaux sur un tapis ou un canapé utilisé en famille ?",
          answer: `<p>Oui, le détachage enzymatique cible spécifiquement les composés organiques responsables des odeurs. L'injection-extraction déloge ensuite les résidus en profondeur. Sur des taches anciennes ou répétées, plusieurs passages peuvent être nécessaires pour atténuer durablement l'odeur.</p>`
        },
        {
          question: "Comment adaptez-vous la méthode de nettoyage selon le textile et les sols fragiles d'un appartement T3 ou T4 ?",
          answer: `<p>Le diagnostic initial identifie le type de fibre et l'état du tissu. La pression d'injection et la température sont ajustées pour éviter toute déformation ou décoloration. Les sols environnants (parquet flottant, lino) sont protégés avant l'intervention pour prévenir les traces d'humidité.</p>`
        },
        {
          question: "Que dois-je préparer avant votre arrivée, sachant que le stationnement est compliqué dans mon quartier ?",
          answer: `<p>Dégagez l'accès autour du canapé ou du tapis et prévoyez un espace pour poser le matériel. Si possible, indiquez-nous une place de stationnement proche ou un créneau horaire où la voirie est moins encombrée. Nous adaptons l'heure d'intervention pour limiter les contraintes.</p>`
        }
      ],
      ctaOverride: ""
    },
    {
      ...
      heroDescription: "Remise en état complète de votre terrasse à Bagneux, avec traitement adapté au support et application anti-mousse pour retrouver un espace extérieur propre et utilisable.",
      whyUsBullets: [
...
<p>Une solution préventive est appliquée sur l'ensemble de la surface pour freiner la repousse des mousses et lichens. L'eau est dirigée vers les points d'écoulement existants. Nous vérifions que rien ne stagne avant de remettre le mobilier en place et de vous indiquer le délai de séchage complet.</p>`,
      ...
      faqAdditions: [
        {
          question: "Comment nettoyez-vous une terrasse en bois composite dans le quartier O'Mathurins sans abîmer les lames ?",
          answer: `<p>Nous utilisons une pression modérée et un produit adapté aux surfaces composites. Le jet reste à distance suffisante pour déloger les salissures sans marquer le revêtement. Cette approche préserve l'aspect d'origine des lames tout en éliminant les dépôts verts accumulés.</p>`
        },
        {
          question: "Quel traitement proposez-vous contre la mousse sur une terrasse ombragée à Bas-Longchamps ?",
          answer: `<p>Après le nettoyage, nous appliquons une solution anti-mousse qui agit en profondeur et freine la repousse pendant plusieurs mois. Sur les zones très exposées à l'humidité et au feuillage, nous recommandons un renouvellement annuel pour maintenir la surface praticable.</p>`
        },
        {
          question: "À quelle fréquence faut-il renouveler le traitement anti-mousse compte tenu du climat local ?",
          answer: `<p>En général, une application par an suffit pour les terrasses bien exposées. Pour celles situées sous couvert végétal ou orientées au nord, un passage tous les huit à dix mois limite efficacement le retour des lichens et dépôts verts.</p>`
        },
        {
          question: "Utilisez-vous la haute pression ou un nettoyage doux sur une terrasse en pierre d'un attique ?",
          answer: `<p>Cela dépend de la porosité du matériau. Sur pierre naturelle tendre, nous privilégions un nettoyage doux avec brossage mécanique. Sur carrelage ou pierre reconstituée, une pression contrôlée accélère le travail sans risque d'endommager les joints.</p>`
        }
      ],
      ctaOverride: ""
    },
    {
      ...
      heroDescription: "Une remise en état complète de votre logement, avec traitement adapté à chaque surface et coordination souple pour respecter vos délais de remise de clés ou de livraison.",
      whyUsBullets: [
...
<p class="mt-4">Une intervention structurée permet de respecter les créneaux imposés par les agences ou les artisans. Le stationnement contraint en centre-ville et la présence fréquente de digicodes exigent une organisation anticipée pour éviter les retards.</p>`,
      uniqueDeepDive: `<h3>1. Poussières et résidus de chantier</h3>
...
<p>L'aspiration précède un lavage adapté au revêtement : eau tiède sur carrelage, produit neutre sur parquet flottant, détachant doux sur lino. Les vitres intérieures sont nettoyées si incluses dans la prestation. Un passage de vérification garantit l'absence de zones oubliées avant la remise des clés.</p>`,
      ...
      faqAdditions: [
        {
          question: "Quelles méthodes employez-vous pour un nettoyage fin de chantier dans un appartement livré près du métro Lucie Aubrac ?",
          answer: `<p>Nous commençons par évacuer les résidus de chantier puis dépoussiérons l'ensemble des surfaces avant lavage. Les traces de peinture ou d'enduit sont traitées avec des produits adaptés au support. Le protocole s'ajuste selon l'état constaté à l'arrivée.</p>`
        },
        {
          question: "Comment établissez-vous le prix pour un nettoyage état des lieux d'un T3 ou T4 à Bagneux ?",
          answer: `<p>Le tarif dépend de la surface, du niveau d'encrassement et des prestations demandées. Un T3 standard nécessite généralement trois à quatre heures d'intervention. Nous transmettons un devis après description du bien et des travaux éventuels réalisés.</p>`
        },
        {
          question: "Comment coordonnez-vous votre intervention avec artisans et agence immobilière sur l'Avenue Aristide Briand ?",
          answer: `<p>Nous calons notre passage après la fin des travaux pour éviter de repasser. Si l'agence impose un créneau précis, nous adaptons nos horaires. Un contact direct avec le gestionnaire permet d'ajuster en cas de décalage de planning.</p>`
        },
        {
          question: "Quelles contraintes d'accès devez-vous anticiper pour un état des lieux en copropriété avec digicode ou Vigik ?",
          answer: `<p>Nous récupérons les codes ou badges en amont pour éviter toute attente le jour J. Si un gardien est présent, nous convenons d'un créneau avec lui. Cette organisation garantit un démarrage à l'heure prévue.</p>`
        }
      ],
      ctaOverride: ""
    }
