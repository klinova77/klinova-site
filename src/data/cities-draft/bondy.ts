...
const city: City = {
  ...
  customDescription: "Klinova assure l'entretien des parties communes, parkings et espaces extérieurs à Bondy. Une équipe réactive, des interventions coordonnées entre la gare RER E et les quartiers résidentiels, pour une propreté durable adaptée au tissu urbain local.",
  ...
  hubIntro: `<p>Au carrefour du RER E et du Tram T4, proche de l'Hôpital Jean Verdier, Bondy concentre des besoins variés en propreté. Klinova s'y positionne comme partenaire terrain, capable d'intervenir aussi bien dans les résidences que sur les espaces techniques ou extérieurs.</p>
...
<ul>
  ...
  faq: [
    {
      question: "Comment organisez-vous vos interventions dans les quartiers où le stationnement est compliqué ?",
      answer: `<p>Nous repérons en amont les <strong>zones de stationnement autorisées</strong> et privilégions les créneaux matinaux avant saturation. En centre-ville de Bondy ou près de la gare, nos équipes utilisent du matériel compact pour limiter l'encombrement et accélérer la mise en place.</p>`,
    },
    {
      question: "Pouvez-vous intervenir rapidement en cas de besoin urgent ?",
      answer: `<p>Selon la nature de la demande et notre planning, nous proposons des <strong>créneaux sous 24 à 48h</strong> pour les situations prioritaires. Un premier échange téléphonique permet d'évaluer l'urgence et de confirmer la faisabilité d'une intervention rapide sur Bondy.</p>`,
    },
    {
      question: "Comment se passe la coordination avec un syndic ou un gestionnaire ?",
      answer: `<p>Nous établissons un <strong>contact direct avec le référent désigné</strong> : transmission des dates d'intervention, accès aux parties communes, remontée d'informations après passage. Un reporting écrit peut être fourni si le gestionnaire le souhaite, pour assurer un suivi clair.</p>`,
    },
    {
      question: "Intervenez-vous aussi bien dans les immeubles collectifs que dans les pavillons ?",
      answer: `<p>Oui. À Bondy, nous traitons aussi bien les <strong>résidences des quartiers nord</strong> que les maisons individuelles du secteur sud. Chaque configuration implique des contraintes différentes — accès, surface, matériaux — que nous intégrons dès la préparation du chantier.</p>`,
    },
  ],
...
<p>Dans les petits collectifs du centre-ville, les escaliers et paliers nécessitent une approche adaptée aux contraintes d'espace. Aspiration préalable des fibres, injection de solution nettoyante, puis extraction maximale pour réduire le temps de séchage. Balisage temporaire si le passage doit être maintenu pendant l'intervention.</p>`,
      ...
      faqAdditions: [
        {
          question: "Avec les escaliers étroits du centre-ville, comment organisez-vous le passage du matériel pour shampouinage de moquette ?",
          answer: `<p>Nous utilisons des équipements compacts et modulables, transportables par sections. Le repérage préalable des accès permet d'anticiper les manœuvres. Si nécessaire, nous intervenons en binôme pour faciliter la montée du matériel sans abîmer les murs ni les rampes.</p>`,
        },
        {
          question: "Après un nettoyage en profondeur d'une moquette de bureau sur l'Avenue Gallieni, combien de temps avant remise en service ?",
          answer: `<p>Le séchage dépend de l'épaisseur des fibres et de la ventilation du local. En général, comptez entre 4 et 8 heures pour un passage léger, 12 à 24 heures pour une utilisation normale. Nous optimisons l'extraction pour réduire ce délai au maximum.</p>`,
        },
        {
          question: "Comment protégez-vous plinthes et angles lors d'un décapage ou shampouinage sur les moquettes de halls rénovés ?",
          answer: `<p>Des protections plastifiées sont posées le long des plinthes et bas de murs avant toute injection. Les angles et jonctions avec d'autres revêtements sont isolés pour éviter les projections. Cette précaution préserve les finitions et évite les traces d'humidité sur les surfaces adjacentes.</p>`,
        },
        {
          question: "Si le stationnement est compliqué près de la Mairie, comment planifiez-vous la livraison et le rangement du matériel ?",
          answer: `<p>Nous identifions à l'avance les possibilités de dépose rapide ou les emplacements autorisés à proximité. Le matériel est préparé pour un déchargement efficace. Si besoin, nous coordonnons avec le gestionnaire du site pour réserver un accès temporaire le temps de l'installation.</p>`,
        },
      ],
      ctaOverride: "",
    },
    ...
    {
      serviceKey: "parkings",
      heroDescription: "Décrassage complet des sols de parking avec autolaveuse et gestion stricte des eaux de lavage, balisage sécurisé et coordination des accès pour limiter la gêne aux résidents.",
      whyUsBullets: [
...
<p class="mt-4">Une intervention structurée permet de traiter l'ensemble des surfaces sans perturber l'accès aux véhicules. Le <strong>trafic routier élevé et les flux de livraison</strong> génèrent un encrassement constant : la gestion des eaux de lavage et la coordination des horaires deviennent des points clés pour mener le chantier efficacement.</p>`,
      uniqueDeepDive: `<h3>Sol décrassé et circulation rétablie</h3>
...
<p class="mt-4">Nous transmettons ensuite une recommandation de fréquence adaptée au trafic constaté.</p>`,
      ...
      faqAdditions: [
        {
          question: "Pour un parking proche de l'A3, quelles contraintes d'organisation et d'horaires recommandez-vous pour intervenir sans gêner le trafic ?",
          answer: `<p>Nous définissons un zonage par secteur avec le syndic ou le gestionnaire. Les résidents sont informés en amont pour déplacer leur véhicule sur les emplacements libérés. Le balisage sécurisé délimite la zone en cours de traitement et permet de maintenir une circulation partielle pendant l'intervention.</p>`,
        },
        {
          question: "Comment traitez-vous les taches d'huile incrustées sur un sol de parking exposé au trafic routier intense ?",
        ...
        {
          question: "Quelle méthode et quel traitement des eaux de lavage préconisez-vous pour un parking de copropriété à Bondy ?",
          answer: `<p>Nous vérifions d'abord l'état des regards et rigoles pour identifier les points d'évacuation autorisés. Les eaux chargées sont dirigées vers ces évacuations ou récupérées si nécessaire. Aucun rejet sauvage n'est effectué : la gestion des eaux fait partie intégrante du protocole.</p>`,
        },
        {
          question: "À quelle fréquence recommandez-vous un entretien de balayage mécanique sur un parking près d'Avenue Gallieni ?",
          answer: `<p>Pour un parking à fort trafic, un décrassage complet tous les trois à six mois limite l'accumulation de salissures et préserve l'état du revêtement. Entre deux interventions, un balayage mécanique mensuel peut suffire à maintenir un niveau de propreté acceptable selon le flux constaté.</p>`,
        },
      ],
      ctaOverride: "",
    },
    ...
    {
      serviceKey: "balcons",
      heroDescription: "Une remise en état complète de votre balcon, avec traitement des dépôts incrustés, protection des menuiseries et gestion maîtrisée des eaux pour préserver le voisinage.",
      whyUsBullets: [
...
<p>L'eau résiduelle est raclée vers l'évacuation. Nous vérifions l'absence de traces et laissons sécher naturellement. Avant de partir, nous vous indiquons la fréquence d'entretien recommandée selon l'exposition de votre balcon.</p>`,
      ...
      faqAdditions: [
        {
          question: "Quel procédé évitez-vous pour nettoyer un balcon en carrelage aux Rives de l'Ourcq afin de ne pas abîmer les joints ?",
          answer: `<p>Nous évitons la haute pression directe sur les joints. Le carrelage est brossé avec un produit adapté, puis rincé à pression douce et contrôlée. Cette méthode préserve l'étanchéité tout en éliminant les salissures incrustées par les poussières de chantier fréquentes dans ce secteur.</p>`,
        },
        {
          question: "Comment traitez-vous les dépôts de mousse sur un balcon exposé au canal et à l'humidité ?",
          answer: `<p>Les mousses et dépôts verts sont d'abord décollés mécaniquement par brossage. Un produit anti-mousse est ensuite appliqué pour ralentir la repousse. Sur les loggias ombragées proches du canal, nous recommandons un entretien bisannuel pour limiter le retour de ces salissures organiques.</p>`,
        },
        {
          question: "Comment évitez-vous les coulures chez le voisin du dessous lors du nettoyage d'un balcon en étage à Bondy ?",
          answer: `<p>Avant de commencer, nous installons des protections en périphérie du balcon pour canaliser l'eau vers l'évacuation. Le rinçage est effectué par zones, avec un raclage immédiat. Cette organisation évite les projections sur le linge étendu ou le mobilier du voisin situé en dessous.</p>`,
        },
        {
          question: "Quelles méthodes différez-vous selon le support (béton vs carrelage) pour un balcon à Bondy ?",
          answer: `<p>Le béton brut supporte un brossage plus appuyé et un rinçage à pression modérée. Le carrelage demande davantage de précaution sur les joints : pression réduite, produit non acide. Nous identifions le support dès le diagnostic pour choisir la technique et le dosage appropriés.</p>`,
        },
      ],
      ctaOverride: "",
    },
...
<p class="mt-4">Les déchets sont évacués en sacs étanches.</p>`,
      ...
      faqAdditions: [
        {
          question: "Des fientes importantes sur mon balcon côté Bois de Bondy : intervenez-vous en urgence et comment gérez-vous les risques sanitaires ?",
          answer: `<p>Les fientes de pigeons peuvent contenir des agents pathogènes transmissibles par inhalation de poussières. Nous intervenons sous quelques jours selon l'urgence. Le port d'EPI et l'humidification préalable limitent tout risque de dispersion pendant le traitement.</p>`,
        },
        {
          question: "Quel protocole et quels EPI utilisez-vous pour le nettoyage et la désinfection de fientes de pigeons sur un balcon ?",
          answer: `<p>L'intervenant porte masque FFP2, combinaison, gants et lunettes. La zone est confinée par bâchage. Après collecte des dépôts, un désinfectant virucide homologué est appliqué avec respect du temps de contact avant rinçage final.</p>`,
        },
        {
          question: "Les fientes ont attaqué la peinture de ma corniche : proposez-vous un diagnostic et remise en état après nettoyage ?",
          answer: `<p>Nous constatons l'état des supports après assainissement et signalons les zones dégradées. L'acidité des fientes peut corroder béton, métal et peinture. Un traitement préventif peut être recommandé pour protéger les surfaces fragilisées.</p>`,
        },
        {
          question: "Qui prend en charge l'évacuation des résidus après désinfection d'un balcon en copropriété à Bondy ?",
          answer: `<p>L'évacuation des déchets fait partie de notre intervention. Les fientes et matériaux souillés sont conditionnés en sacs étanches et emportés par nos équipes. Aucun résidu ne reste sur place après notre passage.</p>`,
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription: "Un détachage en profondeur de vos canapés, tapis et matelas à Bondy, avec extraction des salissures incrustées et séchage maîtrisé pour retrouver un mobilier sain.",
      whyUsBullets: [
      ...
      uniqueIntro: `<p>Comment préserver un canapé ou un tapis quand la vie de famille s'y installe durablement ? Dans le <strong>quartier de la Noue Caillet</strong>, les logements accueillent souvent enfants, repas partagés et animaux de compagnie. Les fibres absorbent ce quotidien : miettes, traces de boissons, poils, et parfois des accidents plus tenaces. Le tissu se ternit, les odeurs s'installent sans qu'on s'en rende compte immédiatement.</p>
...
<p class="mt-4">Notre intervention s'adapte aux contraintes locales : <strong>présence fréquente d'animaux domestiques</strong>, textiles variés, et accès parfois compliqués par des ascenseurs réduits. Nous évaluons chaque pièce avant d'agir, pour un résultat adapté à votre mobilier et à votre usage réel.</p>`,
      uniqueDeepDive: `<h3>Un textile assaini et des couleurs ravivées</h3>
...
<p>Le procédé injecte une solution nettoyante puis aspire immédiatement l'eau chargée de salissures. La pression et la température sont ajustées selon le textile. Nous indiquons le délai de séchage selon l'épaisseur et la ventilation disponible, généralement entre 4 et 8 heures pour une remise en service confortable.</p>`,
      ...
      faqAdditions: [
        {
          question: "Pour un canapé tissu en maison de famille à la Noue Caillet, pouvez-vous éliminer acariens et allergènes efficacement ?",
          answer: `<p>L'injection-extraction déloge les acariens et leurs déjections des fibres profondes. Combinée à un séchage rapide, cette méthode réduit significativement la charge allergène. Les familles avec enfants ou personnes sensibles constatent une amélioration du confort respiratoire après intervention.</p>`,
        },
        {
          question: "Comment traitez-vous les taches d'urine et les odeurs tenaces sur un tapis après animaux domestiques ?",
          answer: `<p>Un pré-traitement enzymatique cible les composés organiques responsables des odeurs. L'extraction retire ensuite les résidus en profondeur. Selon l'ancienneté de la tache, un second passage peut être nécessaire. Le textile retrouve une odeur neutre après séchage complet.</p>`,
        },
        {
          question: "Quel procédé utilisez-vous pour un canapé non déhoussable afin d'éviter surmouillage et rétrécissement ?",
          answer: `<p>Nous ajustons la pression d'injection et la quantité d'eau selon le tissu. L'extraction immédiate limite l'humidité résiduelle. Un test préalable sur zone cachée confirme la tolérance du textile. Cette précaution évite les auréoles et préserve la forme du rembourrage.</p>`,
        },
        {
          question: "Avec un accès difficile et ascenseur souvent en panne, comment organisez-vous l'intervention pour nettoyer un grand tapis ?",
          answer: `<p>Nous vérifions l'accessibilité avant le rendez-vous et adaptons le matériel transporté. Si l'ascenseur est indisponible, nous montons l'équipement par les escaliers. L'intervention se déroule sur place, sans déplacement du tapis, pour limiter les contraintes et respecter le délai convenu.</p>`,
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription: "Une remise en état complète de votre terrasse à Bondy, avec traitement adapté au support et élimination des dépôts verts pour retrouver un extérieur propre et utilisable.",
      whyUsBullets: [
...
<p class="mt-4">Avant de partir, nous indiquons la fréquence d'entretien recommandée selon l'exposition de votre terrasse.</p>`,
      ...
      faqAdditions: [
        {
          question: "Pour une terrasse en carrelage au Merisiers, quelle méthode préconisez-vous pour un décrassage sans abîmer les joints ?",
          answer: "<p>Nous appliquons d'abord un produit désincrustant qui ramollit les dépôts sans attaquer le mortier des joints. Le brossage mécanique déloge ensuite les salissures, puis la haute pression à réglage modéré rince l'ensemble. Les joints restent intacts et le carrelage retrouve son aspect d'origine.</p>",
        },
        {
          question: "Ma terrasse proche du Canal est envahie de mousse : proposez-vous démoussage et traitement anti-repousse durable ?",
          answer: `<p>Après élimination mécanique des mousses et lichens, nous appliquons un traitement préventif qui freine la recolonisation pendant plusieurs mois. L'humidité persistante près du Canal favorise ces dépôts verts : un entretien annuel prolonge l'efficacité du traitement et maintient la surface praticable.</p>`,
        },
        {
          question: "Faut-il déplacer mobilier et jardinières avant intervention, ou vos équipes s'en chargent-elles pour une terrasse pavillonnaire ?",
          answer: `<p>Nos équipes s'en chargent au début de l'intervention. Tables, chaises et pots sont déplacés ou protégés par bâchage selon leur poids. Nous les repositionnons une fois le séchage suffisant, pour que vous retrouviez votre terrasse prête à l'usage sans manipulation de votre part.</p>`,
        },
        {
          question: "Quel est le temps de séchage estimé après un nettoyage haute pression d'une terrasse carrelée à Bondy ?",
          answer: `<p>En conditions normales, comptez entre deux et quatre heures selon l'exposition au soleil et la ventilation. Une terrasse orientée sud sèche plus vite qu'un espace ombragé par des arbres. Nous intervenons de préférence le matin pour optimiser le séchage avant la fin de journée.</p>`,
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription: "Une remise en état complète de votre logement, du sol aux plafonds, pour une restitution impeccable lors d'un état des lieux ou après des travaux de rénovation.",
      whyUsBullets: [
...
<p>Interrupteurs, poignées de portes et radiateurs sont nettoyés un à un. Les vitres intérieures retrouvent leur transparence. En cas de fin de chantier, les traces de peinture ou d'enduit sur les encadrements sont retirées. Un contrôle visuel finalise l'intervention avant restitution des clés.</p>`,
      ...
      faqAdditions: [
        {
          question: "J'ai un état des lieux imminent près de la Mairie : quel est votre délai d'intervention pour un nettoyage complet ?",
        ...
        {
          question: "Pour un ménage fin de chantier dans la ZAC des Rives de l'Ourcq, quelles méthodes utilisez-vous pour poussières et traces de peinture ?",
          answer: `<p>L'intervention débute par l'évacuation des résidus grossiers puis un dépoussiérage complet des surfaces hautes vers le sol. Les traces de peinture, enduit ou colle sur les menuiseries et vitres sont retirées manuellement. Le lavage des sols termine l'opération pour un logement prêt à accueillir ses occupants.</p>`,
        },
        {
          question: "Quel niveau de propreté garantissez-vous pour une remise en état avant entrée d'un nouveau locataire à Bondy ?",
          answer: "<p>L'objectif est un logement propre et fonctionnel, sans traces ni poussières visibles sur les surfaces courantes. Sanitaires, cuisine et sols sont traités pour permettre une installation immédiate. En cas de point non conforme relevé lors du contrôle, une repasse ciblée est effectuée.</p>",
        },
        {
          question: "Travaillez-vous en coordination avec les agences immobilières locales et bailleurs pour les remises en état à Bondy ?",
