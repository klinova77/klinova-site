...
const city: City = {
  ...
  hubIntro: `<p>À Bobigny, préfecture de la Seine-Saint-Denis et terminus du Métro 5, Klinova accompagne syndics, gestionnaires et occupants dans la gestion quotidienne de la propreté. Notre équipe connaît les spécificités du parc immobilier local, des tours administratives aux résidences des quartiers Paul Eluard ou Karl Marx.</p>
 ...
 faq: [
  {
    ...
    answer: `<p>Nous prenons contact avec le gardien ou le gestionnaire en amont pour convenir des horaires et des accès. Cette coordination est particulièrement utile dans les grands ensembles où les entrées sont sécurisées (badge, digicode) et où certains locaux techniques nécessitent une ouverture dédiée.</p>`,
  },
  {
    question: "Pouvez-vous intervenir en dehors des heures de bureau ?",
    answer: `<p>Oui, nous proposons des créneaux tôt le matin ou en fin de journée selon les sites. Cela permet de travailler sans gêner les flux d’usagers et de limiter les contraintes d’accès, notamment pour les parkings et les halls à forte fréquentation.</p>`,
  },
  {
    question: "Quel délai pour obtenir un devis après une demande ?",
    answer: `<p>Le devis est généralement transmis sous <strong>24 à 48 heures</strong> après réception des informations nécessaires. Si une visite technique est utile, elle est planifiée rapidement pour confirmer les surfaces, l’état des sols et les conditions d’accès.</p>`,
  },
  {
    question:
      "Intervenez-vous pour des besoins ponctuels ou uniquement en contrat régulier ?",
    answer: `<p>Les deux formules sont possibles. Nous pouvons intervenir ponctuellement (décrassage de parking, remise en état) ou mettre en place un entretien récurrent des parties communes, avec une fréquence ajustée au niveau de passage et aux attentes du gestionnaire.</p>`,
  },
],
  ...
  services: [
    {
      ...
      heroDescription: "Extraction des salissures incrustées dans vos moquettes et dalles textiles, avec séchage contrôlé pour une remise en circulation rapide des espaces professionnels ou résidentiels.",
      whyUsBullets: [
...
<p>Les moquettes velours des espaces visiteurs nécessitent une extraction soignée pour éviter l'auréolage. Le séchage est accéléré par ventilation si les horaires d'ouverture l'imposent. Un temps de non-piétinement de quelques heures garantit un résultat homogène sur l'ensemble de la surface traitée.</p>`,
      specificChallenges: [
        ...
        "Poussières de chantier du quartier Cœur de Ville qui s'infiltrent dans les halls.",
        "Contraintes horaires strictes imposant des interventions en dehors des heures d'ouverture au public.",
        "Moquettes velours des salles d'attente marquées par les taches de café et traces de semelles.",
        "Accès par escaliers étroits dans certaines copropriétés sociales nécessitant un matériel adapté.",
      ],
      faqAdditions: [
        {
          question: "Dans les immeubles sociaux aux escaliers étroits, comment procédez-vous pour transporter le shampouineur sans gêner les habitants ?",
          answer: `<p>Notre équipement est modulable et se décompose en éléments transportables à la main. Dans les copropriétés où les ascenseurs sont absents ou en panne, nous montons le matériel par étapes sans encombrer les paliers. L'intervention est organisée pour limiter les allers-retours et réduire la gêne pour les résidents.</p>`,
        },
        {
          question: "Pour les moquettes des halls de la Préfecture, quel résultat de propreté attendez-vous et quel temps de remise en service ?",
          answer: `<p>Les dalles textiles retrouvent leur teinte d'origine après extraction des salissures accumulées. Le grisaillement disparaît et les taches de passage s'estompent. Le séchage contrôlé permet une remise en circulation des espaces sous quelques heures selon la ventilation disponible sur site.</p>`,
        },
        {
          question: "Quelle méthode technique recommandez-vous pour dalles textiles en bureaux versus velours ras en résidence privée à Bobigny ?",
          answer: `<p>Les dalles textiles supportent une pression d'injection plus élevée et sèchent rapidement grâce à leur faible épaisseur. Le velours ras demande une extraction plus douce pour éviter l'écrasement des fibres. Nous adaptons le réglage du matériel selon le type de revêtement identifié lors du diagnostic initial.</p>`,
        },
        {
          question: "Avec les poussières de chantier du Cœur de Ville, quel comparatif de méthodes (vapeur vs sec) garantira un meilleur détachage ?",
          answer: `<p>Les particules fines de chantier s'incrustent profondément et résistent aux traitements à sec. L'injection-extraction humide est préférable car elle déloge les résidus incrustés. Plusieurs passes peuvent être nécessaires pour atteindre le niveau de propreté attendu.</p>`,
        },
      ],
      ctaOverride: "",
    },
    ...
    {
      serviceKey: "parkings",
      heroDescription: "Décrassage complet des sols de parking avec autolaveuse et traitement dégraissant, gestion stricte des eaux usées et balisage sécurisé pour maintenir l'accès des usagers.",
      whyUsBullets: [
...
<p class="mt-4">Un compte-rendu est transmis au donneur d'ordre avec nos préconisations de fréquence selon le niveau de trafic constaté.</p>`,
      specificChallenges: [
        "Taches d'huile récurrentes sur les sols béton des parkings en zone d'activités.",
        ...
        "Gestion des eaux de lavage conforme aux réseaux d'évacuation existants.",
      ],
      faqAdditions: [
        {
          question: "Comment traitez-vous les taches d'huile anciennes sur les dalles béton du parking de la ZI des Vignes pour éviter reprises ?",
          answer: `<p>Nous appliquons un dégraissant professionnel sur chaque zone marquée avant le passage de l'autolaveuse. Les taches incrustées reçoivent un temps de pose prolongé. Cette méthode permet d'éliminer la majorité des résidus sans abîmer le revêtement, même sur des salissures de plusieurs mois.</p>`,
        },
        {
          question: "Pour un parking souterrain de copropriété, quelle gestion des eaux de lavage préconisez-vous pour respecter les filières d'évacuation ?",
        ...
        {
          question: "Sur la rampe d'accès d'un parking proche du Canal de l'Ourcq, quelles méthodes antiglisse et de décapage utilisez-vous ?",
          answer: `<p>La rampe est traitée avec une pression adaptée pour ne pas lisser le support. Nous évitons les produits laissant un film glissant et contrôlons l'adhérence après séchage. Si nécessaire, un rinçage complémentaire est effectué pour éliminer tout résidu de dégraissant.</p>`,
        },
        {
          question: "Intervenez-vous en horaires décalés pour le nettoyage des parkings desservant l'Hôpital Avicenne afin de limiter la gêne ?",
          answer: `<p>Oui, nous proposons des créneaux en soirée, la nuit ou le week-end selon les contraintes du site. La planification est validée avec le gestionnaire pour éviter les heures de forte affluence. Le balisage sécurise les zones en cours de traitement pendant toute la durée de l'intervention.</p>`,
        },
      ],
      ctaOverride: "",
    },
    ...
    {
      serviceKey: "balcons",
      heroDescription: "Remise en état complète de votre balcon à Bobigny : traitement des dépôts, nettoyage des garde-corps et gestion maîtrisée de l'eau pour un espace extérieur à nouveau utilisable.",
      whyUsBullets: [
...
<p>L'eau de rinçage est gérée pour éviter les coulures chez les voisins du dessous. Des protections sont posées en périphérie si nécessaire. Le séchage est accéléré par raclage, et des conseils d'entretien sont transmis pour espacer les prochaines interventions.</p>`,
      specificChallenges: [
        ...
        "Béton brut poreux des barres années 60-70 nécessitant un traitement désincrustant adapté.",
        "Loggias semi-fermées avec accumulation de dépôts verts liée à la végétation du Parc de la Bergère.",
        "Étages élevés dans les tours imposant une logistique d'accès et de gestion du matériel.",
        "Densité d'occupation exigeant une coordination stricte pour éviter les nuisances aux voisins.",
      ],
      faqAdditions: [
        {
          question: "Comment nettoyez-vous un balcon en béton brut à Karl Marx fortement noircit par la circulation sur la N3 sans abîmer le support ?",
          answer: `<p>Le béton brut est poreux et retient les particules de pollution. Nous appliquons un produit désincrustant non acide, laissé agir quelques minutes, puis brossé mécaniquement. Le rinçage se fait à pression modérée pour ne pas creuser la surface. Les joints sont traités séparément si nécessaire.</p>`,
        },
        {
          question: "Quelle gestion de l'eau et quelles protections mettez-vous en place pour éviter coulures chez les voisins du dessous ?",
          answer: `<p>Avant de commencer, nous installons des protections en périphérie du balcon — bâches ou raclettes de retenue. L'eau est dirigée vers l'évacuation existante ou récupérée. Si le balcon n'a pas de siphon, nous travaillons par zones avec un minimum d'eau et un raclage immédiat.</p>`,
        },
        {
          question: "Sur des loggias proches du Parc de la Bergère, comment traitez-vous les dépôts verts et mousses incrustées sans détériorer les joints ?",
          answer: `<p>Les mousses et dépôts verts sont d'abord grattés à sec pour retirer l'épaisseur. Un traitement anti-mousse est ensuite appliqué sur les zones concernées. Le brossage reste manuel autour des joints fragiles. Le rinçage final élimine les résidus sans pression excessive.</p>`,
        },
        {
          question: "Pour un balcon au dernier étage d'une tour, quelles solutions d'accès proposez-vous pour intervenir en sécurité et rapidité ?",
          answer: `<p>Le matériel est monté en plusieurs rotations si l'ascenseur est disponible, ou conditionné pour un portage escalier. L'intervention est planifiée pour limiter les allers-retours. Sur place, nous travaillons avec un équipement compact adapté aux espaces réduits et aux contraintes d'évacuation d'eau en hauteur.</p>`,
        },
      ],
      ctaOverride: "",
    },
...
<p class="mt-4">Si nécessaire, nous proposons la pose de pics anti-pigeons sur les rebords ou de filets de protection pour limiter les retours.</p>`,
      specificChallenges: [
        ...
        "Accumulation rapide près des alignements d'arbres et du Parc de la Bergère.",
        "Risque de dispersion vers les voisins du dessous dans les immeubles denses.",
        "Dégradation des peintures et supports par l'acidité des fientes non traitées.",
        "Présence accrue d'oiseaux autour des marchés alimentaires du quartier.",
      ],
      faqAdditions: [
        {
          question: "Les fientes couvrent un balcon côté Parc de la Bergère : quelles sont les urgences sanitaires et étapes immédiates de prise en charge ?",
        ...
        {
          question: "Quel protocole EPI et quels produits utilisez-vous pour désinfecter rebords en béton attaqués par fientes de pigeons ?",
          answer: `<p>Nos équipes portent masques FFP2, gants, lunettes et combinaisons jetables. Après humidification pour éviter l'envol de particules, nous appliquons un produit virucide et bactéricide homologué sur le béton. Le temps de contact est respecté avant rinçage pour garantir l'élimination des agents pathogènes.</p>`,
        },
        {
          question: "Après enlèvement des fientes sur une loggia, quelle désinfection obligatoire appliquez-vous pour rendre l'espace sain aux habitants ?",
          answer: `<p>Une fois les dépôts collectés, nous traitons l'ensemble des surfaces avec un désinfectant à spectre large. Ce produit élimine bactéries et virus présents dans les résidus. Après le temps de contact requis, un rinçage et une aération permettent de réutiliser la loggia en toute sécurité.</p>`,
        },
        {
          question: "Comment évacuez-vous les déchets contaminés (fientes) en respectant la réglementation et sans gêner la voie publique à Bobigny ?",
          answer: `<p>Les fientes et résidus sont conditionnés dans des sacs étanches dès la collecte. Nous les transportons directement vers notre véhicule sans stockage sur les parties communes. Cette organisation limite les nuisances pour le voisinage et respecte les contraintes de stationnement en centre-ville.</p>`,
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription: "Extraction en profondeur des salissures incrustées dans vos canapés, tapis et matelas, avec détachage ciblé et séchage maîtrisé pour une remise en service rapide.",
      whyUsBullets: [
...
<p>Le traitement principal utilise la technique d'injection-extraction : solution nettoyante injectée dans les fibres, puis aspirée avec les salissures. La pression et la température sont ajustées selon l'épaisseur du textile. Nous vous indiquons le délai de séchage selon la saison et l'aération disponible.</p>`,
      specificChallenges: [
        ...
        "Textiles synthétiques sensibles nécessitant un réglage précis de température et pression.",
        ...
        "Salles d'attente médicales exigeant une remise en service rapide entre deux journées.",
      ],
      faqAdditions: [
        {
          question: "Pour un canapé familial infesté d'acariens à Bobigny centre, quel résultat d'assainissement pouvez-vous garantir et en combien de temps ?",
          answer: `<p>L'extraction par injection-aspiration retire la majorité des acariens, poussières et allergènes logés dans les fibres. Sur les canapés des logements proches du métro Pablo Picasso, nous constatons une amélioration nette de la qualité de l'air intérieur dès le séchage terminé, généralement sous 4 à 8 heures selon l'épaisseur du tissu.</p>`,
        },
        {
          question: "Nettoyez-vous les canapés des salles d'attente d'Avicenne sur site et quel est le temps de séchage moyen ?",
          answer: `<p>Oui, nous traitons les assises des cabinets médicaux et juridiques du secteur. Le séchage varie selon le revêtement : comptez 3 à 5 heures pour du similicuir, 6 à 10 heures pour du tissu épais. Nous pouvons intervenir en fin de journée pour une remise en service le lendemain matin.</p>`,
        },
        {
          question: "Comment procédez-vous pour un canapé en tissu non déhoussable dans un studio étudiant proche de l'IUT sans démontage complet ?",
          answer: `<p>Nous travaillons directement sur place sans démontage. Après identification du tissu, le détachage cible les zones marquées puis l'injection-extraction traite l'ensemble de l'assise. Le matériel compact passe dans les escaliers étroits des résidences étudiantes. Aucun transport du meuble n'est nécessaire.</p>`,
        },
        {
          question: "En secteur Pierre Semard, quelles consignes logistiques donnez-vous pour l'arrivée du technicien et du matériel volumineux ?",
          answer: `<p>Nous demandons une place de stationnement à proximité immédiate ou l'autorisation de stationner brièvement devant l'entrée. Le matériel tient sur un chariot roulant. Si l'accès se fait par un jardin ou une allée étroite, prévenez-nous pour adapter l'organisation. Un créneau de 15 minutes suffit pour l'installation.</p>`,
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription: "Remise en état complète de votre terrasse avec traitement adapté au support, élimination des mousses et dépôts tenaces, pour retrouver un espace extérieur propre et utilisable.",
      whyUsBullets: [
        "Connaissance des terrasses bobignyennes exposées à la pollution des axes A86 et N3, avec leurs dépôts caractéristiques.",
        "Maîtrise des techniques adaptées à chaque support : pression contrôlée sur carrelage, nettoyage doux sur bois composite, traitement anti-mousse ciblé.",
        "Organisation prévoyant la protection du mobilier et des plantes, gestion de l'écoulement pour préserver le voisinage.",
      ],
      uniqueIntro: `<p>Dans le quartier de <strong>l'Abreuvoir</strong> comme dans les zones pavillonnaires de Bobigny, les terrasses accumulent rapidement des dépôts noirâtres. La proximité de l'<strong>Avenue Jean Jaurès</strong> et des axes à fort trafic génère un voile de pollution qui se dépose sur les dalles et le carrelage. Les mousses s'installent dans les zones ombragées, rendant les surfaces glissantes dès les premières pluies d'automne.</p>
<p class="mt-4">Les supports varient selon l'âge des constructions : <strong>carrelage et dalles gravillonnées</strong> sur les toits-terrasses des immeubles anciens, <strong>bois composite</strong> sur les résidences récentes de la ZAC Jean Rostand. Chaque matériau réagit différemment aux intempéries et demande une approche spécifique pour éviter les dégradations lors du nettoyage.</p>
<p class="mt-4">L'<strong>exposition à la pollution urbaine liée à l'A86 et à la N3</strong> accélère l'encrassement saisonnier. Une intervention structurée permet de traiter l'ensemble de la surface, d'appliquer un produit anti-mousse adapté et de redonner à votre terrasse son aspect d'origine sans risque pour les joints ou l'étanchéité.</p>`,
      uniqueDeepDive: `<h3>T1: Surface principale et revêtement</h3>
<p>Le sol de la terrasse constitue la zone prioritaire. Après déplacement du mobilier et protection des jardinières, un balayage élimine les débris et feuilles accumulés. Le produit de traitement est sélectionné selon le support identifié : formule douce pour bois composite, dégraissant pour carrelage, solution adaptée aux dalles gravillonnées.</p>
<p class="mt-4">Le brossage mécanique ou manuel déloge les mousses incrustées dans les joints et les micro-reliefs du revêtement.</p>

<h3>T2: Périphérie et éléments verticaux</h3>
<p>Les garde-corps, murets et marches d'accès reçoivent un traitement spécifique. Ces zones verticales retiennent moins l'humidité mais concentrent les projections et coulures. Un rinçage contrôlé évite les éclaboussures vers les plantations ou le voisinage en contrebas.</p>

<h3>T3: Finition et protection</h3>
<p>L'évacuation de l'eau s'effectue vers les points d'écoulement existants. Un traitement anti-mousse préventif peut être appliqué sur les zones exposées à l'ombre. Le séchage naturel précède la remise en place du mobilier extérieur.</p>`,
      specificChallenges: [
        "Dépôts noirs liés à la pollution de l'Avenue Jean Jaurès sur les terrasses exposées côté rue.",
        "Mousses tenaces dans les zones ombragées des pavillons du quartier de l'Abreuvoir.",
        "Bois composite sensible des résidences récentes nécessitant une pression adaptée.",
        "Dalles gravillonnées sur toits-terrasses avec joints fragiles à préserver.",
        "Gestion de l'eau sur terrasses en hauteur pour éviter les coulures chez les voisins.",
      ],
      faqAdditions: [
        {
          question: "Pour une terrasse en bois composite à Jean Rostand, quelle méthode douce recommandez-vous pour ne pas abîmer les lames ?",
          answer: `<p>Sur les terrasses en bois composite des résidences récentes, nous privilégions un nettoyage basse pression associé à un produit neutre. Cette approche évite le grisaillement prématuré des lames et préserve leur traitement de surface. Le brossage manuel complète l'intervention sur les zones encrassées sans risque de rayure.</p>`,
        },
        {
          question: "Comment procédez-vous pour le démoussage d'une terrasse pavillonnaire à Pierre Semard afin d'éviter reprises rapides ?",
          answer: `<p>Les terrasses ombragées accumulent mousses et lichens qui rendent le sol glissant. Nous appliquons un traitement biocide après brossage mécanique pour éliminer les végétaux incrustés. Un produit préventif limite la repousse pendant plusieurs mois, particulièrement utile sur les dalles exposées à l'humidité persistante.</p>`,
        },
        {
          question: "Quel traitement anti-mousse appliquez-vous sur dalles gravillonnées et quel est le délai avant réutilisation de la terrasse ?",
          answer: `<p>Sur dalles gravillonnées, nous utilisons un anti-mousse à action lente qui pénètre sans abîmer les granulats. Le produit agit progressivement sur plusieurs jours. La terrasse reste praticable dès le séchage initial, généralement sous 4 à 6 heures selon les conditions météo à Bobigny.</p>`,
        },
        {
          question: "Sur une terrasse carrelée, préconisez-vous nettoyeur haute pression ou nettoyage doux pour préserver les joints et l'étanchéité ?",
          answer: `<p>Le carrelage supporte généralement la haute pression, mais les joints anciens peuvent se fragiliser. Nous adaptons la puissance selon l'état constaté : pression modérée sur joints dégradés, traitement plus appuyé sur carrelage récent. L'objectif reste d'éliminer les dépôts de pollution sans compromettre l'étanchéité.</p>`,
        },
      ],
      ctaOverride: "",
    },

    {
      ...
      heroDescription: "Une remise en état complète de votre logement après travaux, déménagement ou rotation locative, avec nettoyage minutieux de chaque pièce pour une restitution impeccable.",
      whyUsBullets: [
...
<p>Les détails font la différence lors de l'état des lieux : interrupteurs, poignées, radiateurs, intérieurs de placards. Un contrôle final vérifie chaque point avant aération du logement. Le compte-rendu d'intervention peut être transmis au donneur d'ordre si nécessaire.</p>`,
      specificChallenges: [
        ...
        "Sols mixtes (lino, carrelage, parquet) nécessitant des techniques de lavage différenciées.",
        "Rotations locatives rapides autour du campus universitaire et du métro Pablo Picasso.",
      ...
      faqAdditions: [
        {
          question: "Pour un nettoyage fin de chantier dans le nouveau Cœur de Ville, quels protocoles et quel délai garantissez-vous avant remise des clés ?",
          answer: `<p>Le nettoyage fin de chantier inclut l'élimination des poussières de plâtre, des traces de peinture et des résidus de colle absents d'un ménage classique. Dans les programmes neufs livrés autour de Cœur de Ville, ces dépôts sont systématiques et demandent un protocole renforcé avant la remise des clés.</p>`,
        },
        {
          question: "Quel délai d'intervention proposez-vous pour un nettoyage état des lieux urgent demandé par un bailleur social à Bobigny ?",
          answer: `<p>Nous pouvons intervenir sous 48 à 72 heures selon la surface et la disponibilité du logement. Pour les bailleurs sociaux gérant un volume important de rotations, un planning récurrent peut être mis en place afin de sécuriser les créneaux d'intervention.</p>`,
        },
        {
          question: "Comment établissez-vous un devis pour un appartement T3 avec sols mixtes (lino et parquet) dans une résidence réhabilitée ?",
          answer: `<p>Le devis tient compte de la surface totale, du nombre de pièces d'eau et des types de revêtements présents. Un T3 combinant lino dans les chambres et carrelage en cuisine nécessite des produits et temps de séchage différents, intégrés dans l'estimation.</p>`,
        },
        {
          question: "Comment coordonnez-vous vos interventions avec les artisans lors d'un nettoyage après travaux dans le Cœur de Ville ?",
          answer: `<p>Nous intervenons après la fin des travaux salissants, en accord avec le maître d'œuvre ou l'entreprise générale. Un échange préalable permet de caler la date d'intervention et d'éviter les reprises si des finitions restent à réaliser.</p>`,
        },
      ],
      ctaOverride: "",
    },
